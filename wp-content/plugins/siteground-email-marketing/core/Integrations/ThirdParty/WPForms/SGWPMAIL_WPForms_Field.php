...
class SGWPMAIL_WPForms_Field extends \WPForms_Field {
	...
	public function field_options( $field ) {
		...
		$sg_email_marketing_groups = isset( $field['sg_email_marketing_groups'] ) ? $field['sg_email_marketing_groups'] : '';
		...
		$fld .= $this->field_element_select2(
			...
			array(
				...
				'attrs'    => array(
					'multiple'      => '',
					'data-selected' => $sg_email_marketing_groups,
				),
				'multiple' => true,
			),
		);
		...
		$sg_email_marketing_checkbox_toggle = isset( $field['sg_email_marketing_checkbox_toggle'] ) ? $field['sg_email_marketing_checkbox_toggle'] : '';
		...
		$fld = $this->field_element(
			...
			array(
				...
				'value'   => $sg_email_marketing_checkbox_toggle,
