...
trait Ajax
{
	...
	public function report3_data ()
	{
		...
		$sn             = Request::post( 'sn', 'all', 'string', [ 'all', 'fb', 'instagram', 'twitter', 'planly', 'linkedin', 'pinterest', 'telegram', 'reddit', 'youtube_community', 'tumblr', 'ok', 'vk', 'google_b', 'medium', 'wordpress', 'webhook', 'blogger', 'plurk', 'xing', 'discord' ] );
