...
trait Popup
{
    public function logs_filter()
    {
        ...
        $sn             = Request::post( 'sn_filter', 'all', 'string', [ 'all', 'fb', 'twitter', 'instagram', 'linkedin', 'vk', 'pinterest', 'reddit', 'tumblr', 'ok', 'plurk', 'google_b', 'blogger', 'telegram', 'medium', 'wordpress', 'webhook' ] );
