...
trait Popup
{
	...
	public function add_schedule ()
	{
		...
		{
			if ( ! in_array( $post_type->name, $allowedPostTypes ) || $post_type->name === 'attachment' )
			{
				continue;
			}
	...
	public function edit_schedule ()
	{
		...
		$autoRescheduleCount     = empty( $scheduleData[ 'autoRescheduleCount' ] ) ? 1 : $scheduleData[ 'autoRescheduleCount' ];
