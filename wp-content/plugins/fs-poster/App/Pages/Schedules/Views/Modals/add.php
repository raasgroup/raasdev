		...
		<div id="fspAddSchedule_1" class="fspAddSchedule-step">
			...
			<div class="fsp-form-group <?php echo $fsp_params[ 'isAutoRescheduled' ] === 1 ? 'fsp-hide' : ''; ?>">
				<div class="fsp-form-checkbox-group">
					...
					<span class="fsp-tooltip" data-title="<?php echo fsp__( 'You can automatically repeat the schedule as many times as you want.' ); ?>"><i class="far fa-question-circle"></i></span>
				</div>
				<div id="fspScheduleRescheduleCount" class="fsp-modal-row <?php echo $fsp_params[ 'isAutoRescheduleEnabled' ] === 1 ? '' : 'fsp-hide'; ?>">
					<div class="fsp-modal-col">
						<input type="number" min="1" autocomplete="off" class="fsp-form-input schedule_auto_reschedule_count" value="<?php echo $fsp_params[ 'autoRescheduleCount' ]; ?>">
							...
							<div data-driver="<?php echo $node_info[ 'driver' ]; ?>" class="fsp-metabox-account">
								...
								<div class="fsp-metabox-account-label">
									...
									<div class="fsp-metabox-account-subtext">
										<?php echo $driver; ?>&nbsp;>&nbsp;<?php echo( $node_info[ 'driver' ] == 'webhook' ? esc_html( $node_info[ 'username' ] ) : esc_html( $node_info[ 'node_type' ] ) ); ?>&nbsp;<?php echo empty( $titleText ) ? '' : '<i class="fas fa-filter fsp-tooltip" data-title="' . $titleText . '" ></i>'; ?>
									</div>
								</div>
