					...
					<div data-driver="<?php echo $node_info[ 'driver' ]; ?>" class="fsp-metabox-account">
						...
						<div class="fsp-metabox-account-label">
							...
							<div class="fsp-metabox-account-subtext">
								<?php echo $driver[ 'long' ]; ?>&nbsp;>&nbsp;<?php echo( $node_info[ 'driver' ] == 'webhook' ? esc_html( $node_info[ 'username' ] ) : esc_html( $node_info[ 'node_type' ] ) ); ?>&nbsp;<?php echo empty( $titleText ) ? '' : '<i class="fas fa-filter fsp-tooltip" data-title="' . $titleText . '" ></i>'; ?>
							</div>
						</div>
