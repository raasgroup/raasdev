...
new AIOSEOExtend( 'AIOSEO - Link Assistant', 'aioseo_link_assistant_load', AIOSEO_LINK_ASSISTANT_FILE, '4.7.1' );
...
function aioseo_link_assistant_load() {
	...
	$extend = new AIOSEOExtend( 'AIOSEO - Link Assistant', '', AIOSEO_LINK_ASSISTANT_FILE, '4.7.1', $levels );
