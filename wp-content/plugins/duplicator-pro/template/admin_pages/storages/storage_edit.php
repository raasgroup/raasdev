...
$txt_auth_note = __(
    'Note: Clicking the button below will open a new tab/window. Please be sure your browser does not block popups. If a new tab/window does not ' .
...
<form 
    ...
    action="<?php echo $edit_storage_url; ?>" 
    method="post" 
                ...
                <?php if ($storage_count > 0) : ?>
                    ...
                    foreach ($storages as $copy_storage) {
                        echo ($copy_storage->id != $storage->id) ?
                            "<option value='" . intval($copy_storage->id) . "'>" . esc_html($copy_storage->name) . "</option>" :
                            '';
                    }
                    ?>
                    </select>
...
?>
    ...
    <table class="form-table top-entry">
        <tr valign="top">
            ...
            <td>
                <input 
                    ...
                    id="name" 
                    name="name" 
                    value="<?php echo esc_attr($storage->name); ?>" autocomplete="off" 
                >
        ...
        <tr valign="top">
            ...
            <td>
                <textarea id="notes" name="notes" style="width:100%; max-width: 500px"><?php echo esc_attr($storage->notes); ?></textarea>
            </td>
        </tr>
        <tr valign="top">
            ...
            <td>
                <select id="change-mode" name="storage_type" onchange="DupPro.Storage.ChangeMode()">
                    ...
                    <?php endif; ?>
                    <option <?php selected($storage->storage_type, DUP_PRO_Storage_Types::Dropbox); ?> value="<?php echo DUP_PRO_Storage_Types::Dropbox; ?>">
                        <?php esc_html_e("Dropbox", 'duplicator-pro'); ?>
                    </option>
                    <?php
                    ...
                    if ($ftp_connect_exists_filtered) {
                        ?>
                        <option <?php selected($storage->storage_type == DUP_PRO_Storage_Types::FTP); ?> value="<?php echo DUP_PRO_Storage_Types::FTP; ?>">
                            <?php esc_html_e("FTP", 'duplicator-pro'); ?>
                        </option>
                        <?php
                    }
                    if (extension_loaded('gmp')) : ?>
                        <option <?php selected($storage->storage_type == DUP_PRO_Storage_Types::SFTP); ?> value="<?php echo DUP_PRO_Storage_Types::SFTP; ?>">
                            <?php esc_html_e("SFTP", 'duplicator-pro'); ?>
                        </option>
                    <?php endif; ?>
                    <?php if (DUP_PRO_StorageSupported::isGDriveSupported()) :?>
                        <option <?php selected($storage->storage_type, DUP_PRO_Storage_Types::GDrive); ?> value="<?php echo DUP_PRO_Storage_Types::GDrive; ?>">
                            <?php esc_html_e("Google Drive", 'duplicator-pro'); ?>
                        </option>
                    <?php endif; ?>
                        <option <?php selected($storage->storage_type == DUP_PRO_Storage_Types::Local); ?> value="<?php echo DUP_PRO_Storage_Types::Local; ?>">
                            <?php esc_html_e("Local Server", 'duplicator-pro'); ?>
                        </option>
                    <?php
                    if (DUP_PRO_StorageSupported::isOneDriveSupported()) { ?>
                        <option 
                            <?php selected($storage->storage_type == DUP_PRO_Storage_Types::OneDriveMSGraph); ?> 
                ...
                <small class="dpro-store-type-notice">
                    ...
                    if (!DUP_PRO_U::isCurlExists()) {
                        echo esc_html__(
                            "Amazon S3 (or Compatible) requires the PHP cURL extension and related functions to be enabled.",
                            'duplicator-pro'
                        ) . '<br/>';
                    } elseif (!DUP_PRO_U::curlMultiEnabled()) {
                        echo esc_html__(
                            "Amazon S3 (or Compatible) requires 'curl_multi_' type functions to be enabled. One or more are disabled on your server.",
                            'duplicator-pro'
                        ) . '<br/>';
                    }
                    ...
                    if (!extension_loaded('gmp')) {
                        echo wp_kses(
                            __(
                                'SFTP requires the <a href="http://php.net/manual/en/book.gmp.php" target="_blank">gmp extension</a>. ' .
                                'Please contact your host to install.',
                                'duplicator-pro'
                            ),
                            array(
                            'a' => array(
    ...
    <div id="provider-<?php echo DUP_PRO_Storage_Types::S3; ?>" class="provider dup-remove-on-submit-if-hidden">
        ...
        <table id="s3-provider-amazon" class="form-table provider dup-remove-on-submit-if-hidden" >
                      ...
                      <tr>
                          ...
                          <td>
                                <input 
                                    ...
                                    type="text" 
                                    autocomplete="off" 
                                    value="<?php echo esc_attr($storage->s3_access_key); ?>"
                                >
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="s3_storage_class_amazon" name="s3_storage_class">
                                    <option <?php selected($storage->s3_storage_class == 'REDUCED_REDUNDANCY'); ?> value="REDUCED_REDUNDANCY">
                                        <?php esc_html_e("Reduced Redundancy", 'duplicator-pro'); ?>
                                    </option>
                                    <option <?php selected($storage->s3_storage_class == 'STANDARD'); ?> value="STANDARD">
                                        <?php esc_html_e("Standard", 'duplicator-pro'); ?>
                                    </option>
                                    <option <?php selected($storage->s3_storage_class == 'STANDARD_IA'); ?> value="STANDARD_IA">
                        ...
                        <tr>
                            ...
                            <td>
                                <input 
                                    ...
                                    type="text" 
                                    value="<?php echo esc_attr($storage->s3_storage_folder); ?>"
                                >
                                <p>
                                    <i>
                                        <?php esc_html_e(
                ...
                <td>
                    <label for="s3_max_files_amazon">
                        <input 
                            ...
                            type="text" 
                            value="<?php echo absint($storage->s3_max_files); ?>"
                        >
            ...
            <tr>
                ...
                <td>
                    <button 
                        class="button button-large button_s3_test" 
                        id="button_s3_send_file_test_amazon" 
                        type="button" 
                        onclick="DupPro.Storage.S3.SendFileTest(); return false;"
                    >
        ...
        <table id="s3-provider-other" class="form-table provider dup-remove-on-submit-if-hidden" >
                ...
                <td class="dup-s3-auth-account">
                    ...
                    <table class="dup-form-sub-area">
                        <tr>
                            ...
                            <td>
                                <input 
                                    id="s3_access_key_other" 
                                    name="s3_access_key" 
                                    data-parsley-errors-container="#s3_access_key_other_error_container" 
                                    type="text" 
                                    autocomplete="off" 
                                    value="<?php echo esc_attr($storage->s3_access_key); ?>"
                                >
            ...
            <tr>
                ...
                <td>
                    <label for="s3_max_files_other">
                        <input 
                            id="s3_max_files_other" 
                            class="s3_max_files" 
                            name="s3_max_files" 
                            data-parsley-errors-container="#s3_max_files_other_error_container" 
                            type="text" 
                            value="<?php echo absint($storage->s3_max_files); ?>"
                        >
                        <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?><br/>
                        <i>
                            <?php
                            esc_html_e(
                                "When this limit is exceeded, the oldest package will be deleted. Set to 0 for no limit.",
                                'duplicator-pro'
                            );
                            ?>
                        </i>
            ...
            <tr valign="top">
                ...
                <td>
                    <input 
                        ...
                        id="s3_ACL_full_control_other" 
                        value="1" 
                        <?php checked($storage->s3_ACL_full_control, true); ?> 
                    >
            ...
            <tr>
                ...
                <td>
                    <button 
                        class="button button-large button_s3_test" 
                        id="button_s3_send_file_test_other" 
                        type="button" 
                        onclick="DupPro.Storage.S3.SendFileTest(); return false;"
                    >
                        <i class="fas fa-cloud-upload-alt fa-sm"></i> <?php esc_html_e('Test S3 Connection', 'duplicator-pro'); ?>
        ...
        <table id="s3-provider-backblaze" class="form-table provider dup-remove-on-submit-if-hidden" >
                ...
                <td class="dup-s3-auth-account">
                    ...
                    <table class="dup-form-sub-area">
                      <tr>
                            ...
                            <td>
                                <input 
                                    id="s3_access_key_backblaze" 
                                    name="s3_access_key" 
                                    data-parsley-errors-container="#s3_access_key_backblaze_error_container" 
                                    type="text" 
                                    autocomplete="off" 
                                    value="<?php echo esc_attr($storage->s3_access_key); ?>"
                                >
                ...
                <td>
                    <table class="dup-form-sub-area dup-s3-auth-provider">
                            ...
                            <td>
                                ...
                                <p>
                                    <i>
                                        <?php
                                        esc_html_e(
                                            "Region is taken from between first 2 dots in Endpoint URL, for example: s3.<region>.backblazeb2.com",
                                            'duplicator-pro'
                                        ); ?>
                                    </i>
                                </p>
                        ...
                        <tr>
                            ...
                            <td>
                                <input 
                                    id="_s3_storage_folder_backblaze" 
                                    name="_s3_storage_folder" 
                                    type="text" 
                                    value="<?php echo esc_attr($storage->s3_storage_folder); ?>"
                                >
            ...
            <tr>
                ...
                <td>
                    <label for="s3_max_files_backblaze">
                        <input 
                            id="s3_max_files_backblaze" 
                            class="s3_max_files" 
                            name="s3_max_files" 
                            data-parsley-errors-container="#s3_max_files_backblaze_error_container" 
                            type="text" 
                            value="<?php echo absint($storage->s3_max_files); ?>"
                        >
                        <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?><br/>
            ...
            <tr>
                ...
                <td>
                    <button 
                        class="button button-large button_s3_test" 
                        id="button_s3_send_file_test_backblaze" 
                        type="button" 
                        onclick="DupPro.Storage.S3.SendFileTest(); return false;"
                    >
                        <i class="fas fa-cloud-upload-alt fa-sm"></i> <?php esc_html_e('Test S3 Connection', 'duplicator-pro'); ?>
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::Dropbox ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
        <tr>
            ...
            <td class="dropbox-authorize">
                ...
                <div class="authorization-state" id="state-waiting-for-auth-button-click">
                    ...
                    <br/>
                    <button type="button" class="button" id="dropbox-finalize-setup" onclick="DupPro.Storage.Dropbox.FinalizeSetup(); return false;">
        ...
        <tr>
            ...
            <td>
                ...
                <input id="_dropbox_storage_folder" name="_dropbox_storage_folder" 
                    type="text" value="<?php echo esc_attr($storage->dropbox_storage_folder); ?>" class="dpro-storeage-folder-path" />
                <p>
                    <i>
                        <?php
                        esc_html_e(
            ...
            <td>
                <label for="dropbox_max_files">
                    <input data-parsley-errors-container="#dropbox_max_files_error_container" id="dropbox_max_files" 
                        name="dropbox_max_files" type="text" value="<?php echo esc_attr($storage->dropbox_max_files); ?>" maxlength="4">
                    <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?> <br/>
                    <i><?php esc_html_e("When this limit is exceeded, the oldest package will be deleted. Set to 0 for no limit.", 'duplicator-pro'); ?></i>
                </label>
        ...
        <tr>
            <th scope="row"><label for=""><?php esc_html_e("Connection", 'duplicator-pro'); ?></label></th>
            <td>
                <button class="button button_dropbox_test" id="button_dropbox_send_file_test" 
                    type="button" onclick="DupPro.Storage.Dropbox.SendFileTest(); return false;">
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::OneDrive ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
        <tr>
            ...
            <?php if ($storage->onedrive_authorization_state == DUP_PRO_OneDrive_Authorization_States::Unauthorized) : ?>
                    <div class='onedrive-authorization-state' id="onedrivestate-unauthorized">
                        <!-- CONNECT -->
                        <button id="dpro-onedrive-connect-btn" type="button" 
                            class="button button-large" onclick="DupPro.Storage.OneDrive.GetAuthUrl(); return false;">
                            <i class="fa fa-plug"></i> <?php esc_html_e('Connect to OneDrive Personal', 'duplicator-pro'); ?>
                        </button>
                        <button id="dpro-onedrive-business-connect-btn" type="button" 
                            class="button button-large" onclick="DupPro.Storage.OneDrive.GetAuthUrl(1); return false;">
                        ...
                        <div class='onedrive-auth-container' style="display: none;">
                            ...
                            <button id="auth-redirect-od" type="button" class="button button-large" 
                                onclick="DupPro.Storage.OneDrive.OpenAuthPage(); return false;">
                            ...
                            <br/>
                            <button type="button" class="button" onclick="DupPro.Storage.OneDrive.FinalizeSetup(); return false;">
                                <i class="fa fa-check-square"></i> <?php esc_html_e('Finalize Setup', 'duplicator-pro'); ?>
                            </button>
                        </div>
                    </div>
            ...
            <?php endif; ?>
                ...
                <?php if ($storage->onedrive_authorization_state == DUP_PRO_OneDrive_Authorization_States::Authorized) : ?>
                        <h3>
                            <?php
                            echo (!$storage->onedrive_is_business()) ?
                                __('OneDrive Personal Account', 'duplicator-pro') :
                                __('OneDrive Business Account', 'duplicator-pro');
                            ?><br/>
                            <i class="dpro-edit-info">
                        ...
                        <i class="dpro-edit-info">
                            <?php esc_html_e('Disassociates storage provider with the OneDrive account. Will require re-authorization.', 'duplicator-pro'); ?> 
                        </i>
                <?php endif; ?>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <input 
                    id="_onedrive_storage_folder" 
                    name="_onedrive_storage_folder" 
                    type="text" 
                    value="<?php echo esc_attr($storage->onedrive_storage_folder); ?>" 
                    ...
                    data-parsley-pattern-message="<?php echo esc_attr__(
        ...
        <tr>
            ...
            <td>
                <label for="onedrive_max_files">
                    <input data-parsley-errors-container="#onedrive_max_files_error_container" id="onedrive_max_files" 
                        name="onedrive_max_files" type="text" value="<?php echo absint($storage->onedrive_max_files); ?>" maxlength="4">
                    <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?> <br/>
                    <i><?php esc_html_e("When this limit is exceeded, the oldest package will be deleted. Set to 0 for no limit.", 'duplicator-pro'); ?></i>
                </label>
        ...
        <tr>
            <th scope="row"><label for=""><?php esc_html_e("Connection", 'duplicator-pro'); ?></label></th>
            <td>
                <button class="button button-large button_onedrive_test" id="button_onedrive_send_file_test" 
                    type="button" onclick="DupPro.Storage.OneDrive.SendFileTest(); return false;">
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::OneDriveMSGraph;?>" class="form-table provider dup-remove-on-submit-if-hidden" >
            ...
            <td class="onedrive-authorize">
                <?php if ($storage->onedrive_authorization_state == DUP_PRO_OneDrive_Authorization_States::Unauthorized) : ?>
                    <div class='onedrive-msgraph-authorization-state' id="onedrive-msgraph-state-unauthorized">
                        ...
                        <label class="switch">
                        <input id="onedrive_msgraph_all_folders_read_write_perm" 
                            name="onedrive_msgraph_all_folders_read_write_perm" type="checkbox" value="1" />
                            <span class="slider round"></span>
                        </label>
                        <div class="auth-code-popup-note" style="margin-top:1px; margin-left: 0;">
                            <?php
                            esc_html_e(
                                'There is only Apps folder permission scope by default. If your OneDrive Business is not working, ' .
                                'Please switch on this option.',
                                'duplicator-pro'
                            ); ?>
                        </div>

                        <!-- CONNECT -->
                        <button id="dpro-onedrive-msgraph-connect-btn" type="button" class="button button-large" 
                        ...
                        <div class='onedrive-msgraph-auth-container' style="display: none;">
                            ...
                            <button 
                                ...
                                class="button" onclick="DupPro.Storage.OneDrive.FinalizeSetup(); return false;"
                            >
                                <i class="fa fa-check-square"></i> <?php esc_html_e('Finalize Setup', 'duplicator-pro'); ?>
                            </button>
                        </div>
        ...
        <tr>
            <th scope="row"><label for=""><?php esc_html_e("Connection", 'duplicator-pro'); ?></label></th>
            <td>
                <button class="button button-large button_onedrive_test" 
                    id="button_onedrive_msgraph_send_file_test" type="button" onclick="DupPro.Storage.OneDrive.SendFileTest(); return false;">
                    <i class="fas fa-cloud-upload-alt fa-sm"></i>   <?php esc_html_e('Test OneDrive Connection', 'duplicator-pro'); ?>
                </button>
                <p><i><?php esc_html_e("Test connection by sending and receiving a small file to/from the account.", 'duplicator-pro'); ?></i></p>
            </td>
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::FTP ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
        ...
        <tr>
            ...
            <td>
                <input id="ftp_server" class="dup-empty-field-on-submit" name="ftp_server" data-parsley-errors-container="#ftp_server_error_container" 
                    type="text" autocomplete="off" value="<?php echo esc_attr($storage->ftp_server); ?>">
        ...
        <tr>
            ...
            <td>
                <input id="ftp_username" class="dup-empty-field-on-submit" 
                    name="ftp_username" type="text" autocomplete="off" value="<?php echo esc_attr($storage->ftp_username); ?>" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <label for="ftp_max_files">
                    <input id="ftp_max_files" name="ftp_max_files" data-parsley-errors-container="#ftp_max_files_error_container" 
                        type="text" value="<?php echo absint($storage->ftp_max_files); ?>">
                    <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?> <br/>
                    <i><?php esc_html_e("When this limit is exceeded, the oldest package will be deleted. Set to 0 for no limit. ", 'duplicator-pro'); ?></i>
                </label>
        ...
        <tr>
            ...
            <td>
                <input name="_ftp_ssl" <?php checked($storage->ftp_ssl); ?> class="checkbox" value="1" type="checkbox" id="_ftp_ssl" >
        ...
        <tr>
            ...
            <td>
                <input <?php checked($storage->ftp_passive_mode); ?> class="checkbox" value="1" type="checkbox" name="_ftp_passive_mode" id="_ftp_passive_mode">
        ...
        <tr>
            ...
            <td>
                <input <?php checked($storage->ftp_use_curl); ?> class="checkbox" value="1" type="checkbox" name="_ftp_use_curl" id="_ftp_use_curl">
        ...
        <tr>
            <th scope="row"><label for=""><?php esc_html_e("Connection", 'duplicator-pro'); ?></label></th>
            <td>
                <button class="button button-large button_ftp_test" id="button_ftp_send_file_test" 
                    type="button" onclick="DupPro.Storage.FTP.SendFileTest(); return false;">
        ...
        <table id="provider-<?php echo DUP_PRO_Storage_Types::SFTP ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
            ...
            <tr>
                ...
                <td>
                    <input id="sftp_server" class="dup-empty-field-on-submit" name="sftp_server" 
                        ...
                        utocomplete="off" value="<?php echo esc_attr($storage->sftp_server); ?>">
            ...
            <tr>
                ...
                <td><input id="sftp_username" class="dup-empty-field-on-submit" name="sftp_username" 
                    type="text" autocomplete="off" value="<?php echo esc_attr($storage->sftp_username); ?>" /></td>
            </tr>
            <tr>
                    ...
                    <p>
                        <i>
                            <?php
                                echo wp_kses(
                                    __(
                                        "Folder where packages will be stored. This should be <strong>an absolute path, " .
                                        "not a relative path</strong> and be unique for each web-site using Duplicator.",
                                        'duplicator-pro'
                                    ),
                                    array(
                                    'strong' => array()
                ...
                <td>
                    <label for="sftp_max_files">
                        <input id="sftp_max_files" name="sftp_max_files" data-parsley-errors-container="#sftp_max_files_error_container" 
                            type="text" value="<?php echo absint($storage->sftp_max_files); ?>">
                        <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?> <br/>
                        <i><?php esc_html_e("When this limit is exceeded, the oldest package will be deleted. Set to 0 for no limit.", 'duplicator-pro'); ?></i>
                    </label>
            ...
            <th scope="row"><label for="sftp_disable_chunking_mode"><?php esc_html_e("Chunking", 'duplicator-pro'); ?></label></th>
                <td>
                    <input id="sftp_disable_chunking_mode" name="sftp_disable_chunking_mode" type="checkbox" 
                        class="checkbox" value="1" <?php checked($storage->sftp_disable_chunking_mode, true); ?>>
            ...
            <tr>
                <th scope="row"><label for=""><?php esc_html_e("Connection", 'duplicator-pro'); ?></label></th>
                <td>
                    <button class="button button-large button_sftp_test" id="button_sftp_send_file_test" 
                        type="button" onclick="DupPro.Storage.SFTP.SendFileTest(); return false;">
...
<?php endif; ?>
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::GDrive ?>" class="form-table provider dup-remove-on-submit-if-hidden" >
        ...
        <tr>
            ...
            <td>
                <b>//Google Drive/</b>
                <input id="_gdrive_storage_folder" name="_gdrive_storage_folder" type="text" 
                    value="<?php echo esc_attr($storage->gdrive_storage_folder); ?>"  class="dpro-storeage-folder-path"/>
                <p>
                    <i>
                        <?php
                        esc_html_e(
                    ...
                    <i 
                        ...
                        data-tooltip="<?php
                            esc_attr_e(
                                'If the directory path above is already in Google Drive before connecting then a ' .
                                'duplicate folder name will be made in the same path. This is because the plugin only has rights to folders it creates.',
                                'duplicator-pro'
                            ); ?>"
                        >
                    </i>
        ...
        <tr>
            ...
            <td>
                <label for="gdrive_max_files">
                    <input data-parsley-errors-container="#gdrive_max_files_error_container" id="gdrive_max_files" 
                        name="gdrive_max_files" type="text" value="<?php echo absint($storage->gdrive_max_files); ?>" maxlength="4">&nbsp;
                    <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?> <br/>
                    <i><?php esc_html_e("When this limit is exceeded, the oldest package will be deleted. Set to 0 for no limit.", 'duplicator-pro'); ?></i>
                </label>
        ...
        <tr>
            ...
            ?>
                <button class="button button-large button_gdrive_test" id="button_gdrive_send_file_test" type="button" 
                    onclick="DupPro.Storage.GDrive.SendFileTest(); return false;" <?php echo $gdrive_test_button_disabled; ?>>
    ...
    <table id="provider-<?php echo DUP_PRO_Storage_Types::Local ?>" class="provider form-table dup-remove-on-submit-if-hidden">
            ...
            <td>
                ...
                <script>
                    let validatorMsg = <?php
                        echo json_encode(
                            __('Storage Folder should not be root directory path, content directory path and upload directory path', 'duplicator-pro')
                        ); ?>;
                ...
                <p>
                    ...
                    echo ' <b>' .
                        esc_html__('This will not store to your local computer unless that is where this web-site is hosted.', 'duplicator-pro') .
                        '</b>';
                    echo '<br/> ';
        ...
        <tr>
            ...
            <td>
                <input id="_local_filter_protection" name="_local_filter_protection" 
                    type="checkbox" <?php checked($storage->local_filter_protection); ?> onchange="DupPro.Storage.LocalFilterToggle()">&nbsp;
                ...
                <div style="padding-top:6px">
                    ...
                    <div id="_local_filter_protection_message" style="display:none; color:maroon">
                        <i>
                            <?php
                            esc_html_e(
                                "Unchecking filter protection is not recommended. " .
                                "This setting helps to prevents packages from getting bundled in other packages.",
                                'duplicator-pro'
                            ); ?>
                        </i>
                    </div>
        ...
        <tr>
            ...
            <td>
                <label for="local_max_files">
                    <input data-parsley-errors-container="#local_max_files_error_container" 
                        id="local_max_files" name="local_max_files" type="text" value="<?php echo absint($storage->local_max_files); ?>" maxlength="4">&nbsp;
                    <?php esc_html_e("Number of packages to keep in folder.", 'duplicator-pro'); ?><br/>
                    <i><?php esc_html_e("When this limit is exceeded, the oldest package will be deleted. Set to 0 for no limit.", 'duplicator-pro'); ?></i>
                </label>
        ...
        <tr>
            ...
            <td>
                <button class="button button-large button_local_file_test" id="button_local_file_test" 
                    type="button" onclick="DupPro.Storage.Local.Test(); return false;">
            ...
            $.ajax({
                ...
                success: function (respData) {
                    try {
                        ...
                        <?php $alertOneDriveConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Send OneDrive file test failed. JSON parse failed for response data.', 'duplicator-pro'); ?>";
                        <?php $alertOneDriveConnStatus->updateMessage("alertMsg"); ?>
                        console.log(respData);
                        return false;
                    }
                ...
                error: function (respData) {
                    ...
                    <?php $alertOneDriveConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('Send OneDrive file test failed. AJAX error!', 'duplicator-pro'); ?>";
                    <?php $alertOneDriveConnStatus->updateMessage("alertMsg"); ?>
                    console.log(respData);
                }
            });
            ...
            $.ajax({
                ...
                success: function (respData) {
                    try {
                        ...
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Unable to get Dropbox authentication URL. JSON parse failed for response data.', 'duplicator-pro'); ?>";
                    ...
                    if (parsedData.success) {
                        ...
                        <?php $alertDropboxConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Error getting Dropbox authentication URL. Please try again later.', 'duplicator-pro'); ?>";
                        <?php $alertDropboxConnStatus->updateMessage("alertMsg"); ?>
                        console.log(parsedData);
                ...
                error: function (data) {
                    <?php $alertDropboxConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('Unable to get Dropbox authentication URL. AJAX error!', 'duplicator-pro'); ?>";
                    <?php $alertDropboxConnStatus->updateMessage("alertMsg"); ?>
                },
            ...
            $.ajax({
                ...
                success: function (respData) {
                    try {
                        ...
                        <?php $alertDropboxConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Send Dropbox file test failed. JSON parse failed for response data.', 'duplicator-pro'); ?>";
                        <?php $alertDropboxConnStatus->updateMessage("alertMsg"); ?>
                        console.log(respData);
                        return false;
                    }
                ...
                error: function (data) {
                    ...
                    <?php $alertDropboxConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('Send Dropbox file test failed. AJAX error!', 'duplicator-pro'); ?>";
                    <?php $alertDropboxConnStatus->updateMessage("alertMsg"); ?>
                    console.log(data);
                }
            });
            ...
            $.ajax({
                ...
                success: function (respData) {
                    try {
                        ...
                        <?php $alertGoogleDriveConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Unable to get Google Drive authentication URL. JSON parse failed for response data.', 'duplicator-pro'); ?>";
                        <?php $alertGoogleDriveConnStatus->updateMessage("alertMsg"); ?>
                        return false;
                    }
                    ...
                    if (parsedData.status === 0) {
                        ...
                        <?php $alertGoogleDriveConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Google Drive not supported on systems running PHP version < 5.3.2.', 'duplicator-pro'); ?>";
                        <?php $alertGoogleDriveConnStatus->updateMessage("alertMsg"); ?>
                        console.log(parsedData);
                        ...
                        <?php $alertGoogleDriveConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Error getting Google Drive authentication URL. Please try again later. ', 'duplicator-pro'); ?>";
                ...
                error: function (data) {
                    <?php $alertGoogleDriveConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('Unable to get Google Drive authentication URL. AJAX error!', 'duplicator-pro'); ?>";
                    <?php $alertGoogleDriveConnStatus->updateMessage("alertMsg"); ?>
                },
                complete: function (data) {
        ...
        DupPro.Storage.GDrive.SendFileTest = function () {
            ...
            $.ajax({
                ...
                success: function (respData) {
                    try {
                        ...
                        $test_button.html(
                            ...
                            '<?php esc_html_e("Test Google Drive Connection", 'duplicator-pro'); ?>'
                        );
                        <?php $alertGoogleDriveConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Send Google Drive file test failed. JSON parse failed for response data.', 'duplicator-pro'); ?>";
                        <?php $alertGoogleDriveConnStatus->updateMessage("alertMsg"); ?>
                        console.log(respData);
                        return false;
                    }
                    ...
                    if (parsedData.success) {
                        ...
                        <?php $alertGoogleDriveConnStatus->showAlert(); ?>
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('Send Google Drive file test failed.', 'duplicator-pro'); ?>";
                        <?php $alertGoogleDriveConnStatus->updateMessage("alertMsg"); ?>
                        console.log(parsedData);
                    }
                },
                error: function (data) {
                    ...
                    <?php $alertGoogleDriveConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('Send Google Drive file test failed. AJAX error!', 'duplicator-pro'); ?>";
                    <?php $alertGoogleDriveConnStatus->updateMessage("alertMsg"); ?>
                    console.log(data);
                }
            });
            ...
            $.ajax({
                ...
                success: function (respData) {
                    try {
                        ...
                        let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                            "<?php esc_html_e('JSON parse failed for response data.', 'duplicator-pro'); ?>";
                ...
                error: function (parsedData) {
                    ...
                    <?php $alertFTPConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('AJAX error while testing FTP connection', 'duplicator-pro'); ?>";
                    <?php $alertFTPConnStatus->updateMessage("alertMsg"); ?>
                    console.log(parsedData);
                }
            });
        ...
        DupPro.Storage.SFTP.SendFileTest = function ()
        {
            ...
            $.ajax({
                ...
                error: function (respData) {
                    ...
                    <?php $alertSFTPConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('AJAX error while testing SFTP connection', 'duplicator-pro'); ?>";
                    <?php $alertSFTPConnStatus->updateMessage("alertMsg"); ?>
                    console.log(respData);
                }
            });
        ...
        DupPro.Storage.S3.SendFileTest = function () {
            ...
            $.ajax({
                ...
                error: function (respData) {
                    ...
                    <?php $alertS3ConnStatus->showAlert(); ?>
                    let alertMsg = "<i class='fas fa-exclamation-triangle'></i> " + 
                        "<?php esc_html_e('AJAX error while testing S3 connection', 'duplicator-pro'); ?>";
                    <?php $alertS3ConnStatus->updateMessage("alertMsg"); ?>
                    console.log(respData);
                }
            });
