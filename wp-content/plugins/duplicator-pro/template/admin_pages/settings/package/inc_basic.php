                        ...
                        <div class="dup-feature-notfound">
                            ...
                            printf(
                                _x(
                                    ...
                                    . 'Please contact your host or server admin to enable one or more these functions. For a list of approved '
                                    . 'providers that support these functions, %1sclick here%2s. The "PHP Code" setting will be used '
                            ...
                            <p>
                                <?php
                                _e(
                                    'Below is a list of possible functions to activate to solve the problem. '
                                    . 'If the problem persists, look at the log for a more thorough analysis.',
                                    'duplicator-pro'
                                );
                                ?>
                            </p>
                        ...
                        <div class="dup-group-option-wrapper">
                            ...
                            foreach ($mysqldumpOptions as $key => $option) {
                                ...
                                <div 
                                    ...
                                    <?php echo DUP_PRO_UI::echoChecked($option->getEnabled()); ?>
                                >
...
<script>
    jQuery(document).ready(function ($)
    {
        ...
        {
            var php70 = <?php DUP_PRO_UI::echoBoolean(version_compare(PHP_VERSION, '7', '>=')); ?>;
