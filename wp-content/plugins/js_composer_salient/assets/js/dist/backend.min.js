...
! function(l) {
  _.isUndefined(window.vc) && (window.vc = {}), l.ajaxSetup({
      beforeSend: function(e, t) {
          "script" === t.dataType && !0 === t.cache && (t.cache = !1), "script" === t.dataType && !1 === t.async && (t.async = !0)
      }
  }), vc.showSpinner = function() {
      l("#vc_logo").addClass("vc_ui-wp-spinner")
  }, vc.hideSpinner = function() {
      l("#vc_logo").removeClass("vc_ui-wp-spinner")
  }, l(document).ajaxSend(function(e, t, i) {
      ...
      var e = l("#vc_post-settings-badge");
      ...
      setSize: function() {
          var e = l(window).height() - 150;
          this.$content.css("maxHeight", e), this.trigger("setSize")
      },
      render: function() {
          return l(window).on("resize.ModalView", this.setSize), this.setSize(), vc.closeActivePanel(), this.$el.modal("show"), this
      },
      ...
      buildFiltering: function() {
          this.do_render = !1, e = '[data-vc-ui-element="add-element-button"]', t = this.model ? this.model.get("shortcode") : "vc_column", i = this._getNotIn(t), l("#vc_elements_name_filter").val(""), this.$content.addClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", "*");
          ...
          }, "")), e += a.join(",")) : i && (e = i), t && !_.isUndefined(n.allowed_container_element) && (n.allowed_container_element ? _.isString(n.allowed_container_element) && (e += ":not([data-is-container=true]), [data-element=" + n.allowed_container_element + "]") : e += ":not([data-is-container=true])"), this.$buttons.removeClass("vc_visible").addClass("vc_inappropriate"), l(e, this.$content).removeClass("vc_inappropriate").addClass("vc_visible"), this.hideEmptyFilters()
      },
      ...
      createElement: function(e) {
          ...
          if (!this.preventDoubleExecution) {
              this.preventDoubleExecution = !0, this.do_render = !0, e.preventDefault(), e = l(e.currentTarget).data("tag"), n = {}, !(t = {
                  width: "1/1"
      ...
      filterElements: function(e) {
          ...
          var e = l(e.currentTarget),
              ...
              i = l("#vc_elements_name_filter").val();
          this.$content.removeClass("vc_filter-all"), e.is("[data-filter]") ? (l(".wpb-content-layouts-container .isotope-filter .active", this.$content).removeClass("active"), e.parent().addClass("active"), t += e = e.data("filter"), "*" === e ? this.$content.addClass("vc_filter-all") : this.$content.removeClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", e.replace(".js-category-", "")), l("#vc_elements_name_filter").val("")) : 0 < i.length ? (t += ":containsi('" + i + "'):not('.vc_element-deprecated')", l(".wpb-content-layouts-container .isotope-filter .active", this.$content).removeClass("active"), this.$content.attr("data-vc-ui-filter", "name:" + i)) : i.length || (l('.wpb-content-layouts-container .isotope-filter [data-filter="*"]').parent().addClass("active"), this.$content.attr("data-vc-ui-filter", "*"), this.$content.addClass("vc_filter-all")), l(".vc_visible", this.$content).removeClass("vc_visible"), l(t, this.$content).addClass("vc_visible")
      },
      shown: function() {
          vc.is_mobile || l("#vc_elements_name_filter").trigger("focus")
      }
  }), vc.AddElementBlockViewBackendEditor = vc.AddElementBlockView.extend({
      render: function(e, t) {
          return this.prepend = !!_.isBoolean(t) && t, this.place_after_id = !!_.isString(t) && t, this.model = !!_.isObject(e) && e, this.$content = this.$el.find('[data-vc-ui-element="panel-add-element-list"]'), this.$buttons = l('[data-vc-ui-element="add-element-button"]', this.$content), vc.AddElementBlockView.__super__.render.call(this)
      },
      createElement: function(e) {
          var t, i, a;
          this.preventDoubleExecution || (this.preventDoubleExecution = !0, e && e.preventDefault && e.preventDefault(), this.do_render = !0, e = l(e.currentTarget).data("tag"), a = !(a = {
              width: "1/1"
      ...
      initialize: function() {
          this.clicked = !1, this.$el.removeClass("vc_panel-opacity"), this.$body = l("body"), this.$content = this.$el.find(".vc_panel-body"), _.bindAll(this, "setSize", "fixElContainment", "changeTab", "setTabsSize"), this.on("show", this.setSize, this), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this)
      },
      ...
      changeTab: function(e) {
          e && e.preventDefault && e.preventDefault(), e.target && this.$tabs && (e = l(e.target), this.$tabs.find(".vc_active").removeClass("vc_active"), e.parent().addClass("vc_active"), this.$el.find(e.data("target")).addClass("vc_active"), window.setTimeout(this.setTabsSize, 100))
      },
      showMessage: function(e, t) {
          ...
          var i = l('<div class="vc_panel-message type-' + t + '"></div>').appendTo(this.$el.find(".vc_ui-panel-content-container"));
      ...
      initialize: function() {
          vc.$custom_css = l("#vc_post-custom-css"), vc.$custom_js_header = l("#vc_post-custom-js-header"), vc.$custom_js_footer = l("#vc_post-custom-js-footer"), this.saved_css_data = vc.$custom_css.val(), this.saved_js_header_data = vc.$custom_js_header.val(), this.saved_js_footer_data = vc.$custom_js_footer.val(), this.saved_title = vc.title, window.Vc_postSettingsEditor && this.initEditor(), this.$body = l("body"), _.bindAll(this, "setSize", "fixElContainment"), this.on("show", this.setSize, this), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this), this.on("afterRender", function() {
              l(".edit-form-info").initializeTooltips(".vc_column")
          }, this)
      },
      initEditor: function() {
          this.editor_css = new Vc_postSettingsEditor, this.editor_css.sel = "wpb_css_editor", this.is_css = l("#" + this.editor_css.sel).length, this.editor_css.mode = "css", this.editor_css.is_focused = !0, this.editor_js_header = new Vc_postSettingsEditor, this.editor_js_header.sel = "wpb_js_header_editor", this.is_js_header = l("#" + this.editor_js_header.sel).length, this.editor_js_header.mode = "javascript", this.editor_js_footer = new Vc_postSettingsEditor, this.editor_js_footer.sel = "wpb_js_footer_editor", this.is_js_footer = l("#" + this.editor_js_footer.sel).length, this.editor_js_footer.mode = "javascript"
      },
      render: function() {
      ...
      save: function() {
          for (var e = l("#vc_setting-seo-form").serializeArray(), t = {}, i = 0; i < e.length; i++) t[e[i].name] = e[i].value;
          l("#vc_post-custom-seo-settings").val(JSON.stringify(t)), this.trigger("save"), this.hide()
      }
      ...
      render: function() {
          this.trigger("render"), this.$name = l("#vc_template-name"), this.$list = l("#vc_template-list");
          var t = l("#vc_tabs-templates");
          return t.find(".vc_edit-form-tab-control").removeClass("vc_active").eq(0).addClass("vc_active"), t.find('[data-vc-ui-element="panel-edit-element-tab"]').removeClass("vc_active").eq(0).addClass("vc_active"), t.find(".vc_edit-form-link").on("click", function(e) {
              e.preventDefault();
              e = l(this);
              t.find(".vc_active").removeClass("vc_active"), e.parent().addClass("vc_active"), l(e.attr("href")).addClass("vc_active")
      ...
      removeTemplate: function(e) {
          ...
          confirm(window.i18nLocale.confirm_deleting_template.replace("{template_name}", t)) && (e.closest('[data-vc-ui-element="template"]').remove(), this.$list.html(window.i18nLocale.loading), l.ajax({
              type: "POST",
              url: window.ajaxurl,
              data: {
      ...
      events: l.extend(vc.PanelView.prototype.events, {
      ...
      render: function() {
          return this.$el.css("left", (l(window).width() - this.$el.width()) / 2), this.$name = this.$el.find('[data-js-element="vc-templates-input"]'), this.$name.off("keypress").on("keypress", this.checkInput), this.$list = this.$el.find(".vc_templates-list-my_templates"), vc.TemplatesPanelViewBackend.__super__.render.call(this)
      },
      saveTemplate: function(e) {
          var t, i;
      ...
      removeTemplate: function(e) {
          ...
          var t, i, e = l(e.target).closest("[data-template_id]"),
              a = e.find('[data-vc-ui-element="template-title"]').text();
          confirm(window.i18nLocale.confirm_deleting_template.replace("{template_name}", a)) && (t = e.data("template_id"), i = e.data("template_type"), a = e.data("template_action"), e.remove(), l.ajax({
              type: "POST",
              url: window.ajaxurl,
              data: {
      ...
      reloadTemplateList: function(e, t, i) {
          ...
          l.ajax({
              ...
              a.filter = !1, a.$list || (a.$list = a.$el.find(".vc_templates-list-my_templates")), a.$list.prepend(l(e)), "function" == typeof t && t(e)
      ...
      loadTemplate: function(e) {
          e && e.preventDefault && e.preventDefault(), e && e.stopPropagation && e.stopPropagation();
          e = l(e.target).closest("[data-template_id][data-template_type]");
          l.ajax({
              type: "POST",
              url: this.loadUrl,
              data: {
      ...
      renderTemplate: function(t) {
          ...
          _.each(vc.filters.templates, function(e) {
              ...
              vc.shortcodes.create(e)
          }), vc.closeActivePanel()
      },
      buildTemplatePreview: function(e) {
          e && e.preventDefault && e.preventDefault();
          try {
              var a, n = l(e.currentTarget),
              ...
              if (s.hasClass("vc_active") || s.hasClass("vc_loading")) n.vcAccordion("collapseTemplate");
                  ...
                  n.vcAccordion("collapseTemplate", function() {
                      ...
                      t && !o && (e = "?", -1 < window.ajaxurl.indexOf("?") && (e = "&"), a = window.ajaxurl + e + l.param({
      ...
      _builder: !1,
      render: function(e) {
          return this.$input = l("#vc_row-layout"), e && (this.model = e), this.addCurrentLayout(), this.resetMinimize(), vc.column_trig_changes = !0, l(".edit-form-info").initializeTooltips(".vc_ui-panel-content"), this
      },
      builder: function() {
      ...
      setLayout: function(e) {
          ...
          e = l(e.currentTarget).attr("data-cells"), e = this.model.view.convertRowColumns(e, this.builder());
      ...
      setLayout: function(e) {
          e && e.preventDefault && e.preventDefault();
          e = l(e.currentTarget).attr("data-cells"), e = this.model.view.convertRowColumns(e);
          this.$input.val(e.join(" + "))
      }
  ...
  }), l(window).on("resize.fixElContainment", function() {
      vc.active_panel && vc.active_panel.fixElContainment && vc.active_panel.fixElContainment()
  }), l("body").on("keyup change input", "[data-vc-disable-empty]", function() {
      var e = l(this),
          t = l(e.data("vcDisableEmpty"));
...
! function() {
  function e() {
      var e, o, n = window.vc.latestAddedElement;
      n && n.view && n.view.el && (n = n.view.el.getBoundingClientRect().top, e = document.getElementById("vc_inline-frame"), o = n + (window.scrollY || document.documentElement.scrollTop) - 250, (e ? (o = n + ((n = e.contentWindow).scrollY || n.document.documentElement.scrollTop) - 250, n) : window).scrollTo({
          top: o,
          behavior: "smooth"
      }))
  }
  "admin_frontend_editor" === window.vc_mode ? vc.events.once("shortcodeView:ready", function() {
      vc.events.on("afterLoadShortcode", _.debounce(e, 300))
  }) : vc.events.on("shortcodeView:ready", _.debounce(e, 300))
}(window.jQuery);
...
! function(t) {
  window.vc.HelperTemplatesPanelViewSearch = {
      ...
      focusToSearch: function() {
          vc.is_mobile || t(this.searchSelector, this.$el).trigger("focus")
      },
...
! function(l) {
  window.vc.TemplateWindowUIPanelBackendEditor = vc.TemplatesPanelViewBackend.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperTemplatesPanelViewSearch).extend({
          ...
          this.clearSearch(), window.vc.TemplateWindowUIPanelBackendEditor.__super__.show.call(this);
           ...
           /*nectar addition*/
                ...
                [].forEach.call(document.querySelectorAll('.vc_ui-template img[data-src]'), function(img) {
                  ...
                  if( jQuery('.vc_ui-template-list.salient-studio-template-json .json-templates').length > 0 ) {
                    ...
                    var $studioTemplatesContainer = jQuery('.vc_ui-template-list.salient-studio-template-json');
                    ...
                    if($studioTemplatesJSON.length > 0) {
                      ...
                      jQuery.each($studioTemplatesJSON,function(k,v){
  
                        $studioTemplateMarkup = jQuery('<div class="vc_ui-template vc_templates-template-type-'+ v.template_type+ ' ' + v.custom_class +'" data-vc-content=".vc_ui-template-content"></div>');
                      ...
                      jQuery('select#salient-studio-sorting').val('date').trigger('change');
                  ...
                  //set counts
                  jQuery('.vc_edit-form-tab[data-tab="default_templates"] .library_categories ul > li').each(function(){
                      if(jQuery(this).attr('data-sort') == 'all') {
                            jQuery(this).find('.count').html( jQuery('.vc_edit-form-tab[data-tab="default_templates"] .vc_ui-template-list > .vc_ui-template').length );
                      } else {
                          jQuery(this).find('.count').html( jQuery('.vc_edit-form-tab[data-tab="default_templates"] .vc_ui-template-list > .vc_ui-template.'+jQuery(this).attr('data-sort')).length );
                      }
                  });
      
                  //filtering
                  jQuery('.vc_edit-form-tab[data-tab="default_templates"] .library_categories li[data-sort="all"]').addClass('active').trigger('click');
      
                  jQuery('.vc_edit-form-tab[data-tab="default_templates"] .library_categories li').click(function(){
                      jQuery('.vc_edit-form-tab[data-tab="default_templates"] .library_categories li').removeClass('active');
                      jQuery(this).addClass('active');
      
                      var $selectedCat = jQuery(this).attr('data-sort');
      
                      jQuery('.vc_edit-form-tab[data-tab="default_templates"] .vc_ui-template-list > .vc_ui-template').removeClass('hidden');
      
                      if($selectedCat != 'all'){
                          jQuery('.vc_edit-form-tab[data-tab="default_templates"] .vc_ui-template-list > .vc_ui-template:not(.'+$selectedCat+')').addClass('hidden');
                      }
                  });
                  /*nectar addition end*/
      },
      ...
      showMessage: function(e, a) {
          var t;
          if (this.showMessageDisabled) return !1;
          t = "vc_col-xs-12 wpb_element_wrapper", this.message_box_timeout && (this.$el.find("[data-vc-panel-message]").remove(), window.clearTimeout(this.message_box_timeout)), this.message_box_timeout = !1;
          ...
          switch (a) {
              case "error":
                  i = l('<div class="' + t + '" data-vc-panel-message>').html(c({
                      color: "danger",
                      icon: "times",
                      text: e
                  }));
      ...
      setPreviewFrameHeight: function(e, a) {
          parseInt(a, 10) < 100 && (a = 100), l('data-vc-template-preview-frame="' + e + '"').height(a)
      }
      ...
      showMessage: function(e, a) {
          ...
          var t, i = vc.template('<div class="vc_message_box vc_message_box-standard vc_message_box-rounded vc_color-<%- color %>"><div class="vc_message_box-icon"><i class="fa fa fa-<%- icon %>"></i></div><p><%- text %></p></div>'),
              c = "vc_col-xs-12 wpb_element_wrapper";
          switch (a) {
              case "error":
                  t = l('<div class="' + c + '" data-vc-panel-message>').html(i({
                      color: "danger",
                      icon: "times",
                      text: e
                  }));
          ...
          t.prependTo(this.$el.find('[data-vc-ui-element="panel-edit-element-tab"].vc_row.vc_active')), t.fadeIn(), this.message_box_timeout = window.setTimeout(function() {
              t.remove()
          }, 6e3)
      },
      changeTab: function(e) {
  ...
  }), l.fn.vcAccordion.Constructor.prototype.collapseTemplate = function(a) {
      var t, i, c, e = this.$element,
          n = 0,
          s = this.getContainer().find("[data-vc-preview-handler]").each(function() {
              var e = l(this),
                  a = e.data("vc.accordion");
              void 0 === a && (e.vcAccordion(), a = e.data("vc.accordion")), a && a.setIndex && a.setIndex(n++)
          }).filter(function() {
      ...
      s.length && l.fn.vcAccordion.call(s, "hide"), this.isActive() ? l.fn.vcAccordion.call(e, "hide") : (l.fn.vcAccordion.call(e, "show"), t = e.closest(".vc_ui-list-bar-item"), i = e.closest("[data-template_id]"), c = i.closest("[data-vc-ui-element=panel-content]").parent(), setTimeout(function() {
          var e;
          Math.round(i.offset().top - c.offset().top) < 0 && (e = Math.round(i.offset().top - c.offset().top + c.scrollTop() - t.height()), c.animate({
              scrollTop: e
          }, 400)), "function" == typeof a && a(i, c)
      }, 400))
  }
}(window.jQuery);
! function(l) {
  window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
      ...
      render: function(e, t) {
          return _.isUndefined(vc.ShortcodesBuilder) || (this.builder = new vc.ShortcodesBuilder), this.$el.is(":hidden") && window.vc.closeActivePanel(), (window.vc.active_panel = this).prepend = !!_.isBoolean(t) && t, this.place_after_id = !!_.isString(t) && t, this.model = !!_.isObject(e) && e, this.$content = this.$el.find('[data-vc-ui-element="panel-add-element-list"]'), this.$buttons = l('[data-vc-ui-element="add-element-button"]', this.$content), this.buildFiltering(), this.$el.find('[data-vc-ui-element="panel-tab-control"]').eq(0).click(), this.show(), this.$el.find('[data-vc-ui-element="panel-tabs-controls"]').vcTabsLine("moveTabs"), vc.is_mobile || l(this.searchSelector).trigger("focus"), vc.AddElementUIPanelBackendEditor.__super__.render.call(this)
      },
      buildFiltering: function() {
          var e, t, i, n = '[data-vc-ui-element="add-element-button"]',
              a = this._getNotIn(this.model ? this.model.get("shortcode") : "");
          l(this.searchSelector).val(""), this.$content.addClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", "*"), t = !(!(e = this.model ? this.model.get("shortcode") : "vc_column") || _.isUndefined(vc.getMapped(e).as_parent)) && vc.getMapped(e).as_parent, _.isObject(t) ? (i = [], _.isString(t.only) && i.push(_.reduce(t.only.replace(/\s/, "").split(","), function(e, t) {
              return e + (_.isEmpty(e) ? "" : ",") + '[data-element="' + t.trim() + '"]'
          }, "")), _.isString(t.except) && i.push(_.reduce(t.except.replace(/\s/, "").split(","), function(e, t) {
              return e + ':not([data-element="' + t.trim() + '"])'
          }, "")), n += i.join(",")) : a && (n = a), !1 === e || _.isUndefined(vc.getMapped(e).allowed_container_element) || (!1 === vc.getMapped(e).allowed_container_element ? n += ":not([data-is-container=true])" : _.isString(vc.getMapped(e).allowed_container_element) && (n += ":not([data-is-container=true]), [data-element=" + vc.getMapped(e).allowed_container_element + "]")), this.$buttons.removeClass("vc_visible").addClass("vc_inappropriate"), l(n, this.$content).removeClass("vc_inappropriate").addClass("vc_visible"), this.hideEmptyFilters()
      },
      hideEmptyFilters: function() {
          var e = this;
      ...
      filterElements: function(e) {
          var t, i, n;
          e ? (e.preventDefault && e.preventDefault(), e.stopPropagation && e.stopPropagation()) : e = window.event, t = l(e.currentTarget), i = '[data-vc-ui-element="add-element-button"]', n = l(this.searchSelector).val(), this.$content.removeClass("vc_filter-all"), l('[data-vc-ui-element="panel-add-element-tab"].vc_active').removeClass("vc_active"), t.is("[data-filter]") ? (t.parent().addClass("vc_active"), i += t = t.data("filter"), "*" === t ? this.$content.addClass("vc_filter-all") : this.$content.removeClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", t.replace(".js-category-", "")), l(this.searchSelector).val("")) : n.length ? (i += ":containsi('" + n + "'):not('.vc_element-deprecated')", this.$content.attr("data-vc-ui-filter", "name:" + n)) : n.length || (l('[data-vc-ui-element="panel-tab-control"][data-filter="*"]').parent().addClass("vc_active"), this.$content.attr("data-vc-ui-filter", "*").addClass("vc_filter-all")), l(".vc_visible", this.$content).removeClass("vc_visible"), l(i, this.$content).addClass("vc_visible"), n.length && 13 === (e.keyCode || e.which) && 1 === (t = l(".vc_visible:not(.vc_inappropriate)", this.$content)).length && t.find("[data-vc-clickable]").click()
      },
      createElement: function(e) {
          var t, i, n, a, s, r, d, c, o;
          e && e.preventDefault && e.preventDefault(), d = (e = l(e.currentTarget)).data("tag"), r = {}, s = {
              width: "1/1"
          }, (e = e.closest("[data-preset]")) && (c = e.data("preset"), o = e.data("element")), !1 === this.model ? (window.vc.storage.lock(), "vc_section" === d ? (e = {
              shortcode: d
          }, c && "vc_section" === o && (e.preset = c), i = vc.shortcodes.create(e)) : (e = {
              shortcode: "vc_row",
              params: r
          }, c && o === d && (e.preset = c), e = {
              shortcode: "vc_column",
              ...
              root_id: a.id
          }, c && "vc_column" === o && (e.preset = c), n = vc.shortcodes.create(e), i = a, "vc_row" !== d && (t = {
              shortcode: d,
              parent_id: n.id,
              root_id: a.id
          }, c && o === d && (t.preset = c), i = vc.shortcodes.create(t)))) : i = "vc_row" === d ? (n = "vc_section" === this.model.get("shortcode") ? (window.vc.storage.lock(), a = vc.shortcodes.create({
              shortcode: "vc_row",
              params: r,
              parent_id: this.model.id,
              order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder()
              ...
              order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder(),
              root_id: this.model.get("root_id")
          }, c && o === d && (t.preset = c), vc.shortcodes.create(t)), this.model = i, window.vc.latestAddedElement = i, s = !(_.isBoolean(vc.getMapped(d).show_settings_on_create) && !1 === vc.getMapped(d).show_settings_on_create), this.model.get("shortcode"), this.hide(), s && this.showEditForm();

          /* nectar addition */ 
          jQuery('.modal-backdrop.white').remove();
          /* nectar addition end */ 
      },
      getFirstPositionIndex: function() {
      ...
      createElement: function(e) {
          var t, i, n, a, s, r, d;
          for (e && e.preventDefault && e.preventDefault(), s = (e = l(e.currentTarget)).data("tag"), a = {}, n = {
                  width: "1/1"
...
! function(r) {
  window.vc.ExtendPresets = {
      ...
      saveSettingsAjaxData: function(t, e, i, n) {
          return {
      ...
      saveSettings: function(t, e) {
          var i = this.model.get("shortcode"),
              n = JSON.stringify(this.getParamsForSettingsPreset());
          if (void 0 !== t && t.length) return void 0 === e && (e = !1), this.checkAjax(), this.ajax = r.ajax({
              type: "POST",
              dataType: "json",
              url: window.ajaxurl,
              data: this.saveSettingsAjaxData(i, t, e, n),
              context: this
          }).done(function(t) {
      ...
      showSaveSettingsDialog: function(t) {
          ...
          this.isSettingsPresetDefault = !!t, this.fetchSaveSettingsDialog(function(t) {
              var n, s, a = d.$el.find(".vc_ui-panel-content-container"),
                  o = a.find(".vc_ui-prompt-presets"),
                  c = o.find(".textfield"),
                  e = (a.find(".vc_ui-prompt.vc_visible").removeClass("vc_visible"), o.find("[data-vc-view-settings-preset]"));
              "undefined" !== window.vc_vendor_settings_presets[d.model.get("shortcode")] ? e.removeAttr("disabled") : e.attr("disabled", "disabled"), o.addClass("vc_visible"), c.trigger("focus"), a.addClass("vc_ui-content-hidden"), t && (n = o.find("#vc_ui-save-preset-btn"), s = 0, o.on("submit", function() {
                  var i = c.val();
                  return i.length && d.saveSettings(i, d.isSettingsPresetDefault).done(function(t) {
                      var e = this.getParamsForSettingsPreset();
                      c.val(""), d.setCustomButtonMessage(n, void 0, void 0, !0), vc.events.trigger("vc:savePreset", t.id, d.model.get("shortcode"), i, e), s = _.delay(function() {
                          o.removeClass("vc_visible"), a.removeClass("vc_ui-content-hidden")
                      }, 5e3)
                  }).fail(function() {
                      d.setCustomButtonMessage(n, window.i18nLocale.ui_danger, "danger", !0)
                  }), !1
              }), o.on("click", ".vc_ui-prompt-close", function() {
                  return d.checkAjax(), o.removeClass("vc_visible"), a.removeClass("vc_ui-content-hidden"), d.clearCustomButtonMessage.call(this, n), s && (window.clearTimeout(s), s = 0), !1
      ...
      setSettingsMenuContent: function(t) {
          var e = this.$el.find(this.settingsButtonSelector),
              ...
              n = this.model.get("shortcode"),
              s = this;
          e.data("vcShortcodeName", n), i.html(t), window.vc_presets_data && 0 < window.vc_presets_data.presetsCount ? i.find("[data-vc-view-settings-preset]").removeAttr("disabled") : i.find("[data-vc-view-settings-preset]").attr("disabled", "disabled"), i.find("[data-vc-view-settings-preset]").on("click", function() {
              s.showViewSettingsList(), s.closeSettings()
          }), i.find("[data-vc-save-settings-preset]").on("click", function() {
              s.showSaveSettingsDialog(), s.closeSettings()
          }), i.find("[data-vc-save-template]").on("click", function() {
              s.showSaveTemplateDialog(), s.closeSettings()
          }), i.find("[data-vc-save-default-settings-preset]").on("click", function() {
              s.saveAsDefaultSettings(), s.closeSettings()
          }), i.find("[data-vc-restore-default-settings-preset]").on("click", function() {
              s.restoreDefaultSettings(), s.closeSettings()
          })
      },
      ...
      showViewSettingsList: function() {
          var e, t, i, n = this.$el.find(".vc_ui-panel-content-container");
          n.find(".vc_ui-prompt-view-presets:not(.vc_visible)").remove(), n.find(".vc_ui-prompt-view-presets").length || (n.find(".vc_ui-prompt.vc_visible").removeClass("vc_visible"), e = this, t = jQuery('<form class="vc_ui-prompt vc_ui-prompt-view-presets"><div class="vc_ui-prompt-controls"><button type="button" class="vc_general vc_ui-control-button vc_ui-prompt-close"><i class="vc-composer-icon vc-c-icon-close"></i></button></div><div class="vc_ui-prompt-title"><label for="prompt_title" class="wpb_element_label">Elements</label></div><div class="vc_ui-prompt-content"><div class="vc_ui-prompt-column"><div class="vc_ui-template-list vc_ui-list-bar" data-vc-action="collapseAll" style="margin-top: 20px;" data-vc-presets-list-content></div></div></div>'), this.buildsettingsListContent(t), t.appendTo(n), t.addClass("vc_visible"), n.addClass("vc_ui-content-hidden"), i = function() {
              return t.remove(), n.removeClass("vc_ui-content-hidden"), !1
  ...
  window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
      ...
      initialize: function() {
          _.bindAll(this, "setSize", "setTabsSize", "fixElContainment", "hookDependent", "resetAjax", "removeAllPrompts"), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this), this.on("render", this.setTitle, this), this.on("render", this.prepareContentBlock, this), window.vc_auto_save && this.on("afterRender", this.formRender, this), this.on("afterRender", function() {
              o(".edit-form-info").initializeTooltips(), this.reInitJsFunctions()
          }, this)
      },
      ...
      prepareContentBlock: function() {
          this.$content = this.notRequestTemplate ? this.$el : this.$el.find(this.contentSelector).removeClass("vc_with-tabs"), this.$content.empty(), this.$spinner = o('<span class="vc_ui-wp-spinner vc_ui-wp-spinner-lg vc_ui-wp-spinner-dark"></span>'), this.$content.prepend(this.$spinner)
      },
      buildParamsContent: function(e) {
          var t, n, i = this.model.get("id"),
              a = (this.setEditElementPanelCache(i, e), (e = (i = o(e)).find('[data-vc-ui-element="panel-tabs-controls"]')).find(".vc_edit-form-tab-control:first-child").addClass("vc_active"), t = this.$el.find('[data-vc-ui-element="panel-header-content"]'), (n = i.find('[data-vc-ui-element="panel-edit-element-tab"]')) && n.addClass("visually-hidden"), t && t.addClass("visually-hidden"), this.$content.html(i).append("<script async>window.setTimeout(function(){window.wpb_edit_form_loaded=true;},100);<\/script>"), this.$content.prepend(this.$spinner), e.prependTo(t), this),
              s = 0,
              /* nectar addition - nectarVcAfterRenderBindThis in call back (c) */
              nectarVcAfterRenderBindThis = nectarVcAfterRender.bind(this),
              c = function() {
                  !window.wpb_edit_form_loaded && s < 10 ? (s++, setTimeout(c, 100)) : (a.$content.removeAttr("data-vc-param-initialized"), a.active_tab_index = 0, a.tabsInit = !1, a.panelInit = !1, a.dependent_elements = {}, a.requiredParamsInitialized = !1, a.$content.find("[data-vc-param-initialized]").removeAttr("data-vc-param-initialized"), n.removeClass("visually-hidden"), a.$content.find(".vc_ui-wp-spinner").remove(), a.init(), a.$content.parent().scrollTop(1).scrollTop(0), a.$content.removeClass("vc_properties-list-init"), a.$el.trigger("vcPanel.shown"), a.trigger("afterRender"), nectarVcAfterRenderBindThis() )
              };
          ...
          function nectarVcAfterRender() {
            ...
            jQuery.each(this.model.collection.models,function(k,v){
            ...
            if(v.attributes.id == $rootId || v.attributes.id == $parentId) {
                ...
                //jQuery('select.column_padding, select.column_padding_position').parents('.wpb_el_type_dropdown').show();
                jQuery('input.boxed, input.full_width').parents('.wpb_el_type_checkbox').hide();
                jQuery('.wpb_edit_form_elements').addClass('full-width-content-parent');
                } else if(v.attributes.id != $rootId && v.attributes.id != $parentId) {
                //jQuery('select.column_padding, select.column_padding_position').parents('.wpb_el_type_dropdown').hide();
                jQuery('input.boxed, input.full_width').parents('.wpb_el_type_checkbox').show();
                jQuery('.wpb_edit_form_elements').removeClass('full-width-content-parent');
                }

                
                if(jQuery('.wpb-textinput.background_color').length > 0 && jQuery('.gallery_widget_attached_images_ids').length > 0 && !jQuery('.wpb_edit_form_elements').hasClass('full-width-content-parent')){
                if(jQuery('.wpb-textinput.background_color').val().length > 0 || jQuery('.gallery_widget_attached_images_ids').val().length > 0) {
                    //jQuery('select.column_padding, select.column_padding_position').parents('.wpb_el_type_dropdown').show();
                    jQuery('input.boxed').parents('.wpb_el_type_checkbox').hide();
                } else {
                    //jQuery('select.column_padding, select.column_padding_position').parents('.wpb_el_type_dropdown').hide();
                    jQuery('input.boxed').parents('.wpb_el_type_checkbox').show();
                }
                }
            ...
            jQuery('.wpb-textinput.background_color, .gallery_widget_attached_images_ids').change(function(){
            
            if(!jQuery('.wpb_edit_form_elements').hasClass('full-width-content-parent')) {
            
                if(jQuery('.wpb-textinput.background_color').length > 0 && jQuery('.wpb-textinput.background_color').val().length > 0 || jQuery('.gallery_widget_attached_images_ids').length > 0 && jQuery('.gallery_widget_attached_images_ids').val().length > 0) {
                //the parent row is set to full width content
                //jQuery('select.column_padding, select.column_padding_position').parents('.wpb_el_type_dropdown').show();
                jQuery('input.boxed').parents('.wpb_el_type_checkbox').hide();
                } else {
            ...
            jQuery('div[data-vc-shortcode="nectar_flip_box"] .nectar-shortcode-generator').addClass('slim');
            
            jQuery('.wp-picker-holder, .wp-picker-clear, .iris-slider, .iris-square, .wpb_edit_form_elements').click(function(){
            
            if(!jQuery('.wpb_edit_form_elements').hasClass('full-width-content-parent')) {
            
                if(jQuery('.wpb-textinput.background_color').length > 0 && jQuery('.gallery_widget_attached_images_ids').length > 0){
                if(jQuery('.wpb-textinput.background_color').attr('value').length > 0 || jQuery('.gallery_widget_attached_images_ids').val().length > 0) {
                    //the parent row is set to full width content
                //  jQuery('select.column_padding, select.column_padding_position').parents('.wpb_el_type_dropdown').show();
                    jQuery('input.boxed').parents('.wpb_el_type_checkbox').hide();
                } else {
            ...
            if(jQuery(this).val() != 'image_grid') jQuery('style.wp-gallery-extra-input').remove();
            })
            
            verticallyCenterColumns();
            jQuery('#equal_height-yes, [data-vc-shortcode="vc_row"] select[name=type]').change(function(){
            verticallyCenterColumns();
            });
            function verticallyCenterColumns() {
                if(jQuery('#equal_height-yes').is(':checked') && jQuery('select[name="type"]').val() == 'full_width_content')
                    jQuery('#vertically_center_columns-true').parents('.vc_column').hide();
                else if(!jQuery('#equal_height-yes').is(':checked')  && jQuery('select[name="type"]').val() == 'full_width_content')
                    jQuery('#vertically_center_columns-true').parents('.vc_column').show();

                //full height row hide
                if(jQuery('select[name="type"]').val() == 'full_width_content' && jQuery('._nectar_full_screen_rows label[for="nectar_meta_on"].ui-state-active').length > 0) {

                    jQuery('select[name="full_screen_row_position"] .full_height').show();

                } else if(jQuery('select[name="type"]').val() == 'full_width_background' && jQuery('._nectar_full_screen_rows label[for="nectar_meta_on"].ui-state-active').length > 0) {
                
                    jQuery('select[name="full_screen_row_position"] .full_height').hide();
                    if(jQuery('select[name="full_screen_row_position"]').val() == 'full_height') jQuery('select[name="full_screen_row_position"] .middle').attr('selected','selected');
                        
                }

                //disable ken burns hide
                if(jQuery('._nectar_full_screen_rows label[for="nectar_meta_on"].ui-state-active').length > 0 && jQuery('select#_nectar_full_screen_rows_row_bg_animation').val() == 'ken_burns')
                    jQuery('.vc_shortcode-param[data-vc-shortcode-param-name="disable_ken_burns"]').show();
                else {
                    jQuery('.vc_shortcode-param[data-vc-shortcode-param-name="disable_ken_burns"]').hide();
                }

            }
            
            //fullscreen rows functionality change
            if(jQuery('._nectar_full_screen_rows label[for="nectar_meta_on"].ui-state-active').length > 0) {
                jQuery('.wpb_el_type_dropdown select .in_container').hide();
                if(jQuery('.wpb_el_type_dropdown select[data-option="in_container"]').length > 0) jQuery('.wpb_el_type_dropdown select .full_width_background').attr('selected','selected');
                jQuery('div[data-vc-shortcode-param-name="parallax_bg"]').hide();
                jQuery('div[data-vc-shortcode-param-name="full_height"]').hide();
                jQuery('div[data-vc-shortcode-param-name="columns_placement"]').hide();
                jQuery('div[data-vc-shortcode="vc_row"] .top_padding, div[data-vc-shortcode="vc_row"] .bottom_padding').parents('.vc_column').hide();
                jQuery('select.full_screen_row_position, input[name="row_name"]').parents('.vc_column').show();
            } else {
                jQuery('select.full_screen_row_position, input[name="row_name"]').parents('.vc_column').hide();
            }
            ...
            function updateHotSpotData(rel,x,y) {
                ...
                //update arr of objs
                $hotSpotData[rel-1] = { 'left': x, 'top': y, 'content': jQuery('.hotspot-content[data-rel="'+rel+'"] textarea').val(), 'position': jQuery('.hotspot-content[data-rel="'+rel+'"] select').val() }
                
                //store it / convert to shortcodes
                $that.$convertedData = '';
                jQuery.each($hotSpotData,function(k,v){
            ...
            function hotspotMakeDraggable() {
                ...
                jQuery('#nectar_image_with_hotspots_preview .hotspot:not(.ui-draggable)').draggable({
                    containment: 'parent',
            ...
            function hotspotUpdateNumbers() {
                jQuery('#nectar_image_with_hotspots_preview .hotspot').each(function(i){
                    jQuery(this).html(i+1);
                    jQuery(this).attr('data-rel',i+1);
                });

                jQuery('.hotspot-content').each(function(i){
            ...
            if(jQuery('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0) { 

                jQuery('body').on('click','[data-vc-shortcode="nectar_image_with_hotspots"] .vc_icon-remove',function(){
                    jQuery('#nectar_image_with_hotspots_preview').addClass('no-img');
                });
                
                if(jQuery('[data-vc-shortcode="nectar_image_with_hotspots"]  [name="preview"]').val().length == 0) {
                    jQuery('#nectar_image_with_hotspots_preview').addClass('no-img');
                }

                ////set up initial data
                var $hotSpotData = [];
                if(jQuery('[data-vc-shortcode-param-name="content"] .vc_textarea_html_content').val().length > 0) {

                    var hotspotRegex = wp.shortcode.regexp('nectar_hotspot'),
                        matches;

                    while (matches = hotspotRegex.exec(jQuery('[data-vc-shortcode-param-name="content"] .vc_textarea_html_content').val())) {
                ...
                if($hotSpotData.length > 0) {
                    ...
                    jQuery.each($hotSpotData,function(k,v){
                        //hotspot
                        jQuery('#nectar_image_with_hotspots_preview').append('<div class="hotspot" data-rel="'+(k+1)+'" style="top: '+v.top+'; left: '+v.left+';">'+(k+1)+'</div>');
                ...
                ////add new with click
                jQuery('#nectar_image_with_hotspots_preview:not(#nectar_image_with_hotspots_preview .hotspot)').click(function(e){
                    ...
                    var posX = jQuery(this).offset().left,
                        ...
                        hotSpots = jQuery('#nectar_image_with_hotspots_preview .hotspot').length;
                        hotSpots++;
                ...
                jQuery('body').on('click.hotspot-delete-event','.hotspot-content a.delete',function(e){
                    var $confirm = confirm('Are you sure you want to delete? There is no undo.');

                    if($confirm == false) return false;

                    var $rel = jQuery(this).parents('.hotspot-content').attr('data-rel');
                    jQuery(this).parents('.hotspot-content').remove();
                    ...
                    jQuery('#nectar_image_with_hotspots_preview .hotspot').each(function(i){
                        updateHotSpotData(i+1, jQuery(this)[0].style.left , jQuery(this)[0].style.top);
                    });
                ...
                jQuery('body').on('keyup','.hotspot-content textarea',function(){
                    var $rel = jQuery(this).parents('.hotspot-content').attr('data-rel');

                    updateHotSpotData($rel, jQuery('#nectar_image_with_hotspots_preview .hotspot[data-rel="'+$rel+'"]')[0].style.left , jQuery('#nectar_image_with_hotspots_preview .hotspot[data-rel="'+$rel+'"]')[0].style.top);
                });

                //update when changing select
                jQuery('body').on('change','.hotspot-content select',function(){
                    var $rel = jQuery(this).parents('.hotspot-content').attr('data-rel');
            ...
            function mouseParallaxDepends(){
                ...
                jQuery('.bg_position, .bg_repeat').parent().parent().hide();
                        jQuery('.scene_position, .mouse_sensitivity, .layer_one_image, .layer_one_strength, .layer_two_image, .layer_two_strength, .layer_three_image, .layer_three_strength, .layer_four_image, .layer_four_strength, .layer_five_image, .layer_five_strength').parent().parent().show();
                } else {
                jQuery('.bg_position, .bg_repeat').parent().parent().show();
                    jQuery('.scene_position, .mouse_sensitivity, .layer_one_image, .layer_one_strength, .layer_two_image, .layer_two_strength, .layer_three_image, .layer_three_strength, .layer_four_image, .layer_four_strength, .layer_five_image, .layer_five_strength').parent().parent().hide();
                }
                
            }
            
                if(jQuery('.mouse_based_parallax_bg').is(':checked')) { 
                jQuery('.bg_position, .bg_repeat').parent().parent().hide();
            }

            jQuery('.mouse_based_parallax_bg').change(mouseParallaxDepends);
            jQuery('.mouse_based_parallax_bg').trigger('change');


            //add one-half column classes to mouse based parallax
            jQuery('.layer_one_strength, .layer_two_strength, .layer_three_strength, .layer_four_strength, .layer_five_strength').parent().parent().addClass('one-half-last');
            jQuery('.layer_one_image, .layer_two_image, .layer_three_image, .layer_four_image, .layer_five_image').parent().parent().addClass('one-half');
            jQuery('.text_color').parent().parent().addClass('clear');
            jQuery('.layer_one_strength, .layer_one_image').parent().parent().addClass('tall-fixed-height');
      ...
      ajaxData: function() {
          var e = this.model.get("parent_id"),
              e = e ? this.model.collection.get(e).get("shortcode") : null,
              t = this.model.get("params"),
              t = _.extend({}, vc.getDefaults(this.model.get("shortcode")), t);
          return {
              action: "vc_edit_form",
              tag: this.model.get("shortcode"),
              parent_tag: e,
      ...
      init: function() {
          vc.EditElementPanelView.__super__.init.call(this), this.$el.find('[data-vc-ui-element="panel-header-content"]').removeClass("visually-hidden"), this.initParams(), this.initDependency(), o(".wpb_edit_form_elements .textarea_html").each(function() {
              window.init_textarea_html(o(this))
          }), this.trigger("init"), this.panelInit = !0
      },
      initParams: function() {
          var n = this,
              e = this.content().find('#vc_edit-form-tabs [data-vc-ui-element="panel-edit-element-tab"]:eq(' + this.active_tab_index + ")");
          (e = e.length ? e : this.content()).attr("data-vc-param-initialized") || (o('[data-vc-ui-element="panel-shortcode-param"]', e).each(function() {
              var e, t = o(this);
              t.data("vcInitParam") || (e = t.data("param_settings"), vc.atts.init.call(n, e, t), t.data("vcInitParam", !0))
          }), e.attr("data-vc-param-initialized", !0)), this.requiredParamsInitialized || _.isUndefined(vc.required_params_to_init) || (o('[data-vc-ui-element="panel-shortcode-param"]', this.content()).each(function() {
              var e, t = o(this);
      ...
      initDependency: function() {
          ...
          _.each(this.mapped_params, function(e) {
              var t, n, i;
              _.isObject(e) && _.isObject(e.dependency) && (t = e.dependency, _.isString(e.dependency.element) && (n = o("[name=" + e.dependency.element + "].wpb_vc_param_value", this.$content), i = o("[name= " + e.param_name + "].wpb_vc_param_value", this.$content), _.each(n, function(e) {
                  var e = o(e),
                      t = e.attr("name");
      ...
      hookDependent: function(e) {
          var i, t = o(e.currentTarget),
              n = t.closest(".vc_column"),
              a = this.dependent_elements[t.attr("name")],
              s = t.is(":checkbox") ? _.map(this.$content.find("[name=" + o(e.currentTarget).attr("name") + "].wpb_vc_param_value:checked"), function(e) {
                  return o(e).val()
              }) : t.val(),
              e = this.doCheckTabs;
      ...
      checkTabs: function() {
          ...
          !1 === this.tabsInit && (this.tabsInit = !0, this.$content.hasClass("vc_with-tabs")) && (this.$tabsMenu = this.$content.find(".vc_edit-form-tabs-menu")), this.$tabsMenu && (this.$content.find('[data-vc-ui-element="panel-edit-element-tab"]').each(function(e) {
              ...
              o(this).find('[data-vc-ui-element="panel-shortcode-param"]:not(".vc_dependent-hidden")').length ? t.hasClass("vc_dependent-hidden") && (t.removeClass("vc_dependent-hidden").removeClass("vc_tab-color-animated").addClass("vc_tab-color-animated"), window.setTimeout(function() {
      ...
      save: function(e) {
        ...
        if(jQuery('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0 && this.$convertedData.length > 0) {
          ...
          if (this.panelInit && this.model) {
              ...
              if (!_.isUndefined(i.content)) {
                  if (t) try {
                      i.content = window.vc.htmlHelpers.fixUnclosedTags(i.content)
                  } catch (e) {
                      console.error("Failed to execute window.vc.htmlHelpers.fixUnclosedTags function: ", e)
                  }
                  a.content = i.content
              }
              e.model.save({
      ...
      _killEditor: function() {
          _.isUndefined(window.tinyMCE) || o("textarea.textarea_html", this.$el).each(function() {
      ...
      show: function() {
          vc.EditElementUIPanel.__super__.show.call(this), o('[data-vc-ui-element="panel-tabs-controls"]', this.$el).remove(), this.$el.css("maxHeight", "75vh")
      },
      tabsMenu: function() {
          var e;
      ...
      checkTabs: function() {
          ...
          !1 === this.tabsInit && (this.tabsInit = !0, this.$tabsMenu = this.$el.find('[data-vc-ui-element="panel-tabs-controls"]')), this.tabsMenu() && (this.content().find('[data-vc-ui-element="panel-edit-element-tab"]').each(function(e) {
              var t = n.$tabsMenu.find('> [data-tab-index="' + e + '"]');
              o(this).find('[data-vc-ui-element="panel-shortcode-param"]:not(".vc_dependent-hidden")').length ? t.hasClass("vc_dependent-hidden") && (t.removeClass("vc_dependent-hidden"), window.setTimeout(function() {
                  t.removeClass("vc_tab-color-animated")
              }, 200)) : window.setTimeout(function() {
                  t.addClass("vc_dependent-hidden")
              }, 0)
...
! function(l) {
  window.vc.TemplateLibraryView = vc.PanelView.vcExtendUI(vc.HelperAjax).extend({
      ...
      removeStorage: function(e) {
          try {
              localStorage.removeItem("vc4-" + e), localStorage.removeItem("vc4-" + e + "_expiresIn")
          } catch (e) {
              return !1
          }
          return !0
      ...
      getStorage: function(e) {
          var t = Date.now(),
              a = localStorage.getItem("vc4-" + e + "_expiresIn");
          if ((a = null == a ? 0 : a) < t) return this.removeStorage(e), null;
          try {
              return JSON.parse(localStorage.getItem("vc4-" + e))
          } catch (e) {
              return null
          }
      },
...
! function(e) {
  vc.PostSettingsUIPanelFrontendEditor = vc.PostSettingsPanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).vcExtendUI({
      ...
      removeChangeTitleField: function() {
          e("#vc_settings-title-container").remove()
      }
  })
}(window.jQuery);
! function() {
  ...
  function(r, c, a) {
      window.vc_toTitleCase = function(e) {
          ...
          e.source_data = function(e, n) {
              ...
              t = a(this).val(), e.source_data_val != t && (e.source_data = function(e, n) {
                  return {
                      query: {
                          query: t,
                          term: e.term
  ...
  function(d) {
      ...
      function i(e, t) {
          this.el = e, this.$el = d(this.el), this.$el_wrap = "", this.$block = "", this.suggester = "", this.selected_items = [], this.options = _.isObject(t) ? t : {}, _.defaults(this.options, {
              ...
              predefined: [],
              locked: !1,
              select_callback: function(e, t) {},
              remove_callback: function(e, t) {},
              update_callback: function(e, t) {},
              check_locked_callback: function(e, t) {
                  return !1
              }
          }), this.init()
      }
      window.init_textarea_html = function(t) {
          var a, e, n, i = d("#wp-link");
          i.parent().hasClass("wp-dialog") && i.wpdialog("destroy"), a = t.attr("id"), e = (i = t.closest(".edit_form_line")).find(".vc_textarea_html_content");
          try {
              _.isUndefined(tinyMCEPreInit.qtInit[a]) && (window.tinyMCEPreInit.qtInit[a] = _.extend({}, window.tinyMCEPreInit.qtInit[window.wpActiveEditor], {
                  id: a
              })), window.tinyMCEPreInit && window.tinyMCEPreInit.mceInit[window.wpActiveEditor] && (n = !1, window.tinyMCEPreInit.mceInit[a] = _.extend({}, window.tinyMCEPreInit.mceInit[window.wpActiveEditor], {
                  resize: "vertical",
                  height: 200,
                  id: a,
                  setup: function(e) {
                      var t;
                      void 0 !== e.onLoadContent && e.onLoadContent.add(function(e, t) {
                          var n = setTimeout(function() {
                              1 === d("#" + a).size() && (d(".vc_edit-form-tab *:input[type!=hidden]:first").focus(), clearTimeout(n))
                          }, 100)
                      }), void 0 !== e.on ? (e.on("init", function(e) {
                          window.wpActiveEditor = a
                      }), window.vc_auto_save && (t = _.debounce(function() {
                          vc.edit_element_block_view.save(), n = !1
                      }, 500), e.on("keyup", function() {
                          n = !0, vc.saveInProcess = !0, t()
                      }), e.on("blur", function() {
                          n && !vc.saveInProcess && (vc.saveInProcess = !0, vc.edit_element_block_view.save(), n = !1)
                      }), e.on("ExecCommand", t), d("#wpb_tinymce_content").on("change", function(e) {
                          n = !0, vc.saveInProcess = !0, t()
                      }))) : e.onInit.add(function() {
                          window.wpActiveEditor = a
                      })
                  }
              }), window.tinyMCEPreInit.mceInit[a].plugins = window.tinyMCEPreInit.mceInit[a].plugins.replace(/,?wpfullscreen/, ""), window.tinyMCEPreInit.mceInit[a].wp_autoresize_on = !1), vc.edit_element_block_view && vc.edit_element_block_view.currentModelParams ? t.val(vc_wpautop(vc.edit_element_block_view.currentModelParams[e.attr("name")] || "")) : t.val(e.val()), quicktags(window.tinyMCEPreInit.qtInit[a]), QTags._buttonsInit(), window.tinymce && (window.switchEditors && window.switchEditors.go(a, "tmce"), "4" === tinymce.majorVersion) && tinymce.execCommand("mceAddEditor", !0, a), window.wpActiveEditor = a
          } catch (e) {
              t.data("vcTinyMceDisabled", !0).appendTo(i), d("#wp-" + a + "-wrap").remove(), console && console.error && (console.error("VC: Tinymce error! Compatibility problem with other plugins."), console.error(e))
          }
      ...
      s.prototype = {
          ...
          save: function() {
              var e = _.map(this.$current_control.find("[data-name]"), function(e) {
                  ...
                  return d(e).find("select").each(function() {
                      var e = d(this);
                      e.is("select") && "" !== e.val() && (t += "|" + encodeURIComponent(e.val()))
                  }), t
              }).join(",");
      ...
      var r = Backbone.View.extend({
              ...
              fontFamilyDropdownChange: function() {
                  ...
                  return this.font_family_url = e.val(), this.font_family = e.attr("data[font_family]"), this.font_types = e.attr("data[font_types]"), this.$font_style_dropdown_el_container.parent().hide(), this.font_family_url && 0 < this.font_family_url.length && WebFont.load({
                      google: {
          ...
          l = Backbone.View.extend({
              ...
              sortableCreate: function(e, t) {},
              sortableUpdate: function(e, t) {
                  var n = this.$sortable_wrapper.sortable("toArray", {
                          attribute: "data-index"
                      }),
                      a = [],
                      i = (_.each(n, function(e) {
                          a.push(this.selected_items[e])
                      }, this), 0);
                  d("li.vc_data", this.$sortable_wrapper).each(function() {
                      d(this).attr("data-index", i++)
                  }), this.selected_items = a, this.updateItems()
              },
              getWidget: function() {
              ...
              open: function(e, t) {
                  var n = this.getWidget().menu(),
                      a = n.position();
                  n.css("left", a.left - 6), n.css("top", a.top + 2)
              },
              focus: function(e, t) {
              ...
              labelRemoveClick: function(e, t) {
                  e.preventDefault();
                  var n = d(e.currentTarget);
                  if (d(e.target).is(".vc_autocomplete-remove")) return this.selected_items.splice(n.index(), 1), n.remove(), this.updateItems(), this.$el.show(), !1
              },
              ...
              hookDependent: function(e) {
                  ...
                  return t.hasClass("vc_dependent-hidden") ? _.each(n, function(e) {
                      ...
                      var t = e.attr("name"),
                          ...
                          n = e.closest(".vc_column");
                      _.isBoolean(t.not_empty) && !0 === t.not_empty && !i || _.isBoolean(t.is_empty) && !0 === t.is_empty && i || t.value && _.intersection(_.isArray(t.value) ? t.value : [t.value], _.isArray(a) ? a : [a]).length || t.value_not_equal_to && !_.intersection(_.isArray(t.value_not_equal_to) ? t.value_not_equal_to : [t.value_not_equal_to], _.isArray(a) ? a : [a]).length ? n.removeClass("vc_dependent-hidden") : n.addClass("vc_dependent-hidden"), (t = d.Event("change")).extra_type = "vcHookDependedParamGroup", e.trigger(t)
                  }, this), this
              },
          ...
          h = (window.i18nLocale, vc.edit_form_callbacks = [], vc.atts = {
              parse: function(e) {
              ...
              parse: function(t) {
                  var n, t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]");
                  try {
                      n = window.vc.htmlHelpers.fixUnclosedTags(t.val())
                  } catch (e) {
                      n = t.val(), console.error("Failed to execute window.vc.htmlHelpers.fixUnclosedTags function: ", e)
                  }
                  return base64_encode(rawurlencode(n))
              },
              render: function(e, t) {
              ...
              parse: function(e) {
                  ...
                  }), d("[data-model-id=" + this.model.id + "]").data("field-" + e.param_name + "-attach-images", n), t.length ? t.val() : null
              },
              render: function(e, t) {
                  var n = this.$el.find(".attachment-thumbnails[data-name=" + e.param_name + "]");
                  return "external_link" === this.model.getParam("source") && (t = this.model.getParam("custom_srcs")), _.isEmpty(t) ? (this.$el.removeData("field-" + e.param_name + "-attach-images"), vc.atts.attach_images.updateImages(n, "")) : d.ajax({
                      type: "POST",
                      url: window.ajaxurl,
                      data: {
          ...
          // nectar addition - image render in editor
          vc.atts.fws_image = {
            parse: function(param) {
                var $field = this.content().find(".wpb_vc_param_value[name=" + param.param_name + "]"),
                    image_src = "";
                return $field.parent().find("li.added").length && (image_src = $field.parent().find("li.added img").attr("src")), jQuery("[data-model-id=" + this.model.id + "]").data("field-" + param.param_name + "-attach-image", image_src), $field.length ? $field.val() : null
            },
            render: function(param, value) {
              var $model = jQuery("[data-model-id=" + this.model.id + "]"),
            ...
            // images from Salient studio
            if (value && value.length > 0 && value.indexOf('://themenectar.com/') > -1) {
                image_data.image_src = value;
                vc.atts.fws_image.updateImage($thumbnail, image_data, true)
                return;
            }

              return 'image_url' === param.param_name && 
                ("external_link" === this.model.getParam("source") ? 
                (image_data.image_src = this.model.getParam("custom_src"), 
                vc.atts.fws_image.updateImage($thumbnail, image_data)) :
                      _.isEmpty(value) && "featured_image" !== this.model.getParam("source") ?
                      _.isUndefined(image_src) || ($model.removeData("field-" + param.param_name + "-attach-image"), 
                ...
                jQuery.ajax({
                  ...
                  var image_exists;
                  response.success && (image_exists = response.data.image_src.length || "featured_image" === this.model.getParam("source"), vc.atts.fws_image.updateImage($thumbnail, response.data, image_exists))
              })), value
          },
        ...
        vc.atts.attach_image = {
              parse: function(e) {
                  var t = this.content().find(".wpb_vc_param_value[name=" + e.param_name + "]"),
                      n = "";
                  return t.parent().find("li.added").length && (n = t.parent().find("li.added img").attr("src")), d("[data-model-id=" + this.model.id + "]").data("field-" + e.param_name + "-attach-image", n), t.length ? t.val() : null
              },
              render: function(e, t) {
              ...
              parse: function(e) {
                  var e = this.content().find(".wpb_vc_param_value[name=" + e.param_name + "]").parent(),
                      t = {};
                  return t.font_family = e.find(".vc_google_fonts_form_field-font_family-select > option:selected").val(), t.font_style = e.find(".vc_google_fonts_form_field-font_style-select > option:selected").val(), e = _.map(t, function(e, t) {
            ...
            init: function(param, $field) {
                jQuery(".vc_color-control", $field).each(function() {
                    var $alpha, $alpha_output, $pickerContainer, $control = jQuery(this),
                        value = $control.val().replace(/\s+/g, ""),
                        alpha_val = 100;

                        var $nectarColor1 = ( jQuery(this).is('[data-color-1]') ) ? jQuery(this).attr('data-color-1') : '#dd3333';
                        var $nectarColor2 = ( jQuery(this).is('[data-color-2]') ) ? jQuery(this).attr('data-color-2') : '#dd9933';
                        var $nectarColor3 = ( jQuery(this).is('[data-color-3]') ) ? jQuery(this).attr('data-color-3') : '#eeee22';
                        var $nectarColor4 = ( jQuery(this).is('[data-color-4]') ) ? jQuery(this).attr('data-color-4') : '#81d742';
            ...
            /* nectar addition end */
              ...
              init: function(t, n) {
                  var a = n.find(".wpb_vc_param_value"),
                      e = d.extend({
                          iconsPerPage: 100,
                  ...
                  n.find(".vc-iconpicker").vcFontIconPicker(e).on("change", function(e) {
                      var t = d(this);
                      t.data("vc-no-check") || a.data("vc-no-check", !0).val(this.value).trigger("change"), t.data("vc-no-check", !1)
                  }), a.on("change", function(e) {
                      a.data("vc-no-check") || vc.atts.iconpicker.change.call(this, t, n), a.data("vc-no-check", !1)
                  })
              }
...
! function(n) {
  vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function() {
      ...
      isChanged: !1,
      create: function(t) {
          return t.id || (t.id = t.attributes.id = vc_guid()), this.data[t.id] = t.toJSON(), this.setModelRoot(t.id), this.save(), t
      },
      lock: function() {
          this.locked = !0
      },
      ...
      setModelRoot: function(t) {
          t = this.data[t];
          _.isString(t.parent_id) && _.isObject(this.data[t.parent_id]) && (t.root_id = this.data[t.parent_id].root_id), _.isObject(this.data[t.root_id]) && (this.data[t.root_id].html = !1)
      },
      update: function(t) {
          return this.data[t.id] = t.toJSON(), this.setModelRoot(t.id), this.save(), t
      },
      destroy: function(t) {
          return _.isUndefined(this.data[t.id]) || _.isUndefined(this.data[t.id].root_id) || !_.isObject(this.data[this.data[t.id].root_id]) || (this.data[this.data[t.id].root_id].html = !1), _.isUndefined(this.data[t.id]) || delete this.data[t.id], this.save(), t
      },
      find: function(t) {
          return this.data[t]
      },
      ...
      findAllRootSorted: function() {
          var t = _.filter(_.values(this.data), function(t) {
              return !1 === t.parent_id
          });
      ...
      escapeParam: function(t) {
          return _.isUndefined(t) || _.isNull(t) || !t.toString ? "" : t.toString().replace(/"/g, "``").replace(/\[/g, "`{`").replace(/\]/g, "`}`")
      },
      unescapeParam: function(t) {
          return t = t.replace(/\`{\`/g, "[").replace(/\`}\`/g, "]").replace(/(\`{2})/g, '"'), t = vc_wpnop(t)
      },
      storageCreateShortcodeString: function(t) {
          var e, n = t.get("shortcode"),
              i = _.extend({}, t.get("params")),
              o = {},
              i = vc.getMergedParams(n, i);
          return _.each(i, function(t, e) {
              o[e] = this.escapeParam(t)
          }, this), i = vc.getMapped(n), i = _.isObject(i) && (_.isBoolean(i.is_container) && !0 === i.is_container || !_.isEmpty(i.as_parent)), e = this._storageGetShortcodeContent(t), e = {
              tag: n,
              attrs: o,
              content: e,
              type: _.isUndefined(vc.getParamSettings(n, "content")) && !i ? "single" : ""
          }, t.trigger("stringify", t, e), wp.shortcode.string(e)
      },
      save: function() {
          var t;
          return this.locked ? this.locked = !1 : (t = _.reduce(this.findAllRootSorted(), function(t, e) {
              e = vc.shortcodes.get(e);
              return t + this.storageCreateShortcodeString(e)
          }, "", this), this.setContent(t), this.checksum = vc_globalHashCode(t), this)
      },
      _storageGetShortcodeContent: function(e) {
          var t = _.sortBy(_.filter(this.data, function(t) {
              return t.parent_id === e.get("id")
          }), function(t) {
              return t.order
          });
          return t.length ? _.reduce(t, function(t, e) {
              e = vc.shortcodes.get(e);
              return t + this.storageCreateShortcodeString(e)
      ...
      getContent: function() {
        /* nectar addition */ 
        //return _.isObject(window.tinymce) && tinymce.editors.content && tinymce.editors.content.save(), window.vc_wpnop(jQuery("#content").val() || "")

        if ( _.isObject( window.tinymce ) && tinymce.editors.content ) {
            tinymce.editors.content.save();
        }
        if(jQuery('#nectar-metabox-portfolio-extra').length == 0){ 
                return window.vc_wpnop(jQuery('#content').val() || "");
        } 
        //portfolio extra
        else {
            return window.vc_wpnop(jQuery('textarea#_nectar_portfolio_extra_content').val());
        }
        /* nectar addition end */ 
      },
      addUndo: _.debounce(function(t) {
          vc.undoRedoApi && vc.undoRedoApi.add(t)
      }, 100),
      setContent: function(t) {

        /* nectar addition */ 
        var tinyMceGet = 'content';
        var jQuerySelector = '#content';
        if(jQuery('#nectar-metabox-portfolio-extra').length > 0){ 
            tinyMceGet = '_nectar_portfolio_extra_content';
            jQuerySelector = 'textarea#_nectar_portfolio_extra_content';
        }
          this.addUndo(t);
          var e = window.tinyMCE && window.tinyMCE.get && window.tinyMCE.get(tinyMceGet);
          t = vc_wpautop(t), this.isChanged || window.jQuery(window).on("beforeunload.vcSave", function() {
              return window.i18nLocale.confirm_to_leave
          }), this.isChanged = !0, n(jQuerySelector).val(t), e && e.setContent && (e.setContent(t), e.fire("change"))
           /* nectar addition end */ 
        },
        /* nectar addition */ 
     ...
     //* nectar addition end */ 
      ...
      wrapData: function(t) {
          var e = _.keys(vc.map).join("|"),
              n = this.regexp_split("vc_row"),
              i = new RegExp("^\\[(\\[?)(" + e + ")", "g"),
              o = this,
              r = {},
              c = 0,
              e = (t = wp.shortcode.replace("vc_section", t, function(t) {
                  var t = {
                          attrs: t.attrs.named,
                          content: o.wrapData(t.content)
                      },
                      e = "vc_pseudo_section_" + ++c + "_" + VCS4() + VCS4();
                  return r[e] = {
                      tag: e,
                      data: t
                  }, '[vc_row][vc_pseudo_section id="' + e + '"][/vc_pseudo_section][/vc_row]'
              }), _.filter(t.trim().split(n), function(t) {
                  if (!_.isEmpty(t)) return t
              }));
          return t = _.reduce(e, function(t, e) {
              var n = (e = -1 !== e.trim().indexOf("vc_pseudo_section_") || e.trim().match(i) ? e : "[vc_row][vc_column][vc_column_text]" + e + "[/vc_column_text][/vc_column][/vc_row]").match(vc_regexp_shortcode());
              return t + (e = !_.isArray(n) || _.isUndefined(n[2]) || -1 !== n[2].indexOf("vc_pseudo_section_") || _.isUndefined(vc.map[n[2]]) || !_.isUndefined(vc.map[n[2]].is_container) && vc.map[n[2]].is_container || !_.isEmpty(vc.map[n[2]].as_parent) ? e : "[vc_row][vc_column]" + e + "[/vc_column][/vc_row]")
          }, ""), 0 < Object.keys(r).length && (t = (t = t.replace(/\[vc_row\]\[vc_pseudo_section/g, "[vc_pseudo_section")).replace(/\[\/vc_pseudo_section\]\[\/vc_row\]/g, "[/vc_pseudo_section]"), t = wp.shortcode.replace("vc_pseudo_section", t, function(t) {
              t = r[t.attrs.named.id];
      ...
      fetch: function() {
          ...
          this.checksum = vc_globalHashCode(t), t = this.wrapData(t), this.data = this.parseContent({}, t)
      },
      append: function(t) {
          ...
          try {
              ...
              window.console && window.console.warn && window.console.warn("storage.append error", t)
          }
      },
      regexp_split: _.memoize(function(t) {
          return new RegExp("(\\[(\\[?)[" + t + "]+(?![\\w-])[^\\]\\/]*[\\/(?!\\])[^\\]\\/]*]?(?:\\/]\\]|\\](?:[^\\[]*(?:\\[(?!\\/" + t + "\\])[^\\[]*)*\\[\\/" + t + "\\])?)\\]?)", "g")
      }),
      regexp: _.memoize(function(t) {
          return new RegExp("\\[(\\[?)(" + t + ")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)")
      })
...
! function() {
  ...
  vc.shortcode = Backbone.Model.extend({
      ...
      removeEvents: function(e) {
          vc.events.triggerShortcodeEvents("destroy", e)
      },
      sync: function(e, t, n) {
          if (n && n.silent) return n.success(t);
          var r;
          switch (e) {
              case "read":
                  r = t.id ? a.find(t) : a.findAll();
                  break;
              case "create":
                  r = a.create(t);
                  break;
          ...
          r ? n.success(r) : n.error("Record not found")
      },
      getParam: function(e) {
      ...
      removeChildren: function(e) {
          ...
          _.each(e, function(e) {
              vc.storage.lock(), e.destroy(), this.removeChildren(e)
          }, this), e.length && vc.storage.save()
      },
      setting: function(e) {
      ...
      createFromString: function(e, t) {
          e = vc.storage.parseContent({}, e, !!_.isObject(t) && t.toJSON());
      ...
      createShortcodeString: function(e, t) {
          var n, r = e.get("shortcode"),
              a = _.extend({}, e.get("params")),
              i = {},
              a = vc.getMergedParams(r, a);
          return _.each(a, function(e, t) {
              i[t] = vc.storage.escapeParam(e)
          }, this), a = vc.getMapped(r), a = _.isObject(a) && (_.isBoolean(a.is_container) && !0 === a.is_container || !_.isEmpty(a.as_parent)), n = this._getShortcodeContent(e, t), n = {
              tag: r,
              attrs: i,
              content: n,
              type: _.isUndefined(vc.getParamSettings(r, "content")) && !a ? "single" : ""
          }, _.isUndefined(t) ? e.trigger("stringify", e, n) : e.trigger("stringify:" + t, e, n), n.remove ? "" : wp.shortcode.string(n)
      },
  ...
  }), vc.shortcodes = new vc.shortcodes_collection, vc.getDefaults = vc.memoizeWrapper(function(e) {
      var t = {},
          e = _.isObject(vc.map[e]) && _.isArray(vc.map[e].params) ? vc.map[e].params : [];
      return _.each(e, function(e) {
          _.isObject(e) && (_.isUndefined(e.std) ? vc.atts[e.type] && vc.atts[e.type].defaults ? t[e.param_name] = vc.atts[e.type].defaults(e) : _.isUndefined(e.value) || (_.isObject(e.value) ? t[e.param_name] = _.values(e.value)[0] : _.isArray(e.value) ? t[e.param_name] = e.value[0] : t[e.param_name] = e.value) : t[e.param_name] = e.std)
      }), t
  ...
  }), vc.getMergedParams = function(s, c) {
      var o, d = vc.getDefaultsAndDependencyMap(s),
          u = {};
      return c = _.extend({}, d.defaults, c), o = _.extend({}, d.dependencyMap), _.each(c, function(e, t) {
          if ("content" !== t) {
              if (!_.isUndefined(o[t])) {
                  if (!_.isUndefined(o[o[t].element]) && _.isBoolean(o[o[t].element].failed) && !0 === o[o[t].element].failed) return void(o[t].failed = !0);
                  var n = o[t].element,
                      r = c[n],
                      a = _.isEmpty(r),
                      i = !1;
                  if ("string" == typeof r && (i = c[n].split(",").map(function(e) {
                          return e.trim()
                      }).filter(function(e) {
                          return e
                      })), n = _.omit(o[t], "element"), _.isBoolean(n.not_empty) && !0 === n.not_empty && a || _.isBoolean(n.is_empty) && !0 === n.is_empty && !a || n.value && !_.intersection(_.isArray(n.value) ? n.value : [n.value], _.isArray(r) ? r : [r]).length && i && n.value && !_.intersection(_.isArray(n.value) ? n.value : [n.value], _.isArray(i) ? i : [i]).length || n.value_not_equal_to && _.intersection(_.isArray(n.value_not_equal_to) ? n.value_not_equal_to : [n.value_not_equal_to], _.isArray(r) ? r : [r]).length && i && n.value_not_equal_to && _.intersection(_.isArray(n.value_not_equal_to) ? n.value_not_equal_to : [n.value_not_equal_to], _.isArray(i) ? i : [i]).length) return void(o[t].failed = !0)
              }
              a = vc.getParamSettings(s, t), (_.isUndefined(a) || !_.isUndefined(d.defaults[t]) && d.defaults[t] !== e || _.isUndefined(d.defaults[t]) && "" !== e || !_.isUndefined(a.save_always) && !0 === a.save_always) && (u[t] = e)
          }
      }), u
...
! function(a) {
  vc.clone_index = 1, vc.shortcode_view = Backbone.View.extend({
      ...
      checkControlsPosition: function() {
          var e, t;
          this.$controls_buttons && (t = this.$el.height(), a(window).height() < t) && (40 < (e = a(window).scrollTop() - this.$el.offset().top + a(window).height() / 2) && e < t ? this.$controls_buttons.css("top", e) : t < e ? this.$controls_buttons.css("top", t - 40) : this.$controls_buttons.css("top", 40))
      },
      initialize: function() {
      ...
      hasUserAccess: function() {
          var t = this.model.get("shortcode");
          return -1 < _.indexOf(["vc_row", "vc_column", "vc_row_inner", "vc_column_inner"], t) || !!_.every(vc.roles.current_user, function(e) {
              return !(!_.isUndefined(vc.roles[e]) && !_.isUndefined(vc.roles[e].shortcodes) && _.isUndefined(vc.roles[e].shortcodes[t]))
          })
      },
      canCurrentUser: function(e) {
          var t = this.model.get("shortcode");
          return void 0 === e || "all" === e ? vc_user_access().shortcodeAll(t) : vc_user_access().shortcodeEdit(t)
      },
      createParams: function() {
          var e = this.model.get("shortcode"),
              e = _.isObject(vc.map[e]) && _.isArray(vc.map[e].params) ? vc.map[e].params : [];
          this.model.get("params");
          this.params = {}, _.each(e, function(e) {
              this.params[e.param_name] = e
          }, this)
      },
      setContent: function() {
      ...
      html2element: function(e) {
          var t = {},
              e = vc.template(e),
              e = a(e(this.model.toJSON()).trim());
          _.each(e.get(0).attributes, function(e) {
              t[e.name] = e.value
          }), this.$el.attr(t).html(e.html()), this.setContent(), this.renderContent()
      },
      render: function() {
          var e = a("#vc_shortcode-template-" + this.model.get("shortcode"));
          return e.is("script") && this.html2element(e.html()), (this.model.view = this).$controls_buttons = this.$el.find(".vc_controls > :first"), this
      },
      ...
      _loadDefaults: function() {
          ...
          !!!vc.shortcodes.where({
              parent_id: this.model.get("id")
          }).length && !0 === this.use_default_content && _.isObject(vc.map[e]) && _.isString(vc.map[e].default_content) && vc.map[e].default_content.length && (this.use_default_content = !1, vc.shortcodes.createFromString(vc.map[e].default_content, this.model))
      },
      _callJsCallback: function() {
          var e = this.model.get("shortcode");
          _.isObject(vc.map[e]) && _.isObject(vc.map[e].js_callback) && !_.isUndefined(vc.map[e].js_callback.init) && (e = vc.map[e].js_callback.init, window[e](this.$el))
      },
      ready: function(e) {
      ...
      addShortcode: function(e, t) {
          var n = _.last(vc.shortcodes.filter(function(e) {
              return e.get("parent_id") === this.get("parent_id") && parseFloat(e.get("order")) < parseFloat(this.get("order"))
          }, e.model));
          n ? e.render().$el.insertAfter("[data-model-id=" + n.id + "]") : "append" === t ? this.$content.append(e.render().el) : this.$content.prepend(e.render().el)
      },
      /* nectar addition - escape tags */
            ...
            /* nectar addition end */
      changeShortcodeParams: function(e) {
          var t = e.get("shortcode"),
              r = e.get("params"),
              n = vc.map[t];
          _.defer(function() {
              vc.events.trigger("backend.shortcodeViewChangeParams:" + t)
          }), (_.isArray(n.params) || _.isObject(n.params)) && _.each(n.params, function(e) {
              var t, n, c = e.param_name,
                  o = r[c],
                  i = this.$el.find("> .wpb_element_wrapper, > .vc_element-wrapper"),
                  s = o,
                  c = i.children(".admin_label_" + c);
              _.isObject(vc.atts[e.type]) && _.isFunction(vc.atts[e.type].render) && (o = vc.atts[e.type].render.call(this, e, o)), i.children("." + e.param_name).is("input,textarea,select") ? i.children("[name=" + e.param_name + "]").val(o) : i.children("." + e.param_name).is("iframe") ? i.children("[name=" + e.param_name + "]").attr("src", o) : i.children("." + e.param_name).is("img") ? (t = i.children("[name=" + e.param_name + "]"), o && o.match(/^\d+$/) ? a.ajax({
                  type: "POST",
                  url: window.ajaxurl,
                  data: {
              ...
              }) : o && t.attr("src", o)) : i.children("[name=" + e.param_name + "]").html(o ? vc_wpautop(this.sanitizeTags(o)) : ""), c.length && ("" === o || _.isUndefined(o) ? c.hide().addClass("hidden-label") : (_.isObject(e.value) && !_.isArray(e.value) && "checkbox" === e.type ? (n = _.invert(e.value), s = _.map(o.split(/[\s]*\,[\s]*/), function(e) {
                  return _.isString(n[e]) ? n[e] : e
              }).join(", ")) : _.isObject(e.value) && !_.isArray(e.value) && (n = _.invert(e.value), s = _.isString(n[o]) ? n[o] : o), c.html("<label>" + c.find("label").text() + "</label>: " + this.sanitizeTags(s)), c.show().removeClass("hidden-label"))) // nectar addition -- added sanitizeTags to label_value
          }, this), n = vc.app.views[e.get("parent_id")], !1 !== e.get("parent_id") && _.isObject(n) && n.checkIsEmpty()
      },
      changeShortcodeParent: function(e) {
          var t;
          if (!1 === this.model.get("parent_id")) return e;
          e = a("[data-model-id=" + this.model.get("parent_id") + "]"), t = vc.app.views[this.model.get("parent_id")], this.$el.appendTo(e.find("> .wpb_element_wrapper > .wpb_column_container, > .vc_element-wrapper > .wpb_column_container")), t.checkIsEmpty()
      },
      deleteShortcode: function(e) {
          _.isObject(e) && e.preventDefault(), this.model.destroy()
      },
      addElement: function(e) {
          _.isObject(e) && e.preventDefault(), vc.add_element_block_view.render(this.model, !_.isObject(e) || !a(e.currentTarget).closest(".bottom-controls").hasClass("bottom-controls"));
           /* nectar addition */ 
           jQuery('body').append('<div class="modal-backdrop white"></div>');

           if(jQuery('#wpb_visual_composer div[data-element_type="page_submenu"]').length > 0) jQuery('.vc_add-element-container li[data-element="page_submenu"]').addClass('hidden-element'); 
          else jQuery('.vc_add-element-container li[data-element="page_submenu"]').removeClass('hidden-element'); 
          
           var container =  jQuery('.wpb-content-layouts-container .wpb-content-layouts');  
            var speed = 2200;
            container.each(function() {   
              var elements = jQuery(this).children();
              elements.each(function() {      

                var elementOffset = jQuery(this).position(); 
      ...
      cloneModel: function(e, t, n) {
          var n = _.isBoolean(n) && !0 === n ? e.get("order") : parseFloat(e.get("order")) + vc.clone_index,
              c = _.extend({}, e.get("params")),
              o = e.get("shortcode"),
              i = vc.shortcodes.create({
                  shortcode: o,
                  id: window.vc_guid(),
  ...
  }), vc.shortcodes.on("sync", function(e) {
      _.isObject(e) && !_.isEmpty(e.models) && _.each(e.models, function(e) {
          vc.events.triggerShortcodeEvents("sync", e)
      })
  }), vc.shortcodes.on("add", function(e) {
      _.isObject(e) && vc.events.triggerShortcodeEvents("add", e)
  })
}(window.jQuery);
! function(n) {
...
! function(r) {
  vc.saved_custom_css = !1, vc.createPreLoader = function() {
      ...
      vc.$overlaySpinner = r("#vc_overlay_spinner").show()
      ...
      accessPolicyActions: function() {
          var e, t = "",
              s = "";
          this.accessPolicy.fe_editor && (t = '<a class="wpb_switch-to-front-composer" href="' + r("#wpb-edit-inline").attr("href") + '">' + window.i18nLocale.main_button_title_frontend_editor + "</a>"), this.accessPolicy.classic_editor ? this.accessPolicy.be_editor && (s = '<a class="wpb_switch-to-composer" href="#">' + window.i18nLocale.main_button_title_backend_editor + "</a>") : (r("#postdivrich").addClass("vc-disable-editor"), this.accessPolicy.be_editor && (e = this, _.defer(function() {
              e.show(), e.status = "shown"
          }))), (t || s || gutenberg) && (this.$buttonsContainer = r('<div class="composer-switch"><div class="composer-inner-switch"><span class="logo-icon"></span>' + s + t + "</div></div>").insertAfter("div#titlediv"), this.accessPolicy.classic_editor) && (this.$switchButton = this.$buttonsContainer.find(".wpb_switch-to-composer"), this.$switchButton.on("click", this.switchComposer))
      },
      initialize: function() {
          var s = this;
          _.bindAll(this, "switchComposer", "dropButton", "processScroll", "updateRowsSorting", "updateElementsSorting"), this.accessPolicy = vc.accessPolicy, this.buildRelevance(), vc.events.on("shortcodes:add", vcAddShortcodeDefaultParams, this), vc.events.on("shortcodes:add", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:sync", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:add", this.addShortcode, this), vc.events.on("shortcodes:destroy", this.checkEmpty, this), vc.shortcodes.on("change:params", this.changeParamsEvents, this), vc.shortcodes.on("reset", this.addAll, this), r(document).on("wp-collapse-menu", function(e, t) {
              "open" === t.state && s.leaveFullscreen()
          }), this.render()
      },
      ...
      render: function() {
          return this.$buttonsContainer = r(".composer-switch"),
           this.$switchButton = this.$buttonsContainer.find(".wpb_switch-to-composer"), 
           this.$vcStatus = r("#wpb_vc_js_status"), 
           this.$metablock_content = r(".metabox-composer-content"), 
           this.$content = r("#wpbakery_content"), 
           // nectar addition
           this.$post = (jQuery('#nectar-metabox-portfolio-extra').length == 0) ? jQuery("#postdivrich") : jQuery('#nectar-metabox-portfolio-extra'), 
           // nectar addition end
           this.$loading_block = r("#vc_logo"), 
          ...
          }), this.setSortable(), vc.is_mobile = 0 < r("body.mobile").length, vc.saved_custom_css = r("#wpb_custom_post_css_field").val(), vc.updateSettingsBadge(), _.defer(function() {
              vc.events.trigger("app.render")
          }), r("body").on("click", r.proxy(this.handleBodyClick, this)), this
      },
      addAll: function() {
      ...
      addChild: function(e) {
          _.each(vc.shortcodes.where({
              ...
              this.appendShortcode(e), this.addChild(e.get("id"))
          }, this), this.setSortable()
      },
      getView: function(e) {
          var t = new(_.isObject(vc.map[e.get("shortcode")]) && _.isString(vc.map[e.get("shortcode")].js_view) && vc.map[e.get("shortcode")].js_view.length && !_.isUndefined(window[window.vc.map[e.get("shortcode")].js_view]) ? window[window.vc.map[e.get("shortcode")].js_view] : vc.shortcode_view)({
              model: e
          });
          return e.set({
              view: t
      ...
      setDraggable: function() {
          r("#wpb-add-new-element, #wpb-add-new-row").draggable({
              helper: function() {
                  return r('<div id="drag_placeholder"></div>').appendTo("body")
              },
              zIndex: 99999,
              cursor: "move",
              revert: "invalid",
              start: function(e, t) {
                  r("#drag_placeholder").addClass("column_placeholder").html(window.i18nLocale.drag_drop_me_in_column)
              }
          })
      },
      ...
      dropButton: function(e, t) {
          t.draggable.is("#wpb-add-new-element") ? this.addElement() : t.draggable.is("#wpb-add-new-row") && this.createRow()
      },
      appendShortcode: function(e) {
          var t = this.getView(e),
              s = _.extend(vc.getDefaults(e.get("shortcode")), e.get("params"));
          e.set("params", s, {
              silent: !0
          }), s = !1 !== e.get("parent_id") && this.views[e.get("parent_id")], this.views[e.id] = t, e.get("parent_id") && this.views[e.get("parent_id")].unsetEmpty(), s ? s.addShortcode(t, "append") : this.$content.append(t.render().el), t.ready(), t.changeShortcodeParams(e), t.checkIsEmpty(), this.setNotEmpty()
      },
      addShortcode: function(e) {
          var t, s, c = _.extend(vc.getDefaults(e.get("shortcode")), e.get("params"));
          e.set("params", c, {
              silent: !0
          }), t = this.getView(e), c = !1 !== e.get("parent_id") && this.views[e.get("parent_id")], t.use_default_content = !0 !== e.get("cloned"), this.views[e.id] = t, c ? (c.addShortcode(t), c.checkIsEmpty(), s = this, _.defer(function() {
              t.changeShortcodeParams && t.changeShortcodeParams(e), t.ready(), t.checkIsEmpty(), s.setSortable(), s.setNotEmpty()
          })) : (this.addRow(t), _.defer(function() {
              t.changeShortcodeParams && t.changeShortcodeParams(e), t.ready(), t.checkIsEmpty()
          }))
      },
      addRow: function(e) {
          var t = _.last(vc.shortcodes.filter(function(e) {
              return !1 === e.get("parent_id") && parseFloat(e.get("order")) < parseFloat(this.get("order"))
          }, e.model));
          t ? e.render().$el.insertAfter("[data-model-id=" + t.id + "]") : this.$content.append(e.render().el)
      },
      addTextBlock: function(e) {
          ...
          return e && e.preventDefault && e.preventDefault(), e = vc.shortcodes.create({
              ...
              parent_id: e.id,
              root_id: e.id
          }), s = vc.getDefaults("vc_column_text"), vc.shortcodes.create({
      ...
      openTemplatesWindow: function(e) {
          e && e.preventDefault && e.preventDefault(), r(e.currentTarget).is("#vc_templates-more-layouts") && vc.templates_panel_view.once("show", function() {
              r('[data-vc-ui-element-target="[data-tab=default_templates]"]').click()
          }), vc.templates_panel_view.render().show();
           /*nectar addition*/
            if( jQuery(e.currentTarget).is(".user-templates") && jQuery('[data-vc-ui-element-target="[data-tab=my_templates]"]').length > 0 ) {
                jQuery('[data-vc-ui-element-target="[data-tab=my_templates]"]').click();
            }
            /*nectar addition end*/
      },
      loadDefaultTemplate: function(e) {
      ...
      enterFullscreen: function() {
          var e = r("body");
          e.hasClass("folded") ? (e.data("vcKeepMenuFolded", !0), e.addClass("vc_fullscreen")) : e.addClass("vc_fullscreen folded"), r("#vc_windowed-button").show(), r("#vc_fullscreen-button").hide()
      },
      leaveFullscreen: function() {
          var e = r("body");
          e.hasClass("vc_fullscreen") && (e.data("vcKeepMenuFolded") ? (e.removeClass("vc_fullscreen"), e.removeData("vcKeepMenuFolded")) : e.removeClass("vc_fullscreen folded"), r("#vc_windowed-button").hide(), r("#vc_fullscreen-button").show())
      },
      sortingStarted: function(e, t) {
          r("#wpbakery_content").addClass("vc_sorting-started")
      },
      sortingStopped: function(e, t) {
          var s = t.item.data("element_type"),
              c = t.placeholder.closest("[data-element_type]").data("element_type") || "";
          vc.check_relevance(c, s) && c != s || (t.placeholder.addClass("vc_hidden-placeholder"), r(e.target).sortable("cancel")), r("#wpbakery_content").removeClass("vc_sorting-started")
      },
      updateElementsSorting: function(e, a) {
          _.defer(function(e) {
              var t, s = a.item.parent().closest("[data-model-id]").data("model"),
                  c = a.item.data("model"),
                  n = e.views[s.id].$content.find("> [data-model-id]"),
                  o = 0;
              _.isNull(a.sender) || (t = c.get("parent_id"), vc.storage.lock(), c.save({
                  parent_id: s.id
              }), t && e.views[t].checkIsEmpty(), e.views[s.id].checkIsEmpty()), n.each(function() {
                  var e = r(this).data("model");
                  vc.storage.lock(), e.save({
                      order: o++
                  })
              }), c.save()
          }, this)
      },
      updateRowsSorting: function(a, i) {
          _.defer(function(e) {
              var t = i.item.parent(),
                  s = t.closest("[data-model-id]"),
                  s = !!s.length && s.data("model").get("id"),
                  c = i.item.data("model"),
                  n = i.item.data("element_type"),
                  o = i.item.parent().closest("[data-element_type]").data("element_type") || "";
              vc.check_relevance(o, n) && o != n ? (o = c.get("parent_id"), t.find(e.rowSortableSelector).each(function() {
                  var e = r(this).index();
                  vc.storage.lock(), r(this).data("model").save({
                      order: e
                  })
              }), c.save({
                  parent_id: s
              }), o && e.views[o].checkIsEmpty(), s && e.views[s].checkIsEmpty()) : r(a.target).sortable("cancel")
          }, this)
      },
      renderPlaceholder: function(e, t) {
          var t = r(t).data("element_type"),
              s = _.isObject(vc.map[t]) && (_.isBoolean(vc.map[t].is_container) && !0 === vc.map[t].is_container || !_.isEmpty(vc.map[t].as_parent));
          return r('<div class="vc_helper vc_helper-' + t + '"><i class="vc_general vc_element-icon' + (vc.map[t].icon ? " " + vc.map[t].icon : "") + '"' + (s ? ' data-is-container="true"' : "") + "></i> " + vc.map[t].name + "</div>").prependTo("body")
      },
      rowSortableSelector: "> .wpb_vc_row, > .vc_main-sortable-element",
      setSortable: function() {
          if (vc_user_access().partAccess("dragndrop")) return r(".wpb_main_sortable").sortable({
              ...
              over: function(e, t) {
                  var s = t.item.data("element_type"),
                      c = t.placeholder.closest("[data-element_type]").data("element_type") || "";
                  if (!vc.check_relevance(c, s) || c == s) return t.placeholder.addClass("vc_hidden-placeholder"), !1;
                  t.placeholder.css({
          ...
          }), r(".wpb_column_container").sortable({
              forcePlaceholderSize: !0,
              forceHelperSize: !1,
              ...
              tolerance: "intersect",
              start: function() {
                  r("#wpbakery_content").addClass("vc_sorting-started"), r(".vc_not_inner_content").addClass("dragging_in")
              },
              stop: function(e, t) {
                  r("#wpbakery_content").removeClass("vc_sorting-started"), r(".dragging_in").removeClass("dragging_in");
                  var s = t.item.data("element_type"),
                      c = t.item.parent().closest("[data-element_type]").data("element_type") || "",
                      n = !!_.isUndefined(vc.map[c].allowed_container_element) || vc.map[c].allowed_container_element;
                  vc.check_relevance(c, s) && c != s || r(this).sortable("cancel"), _.isObject(vc.map[s]) && (_.isBoolean(vc.map[s].is_container) && !0 === vc.map[s].is_container || !_.isEmpty(vc.map[s].as_parent)) && !0 !== n && n !== t.item.data("element_type").replace(/_inner$/, "") && r(this).sortable("cancel"), r(".vc_sorting-empty-container").removeClass("vc_sorting-empty-container")
              },
              ...
              over: function(e, t) {
                  var s = t.item.data("element_type"),
                      c = t.placeholder.closest("[data-element_type]").data("element_type"),
                      n = !!_.isUndefined(vc.map[c].allowed_container_element) || vc.map[c].allowed_container_element;
                  vc.check_relevance(c, s) && c != s || t.placeholder.addClass("vc_hidden-placeholder"), _.isObject(vc.map[s]) && (_.isBoolean(vc.map[s].is_container) && !0 === vc.map[s].is_container || !_.isEmpty(vc.map[s].as_parent)) && !0 !== n && n !== t.item.data("element_type").replace(/_inner$/, "") && t.placeholder.addClass("vc_hidden-placeholder"), _.isNull(t.sender) || !t.sender.length || t.sender.find("> [data-element_type]:not(.ui-sortable-helper):visible").length || t.sender.addClass("vc_sorting-empty-container"), t.placeholder.css({
                      maxWidth: t.placeholder.parent().width()
                  })
              },
              out: function(e, t) {
      ...
      setNotEmpty: function() {
          r("#vc_no-content-helper").addClass("vc_not-empty"), r("#vc_navbar").addClass("vc_not-empty")
      },
      setIsEmpty: function() {
          vc.views = {}, r("#vc_no-content-helper").removeClass("vc_not-empty"), r("#vc_navbar").removeClass("vc_not-empty")
      },
      checkEmpty: function(e) {
          if (_.isObject(e) && !1 !== e.get("parent_id") && e.get("parent_id") != e.id) {
              e = this.views[e.get("parent_id")];
              if (!e) return;
              e.checkIsEmpty()
          }
      ...
      show: function() {
          this.$el.show(), this.$post.addClass("vc-disable-editor"), this.$vcStatus.val("true"), this.navOnScroll(), this.hideOtherEditors(), vc.storage.isContentChanged() && (vc.undoRedoApi && vc.undoRedoApi.add(vc.storage.getContent()), vc.app.setLoading(), vc.app.views = {}, _.defer(function() {
              vc.shortcodes.fetch({
                  reset: !0
      ...
      hideOtherEditors: function() {
          r("#elementor-editor").insertAfter("#wpb_wpbakery"), r("#elementor-switch-mode").insertAfter("#wpb_wpbakery")
      },
      setLoading: function() {
      ...
      checkVcStatus: function() {
          var e = new URL(window.location.href).searchParams.has("wpb-backend-editor");
          !vc.accessPolicy.can("be_editor") || vc.accessPolicy.can("classic_editor") && "true" !== this.$vcStatus.val() && !e || this.switchComposer()
      },
      setNavTop: function() {
      ...
      save: function() {
        ...
        /* nectar addition */
        jQuery("#wpb-save-post").text(window.i18nLocale.loading); 

        var $postStatus = (jQuery('input[name="hidden_post_status"]').length > 0) ? jQuery('input[name="hidden_post_status"]').val() : 'published';
      ...
      preview: function() {
          r("#post-preview").click()
      },
      navOnScroll: function() {
          this.$nav = r("#vc_navbar"), this.setNavTop(), this.processScroll(), r(window).off("scroll.composer resize.composer").on("scroll.composer resize.composer", this.processScroll)
      },
      processScroll: function(e) {
          var t;
          !0 === this.disableFixedNav ? this.$nav.removeClass("vc_subnav-fixed") : ((!this.navTop || this.navTop < 0) && this.setNavTop(), this.scrollTop = r(window).scrollTop() + 80, 0 < this.navTop && this.scrollTop >= this.navTop && !this.isFixed ? (this.isFixed = 1, this.$nav.addClass("vc_subnav-fixed")) : this.scrollTop <= this.navTop && this.isFixed && (this.isFixed = 0, this.$nav.removeClass("vc_subnav-fixed")), 0 !== this.$nav.length && (window.innerWidth <= 600 ? 46 < window.scrollY ? "0px" !== this.$nav.css("top") && this.$nav.css("top", "0") : (t = 46 - window.scrollY + "px", this.$nav.css("top") !== t && this.$nav.css("top", t)) : "" !== this.$nav.css("top") && this.$nav.css("top", "")))
      },
      buildRelevance: function() {
          vc.shortcode_relevance = {}, _.map(vc.map, function(e) {
          ...
          }), vc.check_relevance = function(e, t) {
      ...
      handleEditorPaste: function(e) {
          e = e.originalEvent.clipboardData.getData("text/plain") || "";
          vc.pasteShortcode(!1, !1, e)
      },
      handleBodyClick: function(e) {
          this.isEditorInFocus = !!r(e.target).closest("#wpb_wpbakery, .vc_ui-panel-window").length, this.isEditorInFocus && !this.isKeydownEventAssigned ? (r("body").on("paste", this.handleEditorPaste), this.isKeydownEventAssigned = !0) : !this.isEditorInFocus && this.isKeydownEventAssigned && (r("body").off("paste", this.handleEditorPaste), this.isKeydownEventAssigned = !1)
      },
      openSeo: function(e) {
          e && e.preventDefault && e.preventDefault(), vc.post_seo_view.render()
      }
  }), r(function() {
      var e = r("#wpb_wpbakery");
      e.is("div") && (vc.app = new vc.visualComposerView({
          el: e
      }), vc.accessPolicy.can("be_editor") && !vc_user_access().isBlockEditorIsEnabled() && vc.app.checkVcStatus(), r("#post").on("submit", function() {
...
! function(a) {
  ...
  window.VcRowView = vc.shortcode_view.extend({
      ...
      convertRowColumns: function(e) {
          var t = e.toString().split(/_/),
              o = s.where({
                  parent_id: this.model.id
              }),
              i = [],
          ...
          return _.each(t, function(e, t) {
              var n, e = _.map(e.toString().split(""), function(e, t) {
                  return parseInt(e, 10)
              });
              a = 3 < e.length ? e[0] + "" + e[1] + "/" + e[2] + e[3] : 2 < e.length ? e[0] + "/" + e[1] + e[2] : e[0] + "/" + e[1], c.push(a), e = _.extend(_.isUndefined(o[t]) ? {} : o[t].get("params"), {
                  width: a
              }), vc.storage.lock(), n = s.create({
                  shortcode: this.getChildTag(),
                  params: e,
                  parent_id: this.model.id
              }), _.isObject(o[t]) && _.each(s.where({
                  parent_id: o[t].id
              }), function(e) {
                  vc.storage.lock(), e.save({
                      parent_id: n.id
                  }), vc.storage.lock(), e.trigger("change_parent_id")
              }), i.push(n)
          }, this), t.length < o.length && _.each(o.slice(t.length), function(e) {
              _.each(s.where({
                  parent_id: e.id
              }), function(e) {
                  vc.storage.lock(), e.save({
                      parent_id: _.last(i).id
                  }), vc.storage.lock(), e.trigger("change_parent_id")
              })
          }), _.each(o, function(e) {
              vc.storage.lock(), e.destroy()
          }, this), this.model.save(), this.setActiveLayoutButton("" + e), c
      },
      changeShortcodeParams: function(e) {
          window.VcRowView.__super__.changeShortcodeParams.call(this, e), this.buildDesignHelpers(), this.setRowClasses()
      },
      setRowClasses: function() {
          var e = this.model.getParam("disable_element"),
              t = "vc_hidden-xs vc_hidden-sm  vc_hidden-md vc_hidden-lg";
          this.disable_element_class && this.$el.removeClass(this.disable_element_class), _.isEmpty(e) || (this.$el.addClass(t), this.disable_element_class = t)
      },
      ...
      buildDesignHelpers: function() {
          ...
          // matches = css.match(/background\-image:\s*url\(([^\)]+)\)/), matches && !_.isUndefined(matches[1]) && (image = matches[1]), matches = css.match(/#[A-Fa-f0-9]{6}/), matches && !_.isUndefined(matches[1]) && (color = matches[1]), matches = css.match(/background:\s*([^\s]+)\b\s*url\(([^\)]+)\)/), matches && !_.isUndefined(matches[1]) && (color = matches[1], image = matches[2]), 
           //rowId = this.model.getParam("el_id"), this.$el.find("> .vc_controls .vc_row-hash-id").remove(), _.isEmpty(rowId) || jQuery('<span class="vc_row-hash-id"></span>').text("#" + rowId).insertAfter($elementToPrepend), image && jQuery('<span class="vc_row_image" style="background-image: url(' + image + ');" title="' + window.i18nLocale.row_background_image + '"></span>').insertAfter($elementToPrepend), color && jQuery('<span class="vc_row_color" style="background-color: ' + color + '" title="' + window.i18nLocale.row_background_color + '"></span>').insertAfter($elementToPrepend)
           //jQuery('<span class="vc_row_image" style="background-image: url(' + bg_image + ');"  title="' + window.i18nLocale.row_background_image + '"></span>').insertAfter($elementToPrepend);
           jQuery('<span class="vc_row_color" style="background-color: ' + bg_color + '" title="' + window.i18nLocale.row_background_color + '"></span>').insertAfter($elementToPrepend);

           var rowId = this.model.getParam("id"); 
           this.$el.find("> .vc_controls .vc_row-hash-id").remove();
           if( !_.isEmpty(rowId) ) {
             jQuery('<span class="vc_row-hash-id"></span>').text("#" + rowId).insertAfter($elementToPrepend);
           } 
           /* nectar addition end */ 
      },
      addElement: function(e) {
          e && e.preventDefault && e.preventDefault(), s.create({
              shortcode: this.getChildTag(),
              params: {},
              parent_id: this.model.id
      ...
      setSorting: function() {
          var e;
          vc_user_access().partAccess("dragndrop") && (1 < (e = this).$content.find(this.sortingSelector).length ? this.$content.removeClass("wpb-not-sortable").sortable({
              forcePlaceholderSize: !0,
              ...
              distance: .5,
              start: function(e, t) {
                  a("#wpbakery_content").addClass("vc_sorting-started"), t.placeholder.width(t.item.width())
              },
              stop: function(e, t) {
                  a("#wpbakery_content").removeClass("vc_sorting-started")
              },
              update: function() {
                  var n = a(e.sortingSelector, e.$content);
                  n.each(function() {
                      var e = a(this).data("model"),
                          t = a(this).index();
                      e.set("order", t), n.length - 1 > t && vc.storage.lock(), e.save()
                  })
              },
              over: function(e, t) {
                  t.placeholder.css({
                      maxWidth: t.placeholder.parent().width()
                  }), t.placeholder.removeClass("vc_hidden-placeholder")
              },
      ...
      validateCellsList: function(e) {
          var n, o = [],
              e = e.replace(/\s/g, "").split("+");
          return 12 === _.reduce(_.map(e, function(e) {
              var t;
              return e.match(/^(vc_)?span\d?$/) ? !1 === (t = vc_convert_column_span_size(e)) ? 1e3 : (n = t.split(/\//), o.push(n[0] + "" + n[1]), 12 * parseInt(n[0], 10) / parseInt(n[1], 10)) : e.match(/^[1-9]|1[0-2]\/[1-9]|1[0-2]$/) ? (n = e.split(/\//), o.push(n[0] + "" + n[1]), 12 * parseInt(n[0], 10) / parseInt(n[1], 10)) : 1e4
          }), function(e, t) {
              return t += e
          }, 0) && o.join("_")
      },
      setActiveLayoutButton: function(e) {
          e = e || _.map(vc.shortcodes.where({
              parent_id: this.model.get("id")
          }), function(e) {
              e = e.getParam("width");
              return e ? e.replace(/\//, "") : "11"
          }).join("_"), this.$el.find("> .vc_controls .vc_active").removeClass("vc_active");
          e = this.$el.find('> .vc_ [data-cells-mask="' + vc_get_column_mask(e) + '"] [data-cells="' + e + '"], > .vc_controls [data-cells-mask="' + vc_get_column_mask(e) + '"][data-cells="' + e + '"]');
          (e.length ? e : this.$el.find("> .vc_controls [data-cells-mask=custom]")).addClass("vc_active")
      },
      layoutEditor: function() {
          return _.isUndefined(vc.row_layout_editor) && (vc.row_layout_editor = new vc.RowLayoutUIPanelBackendEditor({
              el: a("#vc_ui-panel-row-layout")
          })), vc.row_layout_editor
      },
      setColumns: function(e) {
          _.isObject(e) && e.preventDefault();
          var t, e = a(e.currentTarget);
          "custom" === e.data("cells") ? this.layoutEditor().render(this.model).show() : (vc.is_mobile && !(t = e.parent()).hasClass("vc_visible") && (t.addClass("vc_visible"), a(document).off("click.vcRowColumnsControl").on("click.vcRowColumnsControl", function(e) {
              t.removeClass("vc_visible")
          })), e.is(".vc_active") || (this.change_columns_layout = !0, _.defer(function(e, t) {
              e.convertRowColumns(t)
          }, this, e.data("cells")))), this.$el.removeClass("vc_collapsed-row")
      },
      sizeRows: function() {
          var t = 45;
          a("> .wpb_vc_column, > .wpb_vc_column_inner", this.$content).each(function() {
              var e = a(this).find("> .wpb_element_wrapper > .wpb_column_container").css({
                  minHeight: 0
              }).height();
              t < e && (t = e)
          }).each(function() {
              a(this).find("> .wpb_element_wrapper > .wpb_column_container").css({
                  minHeight: t
              })
          })
      },
      ...
      initialize: function(e) {
          window.VcColumnView.__super__.initialize.call(this, e), _.bindAll(this, "setDropable", "dropButton")
      },
      render: function() {
         /* nectar addition */ 
      ...
      changeShortcodeParams: function(e) {
          window.VcColumnView.__super__.changeShortcodeParams.call(this, e), this.setColumnClasses(), this.buildDesignHelpers()
      },
     ...
     jQuery('<span class="vc_column_color" style="background-color: ' + bg_color + '" title="' + i18nLocale.column_background_color + '"></span>').insertBefore($column_toggle);
     //this.$el.find("> .vc_controls .vc_column_color").remove(), this.$el.find("> .vc_controls .vc_column_image").remove(), matches = css.match(/background\-image:\s*url\(([^\)]+)\)/), matches && !_.isUndefined(matches[1]) && (image = matches[1]), matches = css.match(/background\-color:\s*([^\s\;]+)\b/), matches && !_.isUndefined(matches[1]) && (color = matches[1]), matches = css.match(/background:\s*([^\s]+)\b\s*url\(([^\)]+)\)/), matches && !_.isUndefined(matches[1]) && (color = matches[1], image = matches[2]), image && jQuery('<span class="vc_column_image" style="background-image: url(' + image + ');" title="' + i18nLocale.column_background_image + '"></span>').insertBefore($column_toggle), color && jQuery('<span class="vc_column_color" style="background-color: ' + color + '" title="' + i18nLocale.column_background_color + '"></span>').insertBefore($column_toggle)
      ...
      setColumnClasses: function() {
          var e, t = this.model.getParam("offset") || "",
              n = this.model.getParam("width") || "1/1",
              o = this.convertSize(n);
          this.current_offset_class && this.$el.removeClass(this.current_offset_class), this.current_column_width !== n && (e = this.convertSize(this.current_column_width), this.$el.attr("data-width", n).removeClass(e).addClass(o), this.current_column_width = n), t.match(/vc_col\-sm\-\d+/) && this.$el.removeClass(o), _.isEmpty(t) || this.$el.addClass(t), this.current_offset_class = t
      },
      addToEmpty: function(e) {
          e && e.preventDefault && e.preventDefault(), a(e.target).hasClass("vc_empty-container") && this.addElement(e)
      },
      setDropable: function() {
      ...
      dropButton: function(e, t) {
          t.draggable.is("#wpb-add-new-element") ? vc.add_element_block_view({
              model: {
                  position_to_add: "end"
              }
          }).show(this) : t.draggable.is("#wpb-add-new-row") && this.createRow()
      },
      setEmpty: function() {
      ...
      convertSize: function(e) {
          var t = "vc_col-sm-",
              e = e ? e.split("/") : [1, 1],
              n = _.range(1, 13),
              o = !_.isUndefined(e[0]) && 0 <= _.indexOf(n, parseInt(e[0], 10)) && parseInt(e[0], 10),
              n = !_.isUndefined(e[1]) && 0 <= _.indexOf(n, parseInt(e[1], 10)) && parseInt(e[1], 10);
          return !1 !== o && !1 !== n ? t + 12 * o / n : t + "12"
      },
      deleteShortcode: function(e) {
          var t, n = this.model.get("parent_id");
          if (e && e.preventDefault && e.preventDefault(), !0 !== confirm(window.i18nLocale.press_ok_to_delete_section)) return !1;
          this.model.destroy(), n && !vc.shortcodes.where({
              parent_id: n
          }).length ? (t = vc.shortcodes.get(n), _.contains(["vc_column", "vc_column_inner"], t.get("shortcode")) || t.destroy()) : n && (t = vc.shortcodes.get(n)) && t.view && t.view.setActiveLayoutButton && t.view.setActiveLayoutButton()
      },
      remove: function() {
      ...
      buildDesignHelpers: function() {
          var e, t, n, o = this.model.getParam("css"),
              i = this.$el.find(this.designHelpersSelector);
          this.$el.find("> .vc_controls-row .vc_row_color").remove(), this.$el.find("> .vc_controls-row .vc_row_image").remove(), (n = o.match(/background\-image:\s*url\(([^\)]+)\)/)) && !_.isUndefined(n[1]) && (e = n[1]), (n = o.match(/background\-color:\s*([^\s\;]+)\b/)) && !_.isUndefined(n[1]) && (t = n[1]), (n = o.match(/background:\s*([^\s]+)\b\s*url\(([^\)]+)\)/)) && !_.isUndefined(n[1]) && (t = n[1], e = n[2]), o = this.model.getParam("el_id"), this.$el.find("> .vc_controls-row .vc_row-hash-id").remove(), _.isEmpty(o) || a('<span class="vc_row-hash-id"></span>').text("#" + o).insertAfter(i), e && a('<span class="vc_row_image" style="background-image: url(' + e + ');" title="' + window.i18nLocale.row_background_image + '"></span>').insertAfter(i), t && a('<span class="vc_row_color" style="background-color: ' + t + '" title="' + window.i18nLocale.row_background_color + '"></span>').insertAfter(i)
      },
      checkIsEmpty: function() {
      ...
      setSorting: function() {
          var c;
          vc_user_access().partAccess("dragndrop") && (c = this).$content.sortable({
              forcePlaceholderSize: !0,
              placeholder: "widgets-placeholder",
              ...
              tolerance: "intersect",
              update: function(e, o) {
                  var i, t = o.item.data("element_type"),
                      n = o.item.parent().closest("[data-element_type]").data("element_type");
                  vc.check_relevance(n, t) && n != t && (i = a("> div.wpb_sortable,> div.vc-non-draggable", c.$content)).each(function() {
                      var e, t = a(this).data("model"),
                          n = a(this).index();
                      t.set("order", n), i.length - 1 > n && vc.storage.lock(), _.isNull(o.sender) || (n = o.item.parent().closest("[data-model-id]").data("model"), e = t.get("parent_id"), vc.storage.lock(), t.save({
                          parent_id: n.id
                      }), e && vc.app.views[e].checkIsEmpty(), vc.app.views[n.id].checkIsEmpty()), t.save()
                  })
              },
              stop: function(e, t) {
                  a("#wpbakery_content").removeClass("vc_sorting-started"), a(".dragging_in").removeClass("dragging_in");
                  var n = t.item.data("element_type"),
                      t = t.item.parent().closest("[data-element_type]").data("element_type");
                  vc.check_relevance(t, n) && t != n || a(this).sortable("cancel"), a(".vc_sorting-empty-container").removeClass("vc_sorting-empty-container")
              },
              over: function(e, t) {
                  var n = t.item.data("element_type"),
                      o = t.placeholder.closest("[data-element_type]").data("element_type") || "",
                      i = !!_.isUndefined(vc.map[o].allowed_container_element) || vc.map[o].allowed_container_element;
                  return !vc.check_relevance(o, n) || o == n || _.isObject(vc.map[n]) && (_.isBoolean(vc.map[n].is_container) && !0 === vc.map[n].is_container || !_.isEmpty(vc.map[n].as_parent)) && !0 !== i && i !== t.item.data("element_type").replace(/_inner$/, "") ? (t.placeholder.addClass("vc_hidden-placeholder"), !1) : (_.isNull(t.sender) || !t.sender.length || t.sender.find("> [data-element_type]:not(.ui-sortable-helper):visible").length || t.sender.addClass("vc_sorting-empty-container"), void t.placeholder.css({
                      maxWidth: t.placeholder.parent().width()
                  }))
              },
              out: function(e, t) {
                  t.placeholder.removeClass("vc_hidden-placeholder"), t.placeholder.css({
                      maxWidth: t.placeholder.parent().width()
                  }), _.isNull(t.sender) || !t.sender.length || t.sender.find("> [data-element_type]:not(.ui-sortable-helper):visible").length || t.sender.addClass("vc_sorting-empty-container")
              }
          })
      }
      ...
      render: function() {
        // nectar addition. vc_accordion_tab to toggles
          return window.VcAccordionView.__super__.render.call(this), vc_user_access().shortcodeAll("toggles") ? vc_user_access().partAccess("dragndrop") && this.$content.sortable({
              ...
              handle: "h3",
              stop: function(e, t) {
                  t.item.prev().triggerHandler("focusout"), a(this).find("> .wpb_sortable").each(function() {
                      a(this).data("model").save({
                          order: a(this).index()
                      })
                  })
              }
      ...
      changeShortcodeParams: function(e) {
          window.VcAccordionView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), e = !(!_.isString(e.collapsible) || "yes" !== e.collapsible), this.$content.hasClass("ui-accordion") && this.$content.accordion("option", "collapsible", e)
      },
      changedContent: function(e) {
          this.$content.hasClass("ui-accordion") && this.$content.accordion("destroy");
          var t = !(!_.isString(this.model.get("params").collapsible) || "yes" !== this.model.get("params").collapsible);
          this.$content.accordion({
              ...
              heightStyle: "content",
              collapsible: t,
              active: !1 === this.adding_new_tab && !0 !== e.model.get("cloned") ? 0 : e.$el.index()
      ...
      changeShortcodeParams: function(e) {
          window.VcAccordionTabView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), _.isObject(e) && _.isString(e.title) && this.$el.find("> h3 .tab-label").text(e.title)
      },
      setEmpty: function() {
          a("> [data-element_type]", this.$el).addClass("vc_empty-column"), "edit" !== vc_user_access().getState("shortcodes") && this.$content.addClass("vc_empty-container")
      },
      unsetEmpty: function() {
          a("> [data-element_type]", this.$el).removeClass("vc_empty-column"), this.$content.removeClass("vc_empty-container")
      }
  }), window.VcMessageView = vc.shortcode_view.extend({
      changeShortcodeParams: function(e) {
          var t;
          window.VcMessageView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), t = this.$el.find("> .wpb_element_wrapper").removeClass(_.values(this.params.color.value).join(" ")), _.isObject(e) && _.isString(e.color) && t.addClass(e.color)
      }
  }), window.VcMessageView_Backend = vc.shortcode_view.extend({
      changeShortcodeParams: function(e) {
          var t, n, o, i;
          switch (window.VcMessageView_Backend.__super__.changeShortcodeParams.call(this, e), t = e.get("params"), e = this.$el.find("> .wpb_element_wrapper"), n = ["vc_message_box"], _.isUndefined(t.message_box_style) && (t.message_box_style = "classic"), _.isUndefined(t.message_box_color) && (t.message_box_color = "alert-info"), t.style ? "3d" === t.style ? (t.message_box_style = "3d", t.style = "rounded") : "outlined" === t.style ? (t.message_box_style = "outline", t.style = "rounded") : "square_outlined" === t.style && (t.message_box_style = "outline", t.style = "square") : t.style = "rounded", n.push("vc_message_box-" + t.style), t.message_box_style && n.push("vc_message_box-" + t.message_box_style), e.attr("class", "wpb_element_wrapper"), e.find(".vc_message_box-icon").remove(), o = _.isUndefined(t["icon_" + t.icon_type]) ? "fa fa-info-circle" : t["icon_" + t.icon_type], i = t.color, t.color) {
              case "info":
                  o = "fa fa-info-circle";
                  break;
              case "alert-info":
                  o = "vc_pixel_icon vc_pixel_icon-info";
                  break;
              case "success":
                  o = "fa fa-check";
                  break;
              case "alert-success":
                  o = "vc_pixel_icon vc_pixel_icon-tick";
                  break;
              case "warning":
                  o = "fa fa-exclamation-triangle";
                  break;
              case "alert-warning":
                  o = "vc_pixel_icon vc_pixel_icon-alert";
                  break;
              case "danger":
                  o = "fa fa-times";
                  break;
              case "alert-danger":
                  o = "vc_pixel_icon vc_pixel_icon-explanation";
                  break;
              default:
                  i = t.message_box_color
          }
          n.push("vc_color-" + i), e.addClass(n.join(" ")), e.prepend(a('<div class="vc_message_box-icon"><i class="' + o + '"></i></div>'))
      }
  }), window.VcTextSeparatorView = vc.shortcode_view.extend({
      changeShortcodeParams: function(e) {
          window.VcTextSeparatorView.__super__.changeShortcodeParams.call(this, e), e = e.get("params");
          var t = this.$el.find("> .wpb_element_wrapper");
          _.isObject(e) && _.isString(e.title_align) && t.removeClass(_.values(this.params.title_align.value).join(" ")).addClass(e.title_align), _.isObject(e) && _.isString(e.add_icon) && "true" === e.add_icon && ((e = a('<i class="' + e["i_icon_" + e.i_type] + '" ></i>')).prependTo(t.find("[name=title]")), e.after(" "))
      }
  }), window.VcCallToActionView = vc.shortcode_view.extend({
      changeShortcodeParams: function(e) {
          window.VcCallToActionView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), _.isObject(e) && _.isString(e.position) && this.$el.find("> .wpb_element_wrapper").removeClass(_.values(this.params.position.value).join(" ")).addClass(e.position)
      }
  }), window.VcCallToActionView3 = vc.shortcode_view.extend({
      changeShortcodeParams: function(e) {
          var t;
          window.VcCallToActionView3.__super__.changeShortcodeParams.call(this, e), e = _.extend({
              add_icon: "",
              i_type: ""
          }, e.get("params")), t = this.$el.find(".vc_admin_label.admin_label_i_type"), _.isEmpty(e.add_icon) ? t.addClass("hidden-label").hide() : _.isEmpty(e.i_type) || _.isEmpty(e["i_icon_" + e.i_type]) || (e = vc_toTitleCase(e.i_type) + ' - <i class="' + e["i_icon_" + e.i_type] + '"></i>', t.html("<label>" + t.find("label").text() + "</label>: " + e), t.show().removeClass("hidden-label"))
      }
      ...
      toggle: function(e) {
          e && e.preventDefault && e.preventDefault(), a(e.currentTarget).toggleClass("vc_toggle_title_active"), a(".vc_toggle_content", this.$el).slideToggle(500)
      },
      changeShortcodeParams: function(e) {
          window.VcToggleView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), _.isObject(e) && _.isString(e.open) && "true" === e.open && a(".vc_toggle_title", this.$el).addClass("vc_toggle_title_active").next().show()
      }
      ...
      changeShortcodeParams: function(e) {
          var t;
          window.VcButtonView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), _.isObject(e) && (t = e.color + " " + e.size + " " + e.icon, this.$el.find(".wpb_element_wrapper").removeClass(t), this.$el.find("button.title").attr({
              class: "title textfield wpb_button " + t
          }), "none" !== e.icon && 0 === this.$el.find("button i.icon").length ? this.$el.find("button.title").append('<i class="icon"></i>') : this.$el.find("button.title i.icon").remove())
      }
      ...
      changeShortcodeParams: function(e) {
          window.VcButton2View.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), _.isObject(e) && (e = (e.color ? "vc_btn_" + e.color : "") + " " + (e.color ? "vc_btn-" + e.color : "") + " " + (e.size ? "vc_btn-" + e.size : "") + " " + (e.size ? "vc_btn_" + e.size : "") + " " + (e.style ? "vc_btn_" + e.style : ""), this.$el.find(".wpb_element_wrapper").removeClass(e), this.$el.find("button.title").attr({
              class: "title textfield vc_btn  " + e
          }))
      }
      ...
      changeShortcodeParams: function(e) {
          var t;
          window.VcButton3View.__super__.changeShortcodeParams.call(this, e), t = _.extend({}, e.get("params")), this.buttonTemplate || (this.buttonTemplate = this.$el.find(".vc_btn3-container").html(), this.buttonTemplateCompiled = vc.template(this.buttonTemplate, vc.templateOptions.custom)), this.$wrapper || (this.$wrapper = this.$el.find(".wpb_element_wrapper")), _.isObject(t) && (t.title && _.isEmpty(t.title.trim()) && (t.title = '<span class="vc_btn3-placeholder">&nbsp;</span>'), "custom" === t.style ? (t.color = void 0, _.isEmpty(t.custom_background) && _.isEmpty(t.custom_text) && (t.color = "grey")) : "outline-custom" === t.style && (t.color = void 0, _.isEmpty(t.outline_custom_color)) && _.isEmpty(t.outline_custom_hover_background) && _.isEmpty(t.outline_custom_hover_text) && (t.style = "outline", t.color = "grey"), e = a(this.buttonTemplateCompiled({
              params: t
          })), "custom" === t.style ? ("undefined" !== t.custom_background && e.css("background-color", t.custom_background), "undefined" !== t.custom_text && e.css("color", t.custom_text)) : "outline-custom" === t.style && e.css({
              "background-color": "transparent",
              "border-color": t.outline_custom_color,
              color: t.outline_custom_color
          }).hover(function() {
              a(this).css({
                  "background-color": t.outline_custom_hover_background,
                  "border-color": t.outline_custom_hover_background,
                  color: t.outline_custom_hover_text
              })
          }, function() {
              a(this).css({
                  "background-color": "transparent",
          ...
          }), this.$wrapper.find(".vc_btn3-container").html(e))
      }
      ...
      initialize: function(e) {
          window.VcTabsView.__super__.initialize.call(this, e), _.bindAll(this, "stopSorting")
      },
      render: function() {
      ...
      createAddTabButton: function() {
          var e = Date.now() + "-" + Math.floor(11 * Math.random());
           // nectar addition vc_tab to tab
          this.$tabs.append('<div id="new-tab-' + e + '" class="new_element_button"></div>'), this.$add_button = a('<li class="add_tab_block"><a href="#new-tab-' + e + '" class="add_tab" title="' + window.i18nLocale.add_tab + '"></a></li>').appendTo(this.$tabs.find(".tabs_controls")), vc_user_access().shortcodeAll("tab") || this.$add_button.hide()
      },
      addTab: function(e) {
           /* nectar addition */
            // nectar addition vc_tab to tab
            ...
            if(this.model.get('shortcode') === 'testimonial_slider') { 
                ...
                if(jQuery(this.$add_button[0]).parent().find('li:not(.add_tab_block )').length >= 4) jQuery(this.$add_button[0]).hide();
      ...
      stopSorting: function(e, t) {
          var n;
          this.$tabs.find("ul.tabs_controls li:not(.add_tab_block)").each(function(e) {
              a(this).find("a").attr("href").replace("#", "");
              n = vc.shortcodes.get(a("[id=" + a(this).attr("aria-controls") + "]").data("model-id")), vc.storage.lock(), n.save({
                  order: a(this).index()
              })
          }), n && n.save()
      },
      ...
      changedContent: function(view) {
        ...
        if (view.model.get('cloned') === true) {
            ...
            var cloned_from = view.model.get('cloned_from'),
                $tab_controls = jQuery('.tabs_controls > .add_tab_block', this.$content),
                $new_tab = jQuery("<li><a href='#tab-" + params.id + "'>" + params.title + "</a></li>").insertBefore($tab_controls);
            ...
            jQuery("<li><a href='#tab-" + params.id + "'>" + params.title + "</a></li>")
        ...
        if(this.model.get('shortcode') === 'pricing_table' && jQuery(this.$add_button[0]).parent().find('li:not(.add_tab_block )').length >= 5) jQuery(this.$add_button[0]).hide();
       /* nectar addition end */
       },
       ...
       render:function () {
        ...
        changeShortcodeParams:function (model) {
            ...
            if (_.isObject(params) && _.isString(params.title) && _.isString(params.id)) {
                jQuery('.ui-tabs-nav [href="#tab-' + params.id + '"]').text(params.title);
            }
        },
        deleteShortcode:function (e) {
            _.isObject(e) && e.preventDefault();
            ...
            if(jQuery('[href="#tab-' + params.tab_id + '"]').length > 0) {
                var current_tab_index = jQuery('[href="#tab-' + params.tab_id + '"]', this.$tabs).parent().index();
                jQuery('[href="#tab-' + params.tab_id + '"]').parent().remove();
            }
            else if(jQuery('[href="#tab-' + params.id + '"]').length > 0) {
                var current_tab_index = jQuery('[href="#tab-' + params.id + '"]', this.$tabs).parent().index();
                jQuery('[href="#tab-' + params.id + '"]').parent().remove();
            }
            ...
            if(this.model.get('shortcode') === 'pricing_column'){
                if(jQuery(this.$tabs[0]).find('.tabs_controls li:not(.add_tab_block )').length <= 4) jQuery(this.$tabs[0]).find('.tabs_controls li.add_tab_block').show();
            }
    ...
    /* nectar addition end */
      ...
      changeShortcodeParams: function(e) {
          var t = e.get("shortcode"),
              o = e.get("params"),
              t = vc.map[t];
          _.isArray(t.params) && _.each(t.params, function(e) {
              var t, n;
              !_.isUndefined(e.admin_label) && e.admin_label && (e = e.param_name, t = o[e], (n = this.$el.find("> .wpb_element_wrapper").children(".admin_label_" + e)).length) && ("" === t || _.isUndefined(t) ? n.hide().addClass("hidden-label") : ("type" !== e || _.isUndefined(o["icon_" + t]) || (t = vc_toTitleCase(t) + " - <i class='" + o["icon_" + t] + "'></i>"), n.html("<label>" + n.find("label").text() + "</label>: " + this.sanitizeTags(t)), n.show().removeClass("hidden-label"))) // nectar addition sanitizeTags added to value
          }, this), t = vc.app.views[this.model.get("parent_id")], !1 !== e.get("parent_id") && _.isObject(t) && t.checkIsEmpty()
      }
      ...
      initialize: function(e) {
          window.VcBackendTtaViewInterface.__super__.initialize.call(this, e), _.bindAll(this, "updateSorting")
      },
      render: function() {
      ...
      findSection: function(e) {
          return this.$content.children('[data-model-id="' + e + '"]')
      },
      getIndex: function(e) {
          return e.index()
      },
      buildSortable: function(e) {
          return !("edit" === vc_user_access().getState("shortcodes") || !vc_user_access().shortcodeAll("vc_tta_section")) && e.sortable({
              forcePlaceholderSize: !0,
      ...
      updateSorting: function(e, t) {
          var n;
          if (!vc_user_access().shortcodeAll("vc_tta_section")) return !1;
          (n = this).$sortable.find(this.sortableSelector).each(function() {
              var e = a(this),
                  t = e.attr(n.sortableUpdateModelIdSelector),
                  t = vc.shortcodes.get(t);
              vc.storage.lock(), t.save({
                  order: n.getIndex(e)
              })
      ...
      changeActiveSection: function(e) {
          this.$content.children(".vc_tta-panel." + this.activeClass).removeClass(this.activeClass), this.findSection(e).addClass(this.activeClass)
      },
      changedContent: function(e) {
          e = window.VcBackendTtaViewInterface.__super__.changedContent.call(this, e);
          return this.checkForActiveSection(), this.buildSortable(this.$sortable), e
      },
      notifySectionChanged: function(e) {
          var t = e.get("view");
          _.isObject(t) && (e = e.getParam("title"), _.isString(e) && e.length || (e = this.defaultSectionTitle), t.$el.find(".vc_tta-panel-title a .vc_tta-title-text").text(e))
      },
      notifySectionRendered: function(e) {},
      getNextTab: function(e) {
          var t = this.$navigation.children(),
              n = t.length - 2,
              e = e.index(),
              n = e !== n ? t.eq(e + 1) : t.eq(e - 1);
          return n
      },
      renderSortingPlaceholder: function(e, t) {
          return vc.app.renderPlaceholder(e, t)
      }
      ...
      setNavigationSectionTemplate: function(e) {
          this.navigationSectionTemplate = e, this.navigationSectionTemplateParsed = vc.template(this.navigationSectionTemplate, vc.templateOptions.custom)
      },
      getNavigationSectionTemplate: function() {
          return this.navigationSectionTemplate
      },
      getParsedNavigationSectionTemplate: function(e) {
          return this.navigationSectionTemplateParsed(e)
      },
      changeNavigationSectionTitle: function(e, t) {
          this.findNavigationTab(e).find("[data-vc-target]").text(t)
      },
      changeActiveSection: function(e) {
          window.VcBackendTtaTabsView.__super__.changeActiveSection.call(this, e), this.$navigation.children("." + this.activeClass).removeClass(this.activeClass), this.findNavigationTab(e).addClass(this.activeClass)
      },
      notifySectionRendered: function(e) {
          var t, n;
          window.VcBackendTtaTabsView.__super__.notifySectionRendered.call(this, e), t = e.getParam("title"), t = a(this.getParsedNavigationSectionTemplate({
              model_id: e.get("id"),
              section_title: _.isString(t) && 0 < t.length ? t : this.defaultSectionTitle
          })), e.get("cloned") ? (n = e.get("cloned_from"), _.isObject(n) && ((n = this.$navigation.children('[data-vc-target-model-id="' + n.id + '"]')).length ? t.insertAfter(n) : t.insertBefore(this.$navigation.children(".vc_tta-section-append")))) : e.get("prepend") ? t.insertBefore(this.$navigation.children(":first-child")) : t.insertBefore(this.$navigation.children(":last-child"))
      },
      notifySectionChanged: function(e) {
          var t;
          window.VcBackendTtaTabsView.__super__.notifySectionChanged.call(this, e), t = e.getParam("title"), _.isString(t) && t.length || (t = this.defaultSectionTitle), this.changeNavigationSectionTitle(e.get("id"), t), e.view.$el.find("> .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_element-name").removeClass("vc_element-move"), e.view.$el.find("> .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_element-name .vc-c-icon-dragndrop").hide()
      },
      makeFirstSectionActive: function() {
          var e = this.$navigation.children(":first-child:not(.vc_tta-section-append)").addClass(this.activeClass);
          e.length && this.findSection(e.data("vc-target-model-id")).addClass(this.activeClass)
      },
      findNavigationTab: function(e) {
          return this.$navigation.children('[data-vc-target-model-id="' + e + '"]')
      },
      removeSection: function(e) {
          var t, e = this.findNavigationTab(e.get("id"));
          e.hasClass(this.activeClass) && ((t = this.getNextTab(e)).addClass(this.activeClass), this.changeActiveSection(t.data("vc-target-model-id"))), e.remove()
      },
      renderSortingPlaceholder: function(e, t) {
          var n = t,
              o = t.width() + 1,
              t = t.height();
          return n.width(o), n.height(t), n
      }
      ...
      removeSection: function(e) {
          e = this.findSection(e.get("id"));
          e.hasClass(this.activeClass) && this.getNextTab(e).addClass(this.activeClass)
      },
      addShortcode: function(e) {
          var t = _.last(vc.shortcodes.filter(function(e) {
              return e.get("parent_id") === this.get("parent_id") && parseFloat(e.get("order")) < parseFloat(this.get("order"))
          }, e.model));
          t ? e.render().$el.insertAfter("[data-model-id=" + t.id + "]") : this.$content.prepend(e.render().el)
      }
      ...
      render: function() {
          var e;
          return window.VcBackendTtaSectionView.__super__.render.call(this), e = vc.shortcodes.get(this.model.get("parent_id")), _.isObject(e) && !_.isUndefined(e.view) && (this.parentObj = e), this.$el.addClass("vc_tta-panel"), this.$el.attr("style", ""), this.$el.attr("data-vc-toggle", "tab"), this.replaceTemplateVars(), this
      },
      replaceTemplateVars: function() {
          var e = this.model.getParam("title"),
              t = (_.isEmpty(e) && (e = this.parentObj && this.parentObj.defaultSectionTitle && this.parentObj.defaultSectionTitle.length ? this.parentObj.defaultSectionTitle : window.i18nLocale.section), this.$el.find(".vc_tta-panel-heading")),
              n = vc.template(t.html(), vc.templateOptions.custom);
          t.html(n({
      ...
      changeShortcodeParams: function(e) {
          window.VcBackendTtaSectionView.__super__.changeShortcodeParams.call(this, e), _.isObject(this.parentObj) && this.parentObj.view && this.parentObj.view.notifySectionChanged && this.parentObj.view.notifySectionChanged(e)
      }
  }), vc.addTemplateFilter(function(e) {
      /* nectar addition */ 
      var random_id = VCS4() + "-" + VCS4();
      return e.replace(/tab\_id\=\"([^\"]+)\"/g, 'id="$1' + random_id + '"')
      /* nectar addition end */
  })
}(window.jQuery);
! function(o, r) {
  var e, a = [],
      c = wp.media,
      i = c.featuredImage.set,
      n = c.editor.send.attachment,
      l = i18nLocale,
      d = {};
  ...
  function t(r, l) {
      ...
      o.ajax({
          ...
          if ("function" == typeof l) {
              for (t = [], a = 0; a < e.data.ids.length; a++) i = (i = "function" == typeof i ? r.get(e.data.ids[a]) : r[e.data.ids[a]]) || c.model.Attachment.get(e.data.ids[a]), t.push(i);
              var n = function(e) {
  ...
  e = r.extend(c.view.AttachmentCompat.prototype.render), c.view.AttachmentCompat.prototype.render = function() {
      var a = this,
          n = this.model.get("id");
  ...
  }, c.editor.send.attachment = function(i, e) {
          ...
          n(i, t).done(function(e) {
              ! function e(t, i) {
                  a && a[0] !== i ? setTimeout(function() {
                      e(t, i)
                  }, 50) : (a.shift(), c.editor.insert(t))
              }(e, t.id)
          })
      })
  }, c.featuredImage.set = function(t) {
      -1 !== t ? o.ajax({
          type: "POST",
          url: window.ajaxurl,
          data: {
  ...
  }, c.controller.VcSingleImage = c.controller.FeaturedImage.extend({
      defaults: r.defaults({
          id: "vc_single-image",
          filterable: "uploaded",
          multiple: !1,
          ...
          priority: 60,
          syncSelection: !1
      }, c.controller.Library.prototype.defaults),
      updateSelection: function() {
          var e, t = this.get("selection"),
              i = c.vc_editor.getData();
          void 0 !== i && "" !== i && -1 !== i && (e = r.map(i.toString().split(/,/), function(e) {
              e = c.model.Attachment.get(e);
              return e.get("url") && e.get("url").length || e.fetch(), e
          })), t.reset(e)
      }
  }), c.controller.VcGallery = c.controller.VcSingleImage.extend({
      defaults: r.defaults({
          id: "vc_gallery",
          title: l.add_images,
          toolbar: "main-insert",
  ...
  }, c.view.MediaFrame.VcGallery = c.view.MediaFrame.Post.extend({
      createStates: function() {
          this.states.add([new c.controller.VcGallery])
      },
      bindHandlers: function() {
          c.view.MediaFrame.Select.prototype.bindHandlers.apply(this, arguments), this.on("toolbar:create:main-insert", this.createToolbar, this);
          r.each({
              content: {
                  embed: "embedContent",
  ...
  }), c.vc_editor = r.clone(c.editor), r.extend(c.vc_editor, {
      $vc_editor_element: null,
      getData: function() {
          return c.vc_editor.$vc_editor_element.closest(".edit_form_line").find(".gallery_widget_attached_images_ids").val()
      },
      insert: function(e) {
          var t = c.vc_editor.$vc_editor_element.closest(".edit_form_line"),
        ...
        /* nectar addition */
        jQuery('style.wp-gallery-extra-input').remove();
        /* nectar addition end */
      },
      open: function(e) {
          var t;
      ...
      add: function(e, t) {
          ...
          if (!i) {
              if (d[e]) return d[e];
              i = d[e] = new c.view.MediaFrame.VcGallery(r.defaults(t || {}, {
                  state: "vc_gallery",
                  title: l.add_images,
                  library: {
                      type: "image"
      ...
      init: function() {
          /* nectar addition */ 
            jQuery("body").off("click.vcGalleryWidget").on("click.vcGalleryWidget", ".gallery_widget_add_images", function($this) {
                event.preventDefault();
                var $this = jQuery(this);

            if(jQuery('select[name=type]').length > 0 && jQuery('select[name=type]').val() == 'image_grid'){
            ...
            jQuery(style).attr('class','wp-gallery-extra-input');
            
            if(jQuery('select[name=type]').length > 0 && jQuery('select[name=type]').val() == 'image_grid' ||
            jQuery('select[name=type]').length > 0 && jQuery('select[name=type]').val() == 'parallax_image_grid') head.appendChild(style);
                const media = c; // nectar addition - verify c is the active media object above i.e. c.vc_editor - c could be renamed in the future
                media.vc_editor.$vc_editor_element = jQuery(this), "true" !== $this.attr("use-single") ? ($this.blur(), media.vc_editor.open("visual-composer")) : media.VcSingleImage.frame(this).open("vc_editor")
            });
        /* nectar addition end */
      }
  }), r.bindAll(c.vc_editor, "open"), o(document).ready(function() {
      c.vc_editor.init()
      ...
      o(".media-modal").addClass("processing-media"), t(i, function(e) {
          ...
          switch (i.reset(e), t = r.map(i.models, function(e) {
              ...
              case "gallery":
                  c.vc_editor.insert(t);
                  break;
              case "single":
                    /* nectar addition */ 
                    // verify that  t, e = r.map(e, function(e) { exists above. is. "t" since it could change in the future to another random letter from minification
                    var objects = t;
                    //hotspot logic
                    if(jQuery('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0) {
                        jQuery('#nectar_image_with_hotspots_preview img').remove();
                        jQuery('#nectar_image_with_hotspots_preview').removeClass('no-img').append('<img src="'+objects[0]['url']+'" alt="preview" />');
                        jQuery('#nectar_image_with_hotspots_preview input[type="hidden"]').attr('value',objects[0]['url']);
                    }
                    /* nectar addition end */ 
                  c.VcSingleImage.set(t[0])
          }
...
! function(e) {
  e(function() {
      var o, d, n;
      window.vc && window.vc.events && (o = e("#vc_navbar-undo"), d = e("#vc_navbar-redo"), n = function(o) {
          vc.storage.setContent(o), vc.shortcodes.fetch({
              reset: !0
          }), _.delay(function() {
      ...
      }, 150)), o.on("click.vc-undo", function(o) {
          e(this).is("[disabled]") || window.vc.undoRedoApi.isLocked() ? o && o.preventDefault && o.preventDefault() : (vc.closeActivePanel(), window.vc.undoRedoApi.lock(), o = window.vc.undoRedoApi.undo(), n(o))
      }), d.on("click.vc-redo", function(o) {
          e(this).is("[disabled]") || window.vc.undoRedoApi.isLocked() ? o && o.preventDefault && o.preventDefault() : (vc.closeActivePanel(), window.vc.undoRedoApi.lock(), o = window.vc.undoRedoApi.redo(), n(o))
      }))
  })
}(window.jQuery);
window.vc || (window.vc = {}),
  function() {
      ...
      vc.pasteShortcode = function(e, t, o) {
          ...
          o = vc.shortcodes.createShortcodeString(o), localStorage.setItem("copiedShortcode", JSON.stringify(o));
          if (navigator.clipboard) navigator.clipboard.writeText(o);
          else {
              ...
              try {
                  ...
                  console.error("Unable to copy", o)
              }
              document.body.removeChild(e)
          }
      };
      var a = function(o, e, t) {
              var r, c, n, i, a, d, s, l = !0;
              return o ? (e = (o = p(o, e, t)).isModelRow, r = o.isModelRowInner, c = o.isModelTtaSection, n = o.isTopShortcodeRow, i = o.isTopShortcodeRowInner, a = o.isTopShortcodeSection, d = o.containerPreventsShortcode, l = (s = o.isShortcodeContainer) && (d && !(c && i) || !d && c && n || e && !(n || a) || r && !i || o.isModelColumn && n || o.isModelColumnInner && (i || n)) || !s && (e || r) || (o.shortcodeRejectsAsChild || o.containerRejectsAsParent) && !(a && (o.isModelSection || e))) : "vc_row" === t[0].shortcode && (l = !1), l
          },
          d = function(o, e, t, r) {
              var c, n, i, a, d, s = Object.assign({}, e);
              return o && (t = (e = p(o, e, t)).isModelRow, c = e.isModelRowInner, n = e.isModelSection, i = e.isTopShortcodeRow, a = e.isTopShortcodeRowInner, d = e.isTopShortcodeSection, e = e.isModelContainer, s.params.tab_id && (s.params.tab_id = Date.now() + "-" + vc_guid()), c && a || t && i || !o.get("parent_id") && (!n || !i) ? (r && (s.place_after_id = o.get("id")), s.parent_id = o.get("parent_id")) : e && !t && (s.parent_id = o.get("id")), (t || c) && (i || a) || (t || n) && d) && (s.order = parseFloat(o.get("order")) + vc.clone_index), r ? (r.create(s), r.last()) : vc.shortcodes.create(s)
          },
          p = function(o, e, t) {
...
! function(s) {
  s.fn.initializeTooltips = function(a) {
      return this.each(function() {
          ...
          // nectar addition
          // in wpbakery 7.7.x popper was introduced which can conflict with other third party plugins
          // that register different versinos e.g. formidable forms. This is a temporary fix to check if
          // the popper version is 2 and if not, then we will not initialize the popper.
          var usingPopperv2 = window.Popper && window.Popper.createPopper;
          if (!usingPopperv2) {
            return;
          }
          // nectar addition end
