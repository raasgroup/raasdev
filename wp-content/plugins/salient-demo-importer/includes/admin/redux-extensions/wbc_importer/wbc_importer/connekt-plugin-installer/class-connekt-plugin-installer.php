...
if( !class_exists('Connekt_Plugin_Installer') ) {
   ...
   class Connekt_Plugin_Installer {
      ...
      public function start(){
			...
			if( !defined('SALIENT_CORE_DEMO_INSTALLER_PATH') ) {
        define( 'SALIENT_CORE_DEMO_INSTALLER_PATH', SALIENT_DEMO_IMPORTER_PLUGIN_PATH . '/includes/admin/redux-extensions/wbc_importer/wbc_importer/connekt-plugin-installer/' );
      ...
      */
      public static function init($plugins){ ?>
         ...
         <?php
            ...
            echo '<h3>'. esc_html__('Required Plugins','salient-demo-importer').'</h3>';
          ...
          echo '<div class="inner">';  
   		   foreach($plugins as $plugin) :
               ...
               $button_text = __('Install Now', 'salient-demo-importer');
               ...
               if(isset($plugin['source'])) {
                 ...
                 $api = plugins_api( 'plugin_information',
                  ...
                  /*nectar addition end */ 
	                  	...
	                  	$button_text = __('Activated', 'salient-demo-importer');
	                  } else {
	                     // It's installed, let's activate it
	                  	$button_classes = 'activate button button-primary';
	                  	$button_text = __('Activate', 'salient-demo-importer');
	                  }
	               }
    ...
    /*nectar addition end*/
      ...
      */
		public function cnkt_plugin_installer(){
			...
			if ( ! current_user_can('install_plugins') )
				wp_die( __( 'Sorry, you are not allowed to install plugins on this site.', 'salient-demo-importer' ) );
      ...
      $plugin_name = $_POST["plugin_title"];
			...
			if (! wp_verify_nonce( $nonce, 'cnkt_installer_nonce' )) {
				wp_die( __( 'Error - unable to verify nonce, please try again.', 'salient-demo-importer') );
      }
      ...
      */
		public function cnkt_plugin_activation(){
			if ( ! current_user_can('install_plugins') ) {
				wp_die( __( 'Sorry, you are not allowed to activate plugins on this site.', 'salient-demo-importer' ) );
      }
      ...
      $plugin_name = $_POST["plugin_title"];
			...
			// Check our nonce, if they don't match then bounce!
			if (! wp_verify_nonce( $nonce, 'cnkt_installer_nonce' )) {
				die( __( 'Error - unable to verify nonce, please try again.', 'salient-demo-importer' ) );
      }
      ...
      */
      ...
      wp_enqueue_script( 'plugin-installer', SALIENT_CORE_DEMO_INSTALLER_PATH. 'assets/installer.js', array( 'jquery' ));
			wp_localize_script( 'plugin-installer', 'cnkt_installer_localize', array(
               'ajax_url' => admin_url('admin-ajax.php'),
               'admin_nonce' => wp_create_nonce('cnkt_installer_nonce'),
               'install_now' => __('Are you sure you want to install this plugin?', 'salient-demo-importer'),
               'install_btn' => __('Install Now', 'salient-demo-importer'),
               'activate_btn' => __('Activate', 'salient-demo-importer'),
