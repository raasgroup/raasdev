    ...
    <?php if(is_user_logged_in()){
        ...
        <form name="loginform" id="loginform" action="" method="post" class="login-form" >
            ...
            <div class="row" style="margin-bottom: 10px">
                ...
                <div class="col-md-6"><div class="custom-control custom-switch"><input name="rememberme" type="checkbox" id="rememberme" class="custom-control-input" value="forever" /> <label  class="custom-control-label" for="rememberme"><?php _e( "Remember Me" , "download-manager" ); ?></label></div></div>
                <div class="col-md-6"><div class="text-right"><a href="<?php echo wpdm_lostpassword_url(); ?>"><?php _e( "Forgot Password?" , "download-manager" ); ?></a></div></div>
            </div>
            <?php
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <?php if(count($__wpdm_social_login) > 0) { ?>
                        <div class="text-center card card-default" style="margin: 20px 0 0 0">
                            <div class="card-header">OR Connect Using Social Account</div>
                            <div class="card-body">
        ...
        <form name="loginform" id="resetPassword" action="<?php echo admin_url('/admin-ajax.php?action=resetPassword'); ?>" method="post" class="login-form" >
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <a href="<?php echo home_url('/'); ?>"><?php echo __("Home", "download-manager") ?></a> |
                    <a href="<?php echo wpdm_login_url(); ?>"><?php echo __("Login", "download-manager") ?></a> |
                    <a href="<?php echo wpdm_registration_url(); ?>"><?php echo __("Register", "download-manager") ?></a>
                </div>
            </div>
