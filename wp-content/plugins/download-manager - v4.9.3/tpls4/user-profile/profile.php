                    ...
                    <div class="card-footer">
                        ...
                        <ul class="nav nav-pills" role="tablist">
                            <?php if($q->post_count > 0){ ?>
                                <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-download"></i> &nbsp;<?php _e( "Downloads" , "download-manager" ); ?></a></li>
                            <?php } ?>
                            <!-- li role="presentation" <?php if($q->post_count == 0) echo 'class="active"'; ?>><a href="#activities" aria-controls="activities" role="tab" data-toggle="tab"><i class="fa fa-bars"></i> &nbsp; <?php _e( "Activities" , "download-manager" ); ?></a></li -->
                            <li role="presentation"><a href="#favourites" aria-controls="favourites" role="tab" data-toggle="tab"><i class="fa fa-heart"></i> &nbsp; <?php _e( "Favourites" , "download-manager" ); ?></a></li>
                            <li class="pull-right">
                                <form>
                                ...
                                <input type="search" value="<?php echo isset($_GET['ps']) && $_GET['ps'] != ''?esc_attr($_GET['ps']):''; ?>" class="form-control input-sm" name="ps" style="width: 150px;border: 0" />
                                    <div class="input-group-addon" style="font-size: 10pt;background: #ffffff;border: 0;padding: 8px 10px"><i class="fas fa-search"></i></div>
                                </div>
                                </form>
                            </li>
                        </ul>
...
<style>
    ...
    #profile-header .card h3#profile-title{
        margin-top: 20px;
    }
    #profile-header .card-footer{
        background: rgba(255,255,255,0.7);
        border: 0;
    }

    #profile-header .card .media-body{
        padding-left: 15px;
