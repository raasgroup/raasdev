...
<div  class="form-group">
    <div class="card card-default" id="package-content-section">
        <div class="card-header"><b><?php _e( "Description" , "download-manager" ); ?></b></div>
        ...
        <div class="card card-default" id="attached-files-section">
            ...
            <div class="card card-default" <?php if(in_array('package-settings', $hide)) { ?>style="display: none"<?php }?> id="package-settings-section">
...
<div class="col-md-4">
    ...
    <div class="card card-default" id="package-settings-section">
    ...
    <!-- div class="card card-default" id="package-settings-section">
        <div class="card-header"><b><?php _e( "Live Demo/Preview" , "download-manager" ); ?></b></div>
