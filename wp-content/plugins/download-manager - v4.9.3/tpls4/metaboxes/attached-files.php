                    ...
                    foreach ($files as $id => $value): ++$file_index;
                        ...
                        <div class="cfile">
                            <div class="card card-default card-file">
                                ...
                                <div class="card-header"><button type="button" class="btn btn-xs btn-secondary pull-right" rel="del"><i class="fas fa-trash color-red"></i></button> <span title="<?php echo $value; ?>"><?php echo strlen($value)<100?$value:substr($value, 0, 80).'...'; ?></span></div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="media">
