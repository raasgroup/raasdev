<div id="lock-options"  class="tab-pane">
    ...
    <div class="wpdm-accordion w3eden">
        ...
        <div class="card card-default">
            <h3 class="card-header"><label><input type="checkbox" class="wpdmlock" rel='terms' name="file[terms_lock]" <?php if(get_post_meta($post->ID,'__wpdm_terms_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Must Agree with Terms" , "download-manager" ); ?></label></h3>
        ...
        <div class="card card-default">
        <h3 class="card-header"><label><input type="checkbox" class="wpdmlock" rel='password' name="file[password_lock]" <?php if(get_post_meta($post->ID,'__wpdm_password_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Password Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="card card-default">
            <h3 class="card-header"><label><input type="checkbox" rel="linkedin" class="wpdmlock" name="file[linkedin_lock]" <?php if(get_post_meta($post->ID,'__wpdm_linkedin_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "LinkedIn Share Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="card card-default">
            <h3 class="card-header"><label><input type="checkbox" rel="tweeter" class="wpdmlock" name="file[tweet_lock]" <?php if(get_post_meta($post->ID,'__wpdm_tweet_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Tweet Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="card card-default">
            <h3 class="card-header"><label><input type="checkbox" rel="gplusone" class="wpdmlock" name="file[gplusone_lock]" <?php if(get_post_meta($post->ID,'__wpdm_gplusone_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Google +1 Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="card card-default">
            <h3 class="card-header"><label><input type="checkbox" rel="gplusshare" class="wpdmlock" name="file[twitterfollow_lock]" <?php if(get_post_meta($post->ID,'__wpdm_twitterfollow_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Twitter Follow Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="card card-default">
            <h3 class="card-header"><label><input type="checkbox" rel="facebooklike" class="wpdmlock" name="file[facebooklike_lock]" <?php if(get_post_meta($post->ID,'__wpdm_facebooklike_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Facebook Like Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="card card-default">
            <h3 class="card-header"><label><input type="checkbox" rel="email" class="wpdmlock" name="file[email_lock]" <?php if(get_post_meta($post->ID,'__wpdm_email_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Email Lock" , "download-manager" ); ?></label></h3>
