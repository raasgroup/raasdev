...
<div id="package-settings" class="tab-pane active">
    ...
    <div id="downliad_limit_row" class="form-group-row row">
        ...
        <div class="col-md-9"><div class="input-group"><input size="10" class="form-control" type="text" name="file[download_limit_per_user]" value="<?php echo get_post_meta($post->ID,'__wpdm_download_limit_per_user', true); ?>" /><div class="input-group-append"><span class="input-group-text">/ user</span></div></div></div>
    </div>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('body').on('click', '#wpdm-featured-image', function( event ){
            ...
            file_frame.on( 'select', function() {
                ...
                jQuery('#img').after('<div class="card-footer"  id="rmvp"><a href="#" class="text-danger">Remove Featured Image</a></div>');
                file_frame.close();
