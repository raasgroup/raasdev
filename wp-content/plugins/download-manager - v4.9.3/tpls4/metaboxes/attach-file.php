...
<ul class="nav nav-tabs">
    <li  class="nav-item"><a href="#upload" data-toggle="tab" class="nav-link active"><?php echo __( "Upload" , "download-manager" ); ?></a></li>
    <li class="nav-item"><a href="#browse" data-toggle="tab" class="nav-link"><?php echo __( "Browse" , "download-manager" ); ?></a></li>
    <li class="nav-item"><a href="#remote" data-toggle="tab" class="nav-link"><?php echo __( "URL" , "download-manager" ); ?></a></li>
</ul>
        ...
        <div id="drag-drop-area">
            <div class="drag-drop-inside">
                ...
                <p class="drag-drop-buttons">
                    <input id="plupload-browse-button" type="button" value="<?php esc_attr_e('Select Files'); ?>" class="btn btn-secondary btn-xs" /><br/>
...
<script type="text/html" id="wpdm-file-entry">
    <div class="cfile">
        ...
        <div class="card card-file card-default">
            <div class="card-header"><button type="button" class="btn btn-xs btn-secondary pull-right" rel="del"><i class="fa fa-times text-danger"></i></button> <span title="##filepath##">##filepath##</span></div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="media">
