...
class Packages
{
    ...
    function footerScripts(){
        if(wpdm_query_var('post_type') === 'wpdmpro' && (count($_GET) === 1 || isset($_REQUEST['s']) || isset($_REQUEST['filter_action']))) {
            ?>
                ...
                <div class="modal fade" tabindex="-1" role="dialog" id="gdluModal" style="display: none">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title"><i class="far fa-arrow-alt-circle-down color-purple"></i> <?php _e("Genrate Download Link", "download-manager"); ?></h4>
                            </div>
                            <div class="modal-body">
