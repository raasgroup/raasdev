    ...
    <tr valign="top" class="alternate author-self status-inherit" id="post-8">
                ...
                <div class="tab-content tpleditor">
                    <div class="tab-pane active" id="code">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="background: #f1f1f1"><?php _e("HTML", "download-manager");  ?></div>
                            ...
                            <div class="panel-heading" style="background: #f1f1f1;border-top: 1px solid #dddddd;border-radius: 0"><?php _e("CSS", "download-manager");  ?></div>
...
<script>
    ...
    jQuery(function(){
        jQuery('a[href="#preview"]').on('shown.bs.tab', function (e) {
            ...
            jQuery.post(ajaxurl,{action:'template_preview',template:jQuery('#templateeditor').val(),css:jQuery('#templatecss').val()},function(res){
