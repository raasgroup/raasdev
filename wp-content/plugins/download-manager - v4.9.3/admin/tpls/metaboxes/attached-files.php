                    ...
                    foreach ($files as $id => $value): ++$file_index;
                        ...
                        <div class="cfile">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading"><button type="button" class="btn btn-xs btn-danger pull-right" rel="del"><i class="fas fa-trash"></i></button> <span title="<?php echo $value; ?>"><?php echo strlen($value)<100?$value:substr($value, 0, 80).'...'; ?></span></div>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            <button type="button" class="btn btn-secondary" onclick="__showDownloadLink(<?php the_ID(); ?>, <?php echo $id; ?>)"><i class="fa fa-link"></i></button>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
