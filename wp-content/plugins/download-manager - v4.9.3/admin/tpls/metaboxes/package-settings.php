...
<div id="package-settings" class="tab-pane active">
    <table cellpadding="5" id="file_settings_table" cellspacing="0" width="100%" class="table table-bordered table-hover">
        ...
        <tr id="downliad_limit_row">
            <td valign="top"><?php echo __( "Download&nbsp;Limit:" , "download-manager" ); ?></td>
            <td><input size="10" style="width: 80px" class="form-control input-sm" type="number" name="file[download_limit_per_user]" value="<?php echo get_post_meta($post->ID,'__wpdm_download_limit_per_user', true); ?>" /> / <?php _e( "user" , "download-manager" ); ?> <i class="info fa fa-info" title="<?php _e( "For non-registered members IP will be taken as ID" , "download-manager" ); ?>"></i><br/>
                <label><input type="checkbox" name="reset_udl" value="1"> <?php _e( "Reset Limit for All Users" , "download-manager" ); ?></label>
            </td>
        </tr>
       ...
       <tr id="package_size_row">
        ...
        <tr id="individual_file_download_row">
            <td><?php echo __( "Single File Download:" , "download-manager" ); ?></td>
            <td>


                <div id="eid">
                    <input type="radio" value="-1" id="radio3" name="file[individual_file_download]" <?php if(get_post_meta($post->ID,'__wpdm_individual_file_download', true) == -1 || get_post_meta($post->ID,'__wpdm_individual_file_download', true) == null) echo 'checked=checked';?> /> <label for="radio3"><?php _e( "Use Global" , "download-manager" ); ?> &nbsp; </label>
                    <input type="radio" value="1" id="radio2" name="file[individual_file_download]" <?php checked(get_post_meta($post->ID,'__wpdm_individual_file_download', true),1);?> /> <label for="radio2"><?php _e( "Enable" , "download-manager" ); ?> &nbsp; </label>
                    <input type="radio" value="0" id="radio1" name="file[individual_file_download]" <?php checked(get_post_meta($post->ID,'__wpdm_individual_file_download', true),0);?> /> <label for="radio1"><?php _e( "Disable" , "download-manager" ); ?></label>
        ...
        <tr id="cache_zip_row">
            <td><?php echo __( "Cache Zip File:" , "download-manager" ); ?></td>
            <td>


                <div id="eid">
                    <input type="radio" value="-1" id="radio4" name="file[cache_zip]" <?php if(get_post_meta($post->ID,'__wpdm_cache_zip', true) == -1 || get_post_meta($post->ID,'__wpdm_cache_zip', true) == null) echo 'checked=checked';?> /> <label for="radio4"><?php _e( "Use Global" , "download-manager" ); ?> &nbsp; </label>
                    <input type="radio" value="1" id="radio5" name="file[cache_zip]" <?php checked(get_post_meta($post->ID,'__wpdm_cache_zip', true),1);?> /> <label for="radio5"><?php _e( "Enable" , "download-manager" ); ?> &nbsp; </label>
                    <input type="radio" value="0" id="radio6" name="file[cache_zip]" <?php checked(get_post_meta($post->ID,'__wpdm_cache_zip', true),0);?> /> <label for="radio6"><?php _e( "Disable" , "download-manager" ); ?></label>
