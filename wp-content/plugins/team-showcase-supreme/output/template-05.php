      ...
      ?>
         <div class="wpm-6310-col-<?php echo esc_attr($desktop_row) ?>">
            <div <?php echo $link_type ?>>
               ...
               <img src="<?php echo esc_attr($value['image']) ?>" data-6310-hover-image="<?php echo $value['hover_image'] ?>" alt="<?php echo esc_attr($value['name']) ?>" data-wpm-6310-image-attr="<?php echo esc_attr($value['image']) ?>">
               </div>
               <div class="wpm_6310_team_style_<?php echo esc_attr($ids) ?>_team_content">
                  <div class="wpm_6310_team_style_<?php echo $ids ?>_title">
                     <?php echo wpm_6310_multi_language_get('name', $value['name'], $value['id']) ?>
...
<?php
      ...
      .wpm_6310_team_style_".esc_attr($ids)." .wpm_6310_team_style_".esc_attr($ids)."_pic:after {
         content: '';
