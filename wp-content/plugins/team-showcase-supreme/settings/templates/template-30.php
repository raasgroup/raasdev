    ...
    <div class="wpm_6310_tabs_panel_settings">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="box_shadow_color" id="wpm_box_shadow_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($allStyle[10]) ?>">
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input type="text" name="hover_strip_color" id="wpm_hover_strip_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : $allStyle[10]) ?>">
                    </td>
                  </tr>
                </table>
              </div>
     ...
     <?php
      ...
      .wpm_6310_team_style_30_team_content {
        ...
        border-top: 20px solid ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : $allStyle[10]).";
        border-bottom: 20px solid ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : $allStyle[10]).";
        overflow: hidden;
        display: table;
        z-index: 1;
      }
