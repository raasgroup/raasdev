<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    ?>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                   <?php 
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="real_image_radius" value="<?php echo (isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0 ?>"
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">                    
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="border_width" value="<?php echo $allStyle[3] ?>"
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="box_shadow_width" value="<?php echo $allStyle[8] ?>"
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="box_shadow_blur" value="<?php echo $allStyle[9] ?>"
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      <td><b>Font Size</b></td>
                      <td>
                        <input type="number" min="0" name="member_font_size" value="<?php echo $allStyle[11] ?>"
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_line_height" id="wpm_heading_line_height" type="number" min="0"
                          value="<?php echo $allStyle[18] ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Margin Top</b>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      <td><b>Font Size</b></td>
                      <td>
                        <input type="number" min="0" name="designation_font_size" value="<?php echo $allStyle[19] ?>"
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="designation_line_height" id="wpm_designation_line_height" type="number" min="0"
                          value="<?php echo $allStyle[24] ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Margin Top</b>
                      ...
                      <td>
                        <input name="designation_margin_top" id="wpm_designation_margin_top" type="number" min="0"
                          value="<?php echo (isset($allSlider[51]) && $allSlider[51] !== '') ? $allSlider[51]:0;?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Margin Bottom</b>
                      ...
                      <td>
                        <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0"
                          value="<?php echo (isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:0;?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table" width="100%">
                    ...
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_icon_width" value="<?php echo $allStyle[26] ?>"
                    ...
                    <tr class="social_act_field">
                      <td><b>Social Icon Height</b><?php                    
                                                    ?></td>
                      <td>
                        <input type="number" min="0" name="social_icon_height" value="<?php echo $allStyle[27] ?>"
                  ...
                  <table class="table table-responsive wpm_6310_admin_table social_act_field">
                    <tr class="social_act_field">
                      <td><b>Social Icon Border Width</b><?php                    
                                                                      ?></td>
                      <td>
                        <input type="number" min="0" name="social_border_width" value="<?php echo $allStyle[28] ?>"
                    ...
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_border_radius" value="<?php echo $allStyle[30] ?>"
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-01.php';
      ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
              ...
              if ($value['profile_details_type'] == 1) {
                ...
                $attr2 = [
                 "link-id='" . esc_attr($value['id']) . "' team-id='0'",
                  wpm_6310_validate_profile_url(esc_url($value['profile_url'])),
                 esc_attr($value['open_new_tab'])
                ];
              } else if (esc_attr($value['profile_details_type'] == 2)) {
                $cls = " wpm_6310_team_member_info";
          ...
          <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
            <div class="wpm_6310_team_style_01<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?> <?php echo !$readMoreActive ? $attr : '' ?>>
              ...
              <figcaption>
                <div class="wpm_6310_team_style_01_caption">
                  <div class="wpm_6310_team_style_01_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                  <div class="wpm_6310_team_style_01_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
          ...
          if($filterList){
            ...
            foreach($filterList as $filterKey => $filterValue){
              ...
              if ($catMembers) {
                ...
                if ($value['profile_details_type'] == 1) {
              $cls = " wpm_6310_team_member_info";
              $attr = " link-id='" . esc_attr($value['id']) . "' link-url='" . esc_attr(wpm_6310_validate_profile_url($value['profile_url'])) . "' target='" . esc_attr($value['open_new_tab']) . "' team-id='0'";
              $attr2 = [
                  " link-id='" . esc_attr($value['id']) . "' team-id='0'",
                  esc_attr(wpm_6310_validate_profile_url($value['profile_url'])),
                  esc_attr($value['open_new_tab'])
              ];
      ...
      <div class="carousel">
        <div id="wpm-6310-slider-<?php echo esc_attr($styleId) ?>" class="wpm-6310-owl-carousel">
          ...
          <div class="wpm-6310-item">
           <div class="wpm_6310_team_style_01<?php echo !$readMoreActive ? $cls : ''?>" <?php echo !$readMoreActive ? $attr : '' ?>>
              <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image'] )?>" alt="<?php echo esc_attr($value['name']) ?>" >
              <figcaption>
                <div class="wpm_6310_team_style_01_caption">
                  <div class="wpm_6310_team_style_01_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
