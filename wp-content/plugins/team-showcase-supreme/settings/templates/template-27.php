<div class="wpm-6310">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                   ...
                   <tr class="social_act_field">
                    ...
                    <td>
                      <input type="number" min="0" name="social_margin_top" value="<?php echo esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 20); ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                    </td>
                  </tr>
                   <tr class="social_act_field">
 ...
 <?php
      ...
      .wpm_6310_team_style_27_social {
        ...
        position: absolute;
        bottom:  ".esc_attr((($allStyle[18] ? $allStyle[18] : 0) + ($allStyle[24] ? $allStyle[24] : 0) + 70))."px;
        left: 0;
        opacity: 0;
        z-index: 1;
        transition: all 1s ease 0s;
        padding-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 20)."px;
        padding-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 0)."px;
      }
      ...
      ?>
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-27.php';
    ?>
        ...
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div class="wpm_6310_team_style_27<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_27_team_content">
                    <div class="wpm_6310_team_style_27_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_27_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                  </div>
              </div>
        </div>
        <?php
