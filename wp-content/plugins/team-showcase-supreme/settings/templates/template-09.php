<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    ?>
      ...
      <div class="wpm_6310_tabs_panel_settings">
              ...
              <div class="row wpm_6310_padding_15_px">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      <td>
                        <b>Box Hover Background</b>
                        <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                      </td>
                      <td>
                        <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[7]) ?>">
                      </td>
       ...
       <?php
        ...
        .wpm_6310_team_style_09:hover {
          background-color: ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : '').";
        }
        ...
        .wpm_6310_team_style_09_title {
          float: left;
          width: 100%;
          margin-top: ".esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:20)."px;
        ...
        .wpm_6310_team_style_09_social {
          ...
          float: left;
          width: calc(100% + 20px);
          padding: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 10)."px 0 ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 10)."px;
          margin: 0;
          margin-left: -10px;
          list-style: none;
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-09.php';
      ?>
        ...
        $readMoreActive = esc_attr(isset($allSlider[311]) && $allSlider[311] > 0 ? 1 : 0);
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
               <div class="wpm_6310_team_style_09<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_09_team_content">
                    <div class="wpm_6310_team_style_09_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_09_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
      ...
      <div class="carousel">
        <div id="wpm-6310-slider-<?php echo esc_attr($styleId) ?>" class="wpm-6310-owl-carousel">
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_09<?php echo esc_attr(!$readMoreActive ? $cls : '' )?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_09_pic">
                    <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="img-responsive <?php echo esc_attr($allStyle[1]) ?>" alt="<?php echo esc_attr($value['name']) ?>" >
                  </div>
                  <div class="wpm_6310_team_style_09_team_content">
                    <div class="wpm_6310_team_style_09_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_09_border"></div>
                    <div class="wpm_6310_team_style_09_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
                    wpm_6310_extract_contact_info(isset($value['contact_info']) ? $value['contact_info'] : '', $styleId);
                    wpm_6310_template_skills_admin($value['skills'], $template_id, $allSlider, $value['id']);
