                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[10]) ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:8);?>" class="wpm-form-input" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:28);?>" class="wpm-form-input" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        <tr>
                                            <td>
                                                ...
                                                <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span><br />
                                            </td>
                                            <td>
                                                <label class="switch" for="wpm_social_activation">
                                                <input type="checkbox" name="social_activation" id="wpm_social_activation" value="1" <?php echo (!isset($allStyle[34]) || (isset($allStyle[34]) && $allStyle[34])) ? 'checked' : '' ?>>
  ...
  <?php
       ...
       .wpm_6310_tabs_panel_preview .wpm-6310-row {
                ...
                .wpm_6310_team_style_18 {
                    ...
                    position: relative;
                    height: 100%;
                    background-color: ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[10]).";
                }

                .wpm_6310_team_style_18:hover {
                    background-color: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '').";
                }

                .wpm_6310_team_style_18_pic {
                    position: relative;
                    overflow: hidden;
                    float: left;
                    width: 100%;
                ...
                .wpm_6310_team_style_18_pic:before {
                    content: '';
                    width: 100%;
                    height: 100%;
                    position: absolute;
                ...
                .wpm_6310_team_style_18_pic:after {
                    content: '';
                    width: 90%;
                    height: 90%;
                    position: absolute;
                ...
                .wpm_6310_team_style_18:hover .wpm_6310_team_style_18_pic:before,
                .wpm_6310_team_style_18:hover .wpm_6310_team_style_18_pic:after {
                    opacity: .7;
                ...
                .wpm_6310_team_style_18_pic img {
                    width: 100%;
                    height: auto;
                    float: left;
                    -webkit-border-radius: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0)."%;
                ...
                ul.wpm_6310_team_style_18_social {
                ...
                .wpm_6310_team_style_18:hover ul.wpm_6310_team_style_18_social {
                    opacity: 1;
                }

                ul.wpm_6310_team_style_18_social li {
                    display: inline-block;
                    margin: 0 5px 5px 0;
                }

                ul.wpm_6310_team_style_18_social li a {
                    display: inline-block;
                ...
                ul.wpm_6310_team_style_18_social li:last-child {
                    margin-right: 0;
                }

                .wpm_6310_team_style_18_team_content {
                    padding: 0 10px;
                    float: left;
                    width: 100%;
                }

                .wpm_6310_team_style_18_title {
                    ...
                    transition: background-color 0.3s ease 0s, color 0.3s ease 0s, border-left 0.3s ease 0s, border-right 0.3s ease 0s, width 0s;
                    padding-left: 10px;
                    padding-right: 10px;
                    padding-top: ".esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:20)."px;
                    padding-bottom: 10px;
                ...
                .wpm_6310_team_style_18:hover .wpm_6310_team_style_18_title {
                ...
                .wpm_6310_team_style_18_designation {
                    ...
                    margin-bottom:".esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:28)."px;
                }
      ...
      ?>
            ...
            <?php
            include wpm_6310_plugin_url . 'settings/helper/template-18.php';
            ?>
            ...
            echo "<div class='wpm-6310-row wpm-6310-default-members'{$displayCSS}>";
                    ...
                    ?>
                            <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                                <div class="wpm_6310_team_style_18<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                                    ...
                                    <div class="wpm_6310_team_style_18_team_content">
                                        <div class="wpm_6310_team_style_18_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                                        <div class="wpm_6310_team_style_18_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                                        <?php
