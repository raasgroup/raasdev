  ...
  <div class="wpm-6310-sm">
    ...
    ?>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                   <?php 
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="real_image_radius" value="<?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0) ?>"
                          class="wpm-form-input" id="wpm_real_image_radius" />
                      </td>
                    </tr>                    
                  </table>
                </div>
      ...
      <?php
        ...
        .wpm_6310_team_style_37:hover .wpm_6310_team_style_37_title {
          color: ".esc_attr($allStyle[13]).";
        }
  
        .wpm_6310_team_style_37:hover .wpm_6310_team_style_37_designation {
      ...
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-37.php';
      ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          <div class="wpm-6310-col-<?php echo esc_attr($desktop_row) ?>">
            <div class="wpm_6310_team_style_37<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
              ...
              <figcaption>
                <div class="wpm_6310_team_style_37_caption">
                  <div class="wpm_6310_team_style_37_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                  <div class="wpm_6310_team_style_37_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
