 ...
 <?php
    ...
    .wpm_6310_tabs_panel_preview .wpm-6310-row {
      ...
      .wpm_6310_team_style_25:hover {
        box-shadow: 0 0 3px ".esc_attr($allStyle[7]).";
      }
      ...
      ul.wpm_6310_team_style_25_social {
        ...
        opacity: 0;
        position: absolute;
        bottom: calc(".esc_attr($allStyle[26])."px + 55px);
      ...
      .wpm_6310_team_style_25 ul.wpm_6310_team_style_25_social li a:hover {
        width:".esc_attr(($allStyle[26] ? $allStyle[26] : 0) + 5)."px;
      }
      ...
      .wpm_6310_team_style_25_team_content {
        ...
        opacity: 0;
        position: absolute;
        bottom: ".esc_attr($allStyle[26])."px;
        left: 40px;
      ...
      ?>
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-25.php';
    ?>
        ...
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
               <div class="wpm_6310_team_style_25<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_25_team_content">
                    <div class="wpm_6310_team_style_25_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_25_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?>
                    <?php wpm_6310_read_more($readMoreActive, $template_id, $allSlider, $cls, $attr2, 0);?>
                    </div>
                  </div>
                  <?php
