<div class="wpm-6310">
  <div class="wpm-6310-sm">
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0"
                          value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:15);?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
    ...
    .wpm_6310_team_style_14_team_content {
        position: absolute;
        bottom: 10px;
        left: 0;
        opacity: 0;
        ...
        .wpm_6310_team_style_14:hover .wpm_6310_team_style_14_team_content {
        transform: scale(1);
        opacity: 1;
        transition: all 0.3s ease 0s;
    }
    ...
    .wpm_6310_team_style_14_designation {
        ...
        margin-bottom: ".esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? esc_attr($allSlider[52]) : 15)."px;
        display: block;
    ...
    ul.wpm_6310_team_style_14_social {
        ...
        float: left;
        width: 100%;
        margin-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? esc_attr($allSlider[61]) : 0)."
        margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? esc_attr($allSlider[62]) : 0)."
        padding: 0;
        list-style: none;
        text-align: center;
    }
    ...
    ul.wpm_6310_team_style_14_social li a {
        ...
        font-size: ".esc_attr(ceil((esc_attr($allStyle[26] ? $allStyle[26] : 0) + esc_attr($allStyle[27] ? $allStyle[27] : 0)) / 4))."
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-14.php';
      ?>
        ...
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div class="wpm_6310_team_style_14<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_14_team_content">
                    <div class="wpm_6310_team_style_14_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_14_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
