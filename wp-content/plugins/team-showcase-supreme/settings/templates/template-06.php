<div class="wpm-6310">
   <div class="wpm-6310-sm">
                    ...
                    ?>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php
                                    $effectsList = array(
                                       "wpm_6310_eff_nul" => "Effect 1",
                                       "wpm_6310_eff_2" => "Effect 2",
                                       "wpm_6310_eff_3" => "Effect 3",
                                       "wpm_6310_eff_4" => "Effect 4",
                                       "wpm_6310_eff_5" => "Effect 5",
                                       "wpm_6310_eff_6" => "Effect 6",
                                       "wpm_6310_eff_7" => "Effect 7",
                                       "wpm_6310_eff_8" => "Effect 8",
                                       "wpm_6310_eff_9" => "Effect 9",
                                       "wpm_6310_eff_10" => "Effect 10",
                                       "wpm_6310_eff_11" => "Effect 11"
                                    );
                                    ?>
                                    <select name="effect_appearance" id="wpm_effect_appearance" class="wpm-form-input">
                                       ...
                                       foreach ($effectsList as $k => $v) {
                                          $pro = $index++ ? " (pro)" : '';
                                          if ($k == $allStyle[1]) {
                                             echo "<option selected='' value='{$k}'>{$v}{$pro}</option>";
                                          } else {
                                             echo "<option value='{$k}'>{$v}{$pro}</option>";
                                          }
                                       }
                                       ?>
                                    </select>
                        ...
                        <div class="wpm-col-6">
                           <table class="table table-responsive wpm_6310_admin_table">
                              ...
                              <tr class="social_act_field">
                                 ...
                                 <td>
                                    <input type="number" min="0" name="social_margin_top" value="<?php echo esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 10); ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                                 </td>
                              </tr>
                              <tr class="social_act_field">
                                 <td>
                                    <b>Social Icon Margin Bottom</b>
                                    <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                                 </td>
                                 <td>
    ...
    <?php
            ...
            .wpm_6310_team_style_06 img.wpm_6310_eff_2,
            .wpm_6310_team_style_06 img.wpm_6310_eff_3,
            .wpm_6310_team_style_06 img.wpm_6310_eff_4,
            .wpm_6310_team_style_06 img.wpm_6310_eff_5,
            .wpm_6310_team_style_06 img.wpm_6310_eff_6,
            .wpm_6310_team_style_06 img.wpm_6310_eff_7,
            .wpm_6310_team_style_06 img.wpm_6310_eff_8,
            .wpm_6310_team_style_06 img.wpm_6310_eff_9,
            .wpm_6310_team_style_06 img.wpm_6310_eff_10,
            .wpm_6310_team_style_06 img.wpm_6310_eff_11 {
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_2 {
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_3 {
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_4 {
               -webkit-transform: translate3d(0, 100%, 0);
               -moz-transform: translate3d(0, 100%, 0);
               -o-transform: translate3d(0, 100%, 0);
               transform: translate3d(0, 100%, 0)
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_5 {
               -webkit-transform: translate3d(-100%, 0, 0);
               -moz-transform: translate3d(-100%, 0, 0);
               -o-transform: translate3d(-100%, 0, 0);
               transform: translate3d(-100%, 0, 0)
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_6 {
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_7 {
               -webkit-transform: rotate(-360deg) scale(0.5);
               -moz-transform: rotate(-360deg) scale(0.5);
               -ms-transform: rotate(-360deg) scale(0.5);
               transform: rotate(-360deg) scale(0.5);
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_8 {
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_9 {
               -webkit-transform: translate3d(100%, -100%, 0);
               -moz-transform: translate3d(100%, -100%, 0);
               -o-transform: translate3d(100%, -100%, 0);
               transform: translate3d(100%, -100%, 0)
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_10 {
               -webkit-transform: translate3d(100%, 100%, 0);
               -moz-transform: translate3d(100%, 100%, 0);
               -o-transform: translate3d(100%, 100%, 0);
               transform: translate3d(100%, 100%, 0)
            ...
            .wpm_6310_team_style_06:hover img.wpm_6310_eff_11 {
               -webkit-transform: translate3d(-100%, 100%, 0);
               -moz-transform: translate3d(-100%, 100%, 0);
               -o-transform: translate3d(-100%, 100%, 0);
               transform: translate3d(-100%, 100%, 0)
            ...
            ul.wpm_6310_team_style_06_social {
               display: ".esc_attr((!isset($allStyle[31]) || (isset($allStyle[31]) && $allStyle[31])) ? 'block':'none').";
               float: left;
               width: 100%;
               margin: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61]:10)."px 0 ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62]:0)."px;
               padding: 0;
               list-style: none;
            }
      ...
      ?>
      <?php
         include wpm_6310_plugin_url . 'settings/helper/template-06.php';
         ?>
      ...
      >
            ...
            echo "<div class='wpm-6310-row wpm-6310-default-members'{$displayCSS}>";
               ...
               ?>
                     ...
                     <div class="wpm_6310_team_style_06<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                           ...
                           <figcaption>
                              <div class="wpm_6310_team_style_06_content">
                                 <div class="wpm_6310_team_style_06_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                                 <div class="wpm_6310_team_style_06_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                                 <?php
