  ...
  <div class="wpm-6310-sm">
    ...
    <div class="wpm_6310_tabs_panel_settings">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr(isset($allSlider[42]) ? $allSlider[42] : 5); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="designation_font_hover_color" id="wpm_designation_font_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($allStyle[14]) ?>">
                    </td>
                  </tr>
                  <tr>
                    <td><b>Font Weight</b>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 12); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
     ...
     <?php
      ...
      .wpm_6310_team_style_17_pic_border {
        position: relative;
        padding: ".esc_attr($allStyle[3])."px 0 ".esc_attr($allStyle[3])."px " . esc_attr(($allStyle[3] ? $allStyle[3] : 1) * 2) . "px;
      }

      .wpm_6310_team_style_17_pic_border:before {
        content: '';
        width: 40px;
        height: 100%;
        position: absolute;
      ...
      .wpm_6310_team_style_17_pic {
        position: relative;
        overflow: hidden;
      }

      .wpm_6310_team_style_17_pic:after {
        content: '';
        width: 100%;
        height: 100%;
      ...
      .wpm_6310_team_style_17:hover .wpm_6310_team_style_17_pic:after {
        opacity: 1;
      }

      .wpm_6310_team_style_17_pic img {
        width: 100%;
        height: auto;
        float: left;
      }

        ul.wpm_6310_team_style_17_social {
      ...
      .wpm_6310_team_style_17:hover ul.wpm_6310_team_style_17_social {
        bottom: 20px;
      }

      ul.wpm_6310_team_style_17_social li {
        display: inline-block;
        margin: 0 8px 6px 0;
      }

      ul.wpm_6310_team_style_17_social li:last-child {
        margin-right: 0px;
      }

      ul.wpm_6310_team_style_17_social li a {
        display: inline-block;
      ...
      .wpm_6310_team_style_17_team_content {
        float: left;
        width: 100%;
        padding: 20px;
      ...
      .wpm_6310_team_style_17_team_content:before {
        content: '';
        width: 100%;
        height: 100%;
        position: absolute;
      ...
      .wpm_6310_team_style_17:hover .wpm_6310_team_style_17_team_content:before {
        left: 0;
      }

      .wpm_6310_team_style_17_title {
        float: left;
        width: 100%;
      ...
      .wpm_6310_team_style_17:hover .wpm_6310_team_style_17_title {
      color: ".esc_attr($allStyle[13]).";
      }

      .wpm_6310_team_style_17:hover .wpm_6310_team_style_17_designation {
        color: ".esc_attr($allStyle[14]).";
      }
      ...
      ?>
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-17.php';
    ?>
        ...
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div class="wpm_6310_team_style_17<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_17_team_content">
                    <div class="wpm_6310_team_style_17_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_17_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
      ...
      <div id="wpm-6310-slider-<?php echo esc_attr($styleId) ?>" class="wpm-6310-owl-carousel">
        ...
        ?>
            <div class="wpm-6310-item">
             <div class="wpm_6310_team_style_17<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?> <?php echo esc_attr(!$readMoreActive ? $attr : '' )?>>
                <div class="wpm_6310_team_style_17_pic_border">
                  <div class="wpm_6310_team_style_17_pic">
                    <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="img-responsive <?php echo esc_attr($allStyle[1]) ?>" alt="<?php echo esc_attr($value['name']) ?>" >
...
<script>
  jQuery(document).ready(function(){
    jQuery(".read_more_position_field").hide();    
    jQuery(".read_more_position_field").hide();
