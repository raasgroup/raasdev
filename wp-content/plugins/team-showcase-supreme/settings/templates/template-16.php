<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    $defaultDescriptionTextAlign = 'left';
    $defaultDescriptionLineHeight = '21';
    $defaultDescriptionMarginBottom = '0';
    if (!empty($_POST['update_style_change']) && $_POST['update_style_change'] == 'Save' && $_POST['styleid'] != '') {
      ...
      if (!wp_verify_nonce($nonce, 'wpm_nonce_field_form')) {
        ...
        $css .= "|" . sanitize_text_field($_POST['image_hover_overlay']);
            ...
            <div class="row wpm_6310_padding_15_px">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    <td><b>Image Hover Overlay</b>
                      <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                    </td>
                    <td>
                      <input type="text" name="image_hover_overlay" id="wpm_image_hover_overlay" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[4]) ?>">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <?php
                                                                ?></td>
                    <td>
                      <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : '') ?>">
                    </td>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 5); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 15); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
 ...
 <?php
      ...
      .wpm_6310_team_style_16:hover {
          background-color: " . esc_attr(isset($allStyle[31]) && $allStyle[31] !== '' ? $allStyle[31] : '') . ";
      }
      .wpm_6310_team_style_16_pic {
          position: relative;
          overflow: hidden;
          float: left;
          width: 100%;
      }
      .wpm_6310_team_style_16_pic img {
          width: 100%;
          height: auto;
          float: left;
      }
      .wpm_6310_team_style_16_social_team {
          width: 100%;
          height: 100%;
          position: absolute;
          bottom: -99%;
          transition: all 0.5s ease 0s;
          background: " . esc_attr(isset($allStyle[32]) && $allStyle[32] !== '' ? $allStyle[32] : $allStyle[4]) . ";
      }
      .wpm_6310_team_style_16:hover .wpm_6310_team_style_16_social_team {
          bottom: 0;
      }
      .wpm_6310_team_style_16_social_team:before {
          content: \"\";
          width: 90%;
          height: 0;
          position: absolute;
          ...
          -webkit-border-top-left-radius: " . esc_attr($allStyle[2]) . "px;
          -o-border-top-left-radius: " . esc_attr($allStyle[2]) . "px;
          -moz-border-top-left-radius: " . esc_attr($allStyle[2]) . "px;
          -ms-border-top-left-radius: " . esc_attr($allStyle[2]) . "px;
          border-top-left-radius: " . esc_attr($allStyle[2]) . "px;
      }

      .wpm_6310_team_style_16:hover .wpm_6310_team_style_16_social_team:before {
        opacity: 1;
        height: 90%;

      }

        .wpm_6310_team_style_16_social {
      ...
      .wpm_6310_team_style_16:hover .wpm_6310_team_style_16_social {
          opacity: 1;
          transform: scale(1);
      }

      .wpm_6310_team_style_16_social li {
          display: inline-block;
          margin: 0 5px 5px 0;
      }

      .wpm_6310_team_style_16_social li:last-child {
          margin-right: 0px;
      }

      .wpm_6310_team_style_16_social li a {
          display: inline-block;
          width: ".esc_attr($allStyle[27])."px;
      ...
      .wpm_6310_team_style_16_team_content {
          float: left;
          width: calc(100% - 50px);
      ...
      .wpm_6310_team_style_16_button:hover {
        background: #009999;
        color: black;
        cursor: pointer;
      }

      .wpm_6310_team_style_16_button:after {
        content: '';
        background: #9c88b9;
        position: absolute;
        width: 36px;
      ...
      .wpm_6310_team_style_16 .wpm_6310_team_style_16_button:hover::after {
        background: #009999;
      }
      ...
      ?>
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-16.php';
    ?>
        ...
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
               <div class="wpm_6310_team_style_16<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_16_team_content">
                    <div class="wpm_6310_team_style_16_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_16_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
      ...
      <div id="wpm-6310-slider-<?php echo esc_attr($styleId) ?>" class="wpm-6310-owl-carousel">
        ...
        ?>
            <div class="wpm-6310-item">
              <div class="wpm_6310_team_style_16<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                <div class="wpm_6310_team_style_16_pic">
                  <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo $value['hover_image'] ?>" class="img-responsive <?php echo esc_attr($allStyle[1]) ?>" alt="<?php echo esc_attr($value['name']) ?>" >
                  <div class="wpm_6310_team_style_16_social_team">
                    <?php
                    wpm_6310_social_icon($value['iconids'], $value['iconurl'], $allStyle[28], $value['id'], $template_id, '', '', isset($allSlider['63']) ? $allSlider['63'] : 4);
                    ?>
