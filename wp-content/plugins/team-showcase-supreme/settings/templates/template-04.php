  ...
  <div class="wpm-6310-sm">
    ...
    if (!empty($_POST['update_style_change']) && $_POST['update_style_change'] == 'Save' && $_POST['styleid'] != '') {
      ...
      if (!wp_verify_nonce($nonce, 'wpm_nonce_field_form')) {
        ...
        $css .= "|" . sanitize_text_field($_POST['member_bg_color']);
        $css .= "|" . sanitize_text_field($_POST['designation_bg_color']);
    ...
    ?>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="member_bg_color" id="wpm_member_bg_color" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[13]) && $allStyle[13] !== '') ? $allStyle[13] : 'rgba(31, 125, 207, 1)') ?>">
                      </td>
                    </tr>
                    <tr>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="designation_bg_color" id="wpm_designation_bg_color" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[14]) && $allStyle[14] !== '') ? esc_attr($allStyle[14]) : 'rgba(31, 125, 207, 1)'); ?>">
                      </td>
                    </tr>
                    <tr>
                      <td><b>Font Weight</b><?php                     
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      ...
                      <td>
                          ...
                          <input type="checkbox" name="social_activation" id="wpm_social_activation" value="1" <?php echo esc_attr((!isset($allStyle[31])) || esc_attr((isset($allStyle[31])) && esc_attr($allStyle[31])) ? 'checked' : '') ?>>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                     ...
                     <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_margin_top" value="<?php echo esc_attr(((isset($allSlider[61])) && esc_attr($allSlider[61]) !== '') ? esc_attr($allSlider[61]) : 0); ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                      </td>
                    </tr>
                     <tr class="social_act_field">
      ...
      <?php
        ...
        .wpm_6310_team_style_04_designation {
          ...
          background-color: ".esc_attr((isset($allStyle[14]) && $allStyle[14] !== '') ? $allStyle[14] : 'rgba(31, 125, 207, 1)').";
        }
        ...
        .wpm_6310_team_style_04_title {
          ...
          background-color: ".esc_attr((isset($allStyle[13]) && $allStyle[13] !== '') ? $allStyle[13] : 'rgba(31, 125, 207, 1)').";
        }
        ...
        .wpm_6310_team_style_04:hover .wpm_6310_team_style_04_designation,
        .wpm_6310_team_style_04:hover .wpm_6310_team_style_04_title {
          left: -100%;
        }
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-04.php';
      ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          if ($members) {
            ...
            $link_type = " class='" . 'wpm_6310_team_style_04 wpm_6310_team_member_info' . "' link-id='" . esc_attr($value['id']) . "' link-url='" . wpm_6310_validate_profile_url($value['profile_url']) . "' target='" . esc_attr($value['open_new_tab']) . "' team-id='0'";
        } else if ($value['profile_details_type'] == 2) {
            $link_type = " class='" . 'wpm_6310_team_style_04 wpm_6310_team_member_info' . "' link-id='0' team-id='" . esc_attr($value['id']) . "'";
        }  else if ($value['profile_details_type'] == 3) {
          $link_type = " class='wpm_6310_team_style_04 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
        }  else {
            $link_type = " class='" . 'wpm_6310_team_style_04' . "' link-id='0' team-id='0'";
        }

          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div<?php echo $link_type ?>>
                  <img src="<?php echo esc_attr(($value['image']) ? esc_attr($value['image']) : esc_attr($value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" alt="<?php echo esc_attr($value['name']) ?>">
                  <figcaption>
                    <div class="wpm_6310_team_style_04_caption">
                      <div class="wpm_6310_team_style_04_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                      <div class="wpm_6310_team_style_04_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                      <?php
            ...
            foreach($filterList as $filterKey => $filterValue){
              ...
              if ($catMembers) {
                ...
                foreach ($catMembers as $value) {
                  if ($value['profile_details_type'] == 1) {
                    $link_type = " class='wpm_6310_team_style_04 wpm_6310_team_member_info' link-id='{$value['id']}' link-url='".wpm_6310_validate_profile_url($value['profile_url'])."' target='{$value['open_new_tab']}' team-id='0'";
                  } else if ($value['profile_details_type'] == 2) {
                    $link_type = " class='wpm_6310_team_style_04 wpm_6310_team_member_info' link-id='0' team-id='{$value['id']}'";
                  }  else if ($value['profile_details_type'] == 3) {
                    $link_type = " class='wpm_6310_team_style_04 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
                  }  else {
                    $link_type = " class='wpm_6310_team_style_04' link-id='0' team-id='0'";
