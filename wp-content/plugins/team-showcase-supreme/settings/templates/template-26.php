            ...
            <div class="row wpm_6310_padding_15_px">
              ...
              <div class="wpm-col-6">
                ...
                <tr>
                  ...
                  <tr>
                    <td><b>Content Background</b>
                      <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                    </td>
                    <td>
                      <input type="text" name="content_background" id="wpm_content_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : $allStyle['10']); ?>">
                    </td>
                  </tr>
                  <tr>
                    <td><b>Content Hover Background</b>
                      <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                    </td>
                    <td>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="member_font_hover_color" id="wpm_member_font_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgb(236, 223, 189)') ?>">
                    </td>
                  </tr>
                  <tr>
                    <td><b>Font Weight</b>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 10); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
 ...
 <?php
    ...
    .wpm_6310_tabs_panel_preview .wpm-6310-row {
      ...
      ul.wpm_6310_team_style_26_social {
        ...
        margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 10)."px;
      }
      ...
      .wpm_6310_team_style_26 .wpm_6310_team_style_26_team_content {
        ...
        border-left: 5px solid ".esc_attr($allStyle[4]).";
        padding: 27px 10px;
      ...
      .wpm_6310_team_style_26:hover .wpm_6310_team_style_26_team_content {
        background: ".esc_attr($allStyle[7])." !important;
        padding-top: 10px !important;
        padding-bottom: ".esc_attr(($allStyle[27] ? $allStyle[27] : 0) + 2 * ($allStyle[28] ? $allStyle[28] : 0) + (isset($allSlider[61]) && $allSlider[61]?$allSlider[61]:0) + (isset($allSlider[62]) && $allSlider[62]?$allSlider[62]:10)).";
      }
      ...
      .wpm_6310_team_style_26:hover .wpm_6310_team_style_26_title {
        color:  ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgb(236, 223, 189)').";
      ...
      .wpm_6310_team_style_26:hover .wpm_6310_team_style_26_hover_contents {
        height:".esc_attr((($allStyle[19] ? $allStyle[19] : 0) > ($allStyle[24] ? $allStyle[24] : 0)) ? ($allStyle[19] ? $allStyle[19] : 0) + ($allSlider[51] ? $allSlider[51] : 0) + ($allSlider[52] ? $allSlider[52] : 0) : ($allStyle[24] ? $allStyle[24] : 0) + (isset($allSlider[51]) && $allSlider[51]?$allSlider[51]:0) + (isset($allSlider[52]) && $allSlider[52]?$allSlider[52]:10))."px;
      }
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          if ($members) {
            ...
            $link_type = " class='" . 'wpm_6310_team_style_26 wpm_6310_team_member_info' . "' link-id='" . esc_attr($value['id']) . "' link-url='" . wpm_6310_validate_profile_url($value['profile_url']) . "' target='" . esc_attr($value['open_new_tab']) . "' team-id='0'";
        } else if ($value['profile_details_type'] == 2) {
            $link_type = " class='" . 'wpm_6310_team_style_26 wpm_6310_team_member_info' . "' link-id='0' team-id='" . esc_attr($value['id']) . "'";
        } else if ($value['profile_details_type'] == 3) {
            $link_type = " class='wpm_6310_team_style_26 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
        } else {
              ...
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div<?php echo $link_type ?>>
                  ...
                  <div class="wpm_6310_team_style_26_team_content">
                    <div class="wpm_6310_team_style_26_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_26_hover_contents">
                      <div class="wpm_6310_team_style_26_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                      <?php
