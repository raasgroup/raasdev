  ...
  <div class="wpm-6310-sm">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="image_hover_background" id="wpm_image_hover_background" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($allStyle[7]) ?>">
                    </td>
                  </tr>
                  <tr>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 7); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                   ...
                   <tr class="social_act_field">
                    ...
                    <td>
                      <input type="number" min="0" name="social_margin_bottom" value="<?php echo esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 15); ?>" class="wpm-form-input" id="wpm_social_margin_bottom" />
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <?php
        ...
        .wpm_6310_team_style_23_title {
          ...
          margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 7)."px;
        }
        ...
        ul.wpm_6310_team_style_23_social {
          ...
          margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 15)."px;
        }
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          if ($members) {
            ...
            $link_type = " class='" . 'wpm_6310_team_style_23 wpm_6310_team_member_info' . "' link-id='" . esc_attr($value['id']) . "' link-url='" . wpm_6310_validate_profile_url($value['profile_url']) . "' target='" . esc_attr($value['open_new_tab']) . "' team-id='0'";
        } else if ($value['profile_details_type'] == 2) {
            $link_type = " class='" . 'wpm_6310_team_style_23 wpm_6310_team_member_info' . "' link-id='0' team-id='" . esc_attr($value['id']) . "'";
        } else if ($value['profile_details_type'] == 3) {
          $link_type = " class='wpm_6310_team_style_23 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
        } else {
