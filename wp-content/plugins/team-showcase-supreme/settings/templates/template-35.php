<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    $hover_bg2 = isset($allStyle[35]) ? $allStyle[35] : $hover_bg1 ;
    $hover_bg3 = isset($allStyle[36]) ? $allStyle[36] : $hover_bg1 ;

    $background_bg1 = $allStyle[32];
    $background_bg2 = isset($allStyle[37]) ? $allStyle[37] : $background_bg1 ;
    $background_bg3 = isset($allStyle[38]) ? $allStyle[38] : $background_bg1 ; 
    ?>
              ...
              <div class="row">
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table" width="100%">
                    <tr>
                      <td>
                        <b>Display Social Icons </b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                      </td>
                      <td>
      ...
      <?php
        $gradient = (isset($allStyle[31]) && $allStyle[31] >= 5) ? "linear-gradient(top, $background_bg1 0%, $background_bg2 48%, $background_bg3 99%)" : "linear-gradient(top, #fff 0%, $background_bg1 30%, $background_bg2 70%, $background_bg3 99%)";
        ...
        .wpm_6310_team_style_35:hover {
          ...
          background: -moz-".esc_attr($gradient).";
          background: -webkit-".esc_attr($gradient ).";
        ...
        .wpm_6310_team_style_35_title {
          ...
          margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:10)."px;
        ...
        .wpm_6310_team_style_35:hover .wpm_6310_team_style_35_title {
          color: ".esc_attr($allStyle[13]).";
        }
  
        .wpm_6310_team_style_35:hover .wpm_6310_team_style_35_designation {
        ...
        ul.wpm_6310_team_style_35_social {
          ...
          padding: 0;
          margin: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61]:5)."px 0 ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62]:10)."px;
          list-style: none;
          text-align: center;
          float: left;
          width: 100%;
      ...
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-35.php';
      ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          <div class="wpm-6310-col-<?php echo esc_attr($desktop_row) ?>">
            <div class="wpm_6310_team_style_35<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>          
              <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])); ?>"
            -6310-hover-image="<?php echo esc_attr($value['hover_image']); ?>"
              alt="<?php echo esc_attr($value['name']); ?>">

              <figcaption>
                <div class="wpm_6310_team_style_35_caption">
                  <div class="wpm_6310_team_style_35_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                  <div class="wpm_6310_team_style_35_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
