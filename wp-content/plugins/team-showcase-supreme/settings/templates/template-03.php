                  ...
                  <div id="tab-4">
                     <div class="row">
                        ...
                        <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                                 ...
                                 <td>
                                    <input type="number" min="0" name="social_margin_bottom" value="<?php echo esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[61] : 0); ?>" class="wpm-form-input" id="wpm_social_margin_bottom" />
                                 </td>
                              </tr>
                           </table>
                        </div>
    ...
    <?php
        ...
        .wpm_6310_tabs_panel_preview .wpm-6310-row {
            ...
            .wpm_6310_team_style_03 {
               ...
               -ms-border-radius: ".esc_attr($allStyle[2])."x;
      ...
      >
            ...
            echo "<div class='wpm-6310-row wpm-6310-default-members'{$displayCSS}>";
               ...
               ?>
                     ...
                     <div class="wpm_6310_team_style_03<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
         ...
         <div class="carousel">
            <div id="wpm-6310-slider-<?php echo esc_attr($styleId) ?>" class="wpm-6310-owl-carousel">
               ...
               ?>
                     ...
                     <div class="wpm_6310_team_style_03<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                           <img src="<?php echo ($value['image'] ? $value['image'] : esc_attr($value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" alt="<?php echo esc_attr($value['name']) ?>" >
                           <figcaption>
                              <div class="wpm_6310_team_style_03_caption">
                                 <div class="wpm_6310_team_style_03_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                                 <div class="wpm_6310_team_style_03_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
