<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    $defaultDescriptionColor = 'rgb(117, 117, 117)';
    $defaultDescriptionHoverColor = 'rgb(117, 117, 117)';
    $defaultDescriptionMarginTop = '20';
    $defaultDescriptionMarginBottom = '20';
    $defaultDescriptionLineHeight = '25';
    if (!empty($_POST['update_style_change']) && $_POST['update_style_change'] == 'Save' && $_POST['styleid'] != '') {
      ...
      if (!wp_verify_nonce($nonce, 'wpm_nonce_field_form')) {
        ...
        $css .= "|";
        $css .= "|" . sanitize_text_field($_POST['hover_bottom_border_color']);
    ...
    ?>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                   <?php 
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="real_image_radius" value="<?php echo esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0) ?>" class="wpm-form-input" id="wpm_real_image_radius" />
                      </td>
                    </tr>
                    <tr>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr>
                      ...
                      <?php                                         
                                                                    ?></td>
                      <td>
                        <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34] : $allStyle[7]) ?>;">
                      </td>
                    ...
                    <tr>
                      <td><b>Hover Bottom Border Color</b>
                        <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                      </td>
                      <td>
                        <input type="text" name="hover_bottom_border_color" id="wpm_hover_bottom_border_color" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(220, 0, 90, 0.8)') ?>">
                      </td>
                    </tr>
                  </table>
                </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_top" id="wpm_member_margin_top" type="number" min="0"
                          value="<?php echo esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:15);?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0"
                          value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52]:10);?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
              ...
              <div class="row">
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      <td>
                        <b>Display Social Icons</b> <span class="wpm-6310-pro">(Pro) 
                        <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div>
                        </span><br />
                      </td>
                      <td>
                          <label class="switch" for="wpm_social_activation">
                          <input type="checkbox" name="social_activation" id="wpm_social_activation" value="1" <?php echo esc_attr((!isset($allStyle[35]) || (isset($allStyle[35]) && $allStyle[35])) ? 'checked' : '') ?>>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                     ...
                     <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_margin_top" value="<?php echo esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 0); ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                      </td>
                    </tr>
                     <tr class="social_act_field">
     ...
     <?php
       ...
       .wpm_6310_tabs_panel_preview .wpm-6310-row {
        justify-content: ".esc_attr((isset($allSlider[126]) && $allSlider[126] !== '') ? esc_attr($allSlider[126]) : 'center')." !important;
    }

    .wpm_6310_team_style_13 {
        text-align: center;
        overflow: hidden;
        ...
        float: left;
        height: 100%;
        background-color: ".esc_attr($allStyle[7]).";
    }

    .wpm_6310_team_style_13_pic img {
        width: 100%;
        height: auto;
        float: left;
        -webkit-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? esc_attr($allStyle[33]) : 0)."%;
        -o-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? esc_attr($allStyle[33]) : 0)."%;
        -moz-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? esc_attr($allStyle[33]) : 0)."%;
        -ms-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? esc_attr($allStyle[33]) : 0)."%;
        border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? esc_attr($allStyle[33]) : 0)."%;
    }

        .wpm_6310_team_style_13_team_content {
            float: left;
            width: 100%;
            padding: 0 20px;
        }
        ...
        .wpm_6310_team_style_13_title {
          ...
          margin-top: ".esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? esc_attr($allSlider[41]) : 15)."px;
          margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? esc_attr($allSlider[42]) : 5)."px;
          float: left;
          width: 100%;
      }

      .wpm_6310_team_style_13_designation {
          display: block;
          ...
          margin-bottom: ".esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 10)."px;
          float: left;
          width: 100%;
      }

      .wpm_6310_team_style_13:hover {
          box-shadow: 0 -5px ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(220, 0, 90, 0.8)')." inset;
          background-color: ".esc_attr((isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34] : '').";
      }

      ul.wpm_6310_team_style_13_social {
          display: ".esc_attr((!isset($allStyle[35]) || (isset($allStyle[35]) && $allStyle[35])) ? 'block' : 'none').";
          list-style: none;
          padding: 5px 0 2px;
          margin: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 0)."px 0 ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 0)."px;
          float: left;
          width: 100%;
      }

      ul.wpm_6310_team_style_13_social li {
          display: inline-block;
          margin: 0 8px 8px 0;
      }

      ul.wpm_6310_team_style_13_social li:last-child {
          margin-right: 0;
      }
    ul.wpm_6310_team_style_13_social li a {
    ...
    .wpm-6310-owl-stage-outer {
        padding-top: ".esc_attr((isset($allStyle[3]) && is_numeric($allStyle[3])) ? esc_attr($allStyle[3] * 2) : 0)."px;
        padding-bottom: ".esc_attr((isset($allStyle[3]) && is_numeric($allStyle[3])) ? esc_attr($allStyle[3] * 2) : 0)."px;
    }
        ";
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-13.php';
      ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_13<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_13_pic">
                    <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="img-responsive <?php echo esc_attr($allStyle[5]) ?>" alt="<?php echo esc_attr($value['name']) ?>" >
                  </div>
                  <div class="wpm_6310_team_style_13_team_content">
                    <div class="wpm_6310_team_style_13_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_13_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
