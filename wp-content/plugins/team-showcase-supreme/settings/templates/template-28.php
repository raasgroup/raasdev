  ...
  <div class="wpm-6310-sm">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                   ...
                   <tr class="social_act_field">
                    ...
                    <td>
                      <input type="number" min="0" name="social_margin_bottom" value="<?php echo esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 20); ?>" class="wpm-form-input" id="wpm_social_margin_bottom" />
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <?php
      ...
      ul.wpm_6310_team_style_28_social {
        ...
        float: left;
        width: 100%;
        margin-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 20)."px;
        margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62] : 20)."px;
      }
      ...
      ?>
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-28.php';
    ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_28<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_28_team_content">
                    <div class="wpm_6310_team_style_28_box_content">
                      <div class="wpm_6310_team_style_28_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                      <div class="wpm_6310_team_style_28_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                      <?php
