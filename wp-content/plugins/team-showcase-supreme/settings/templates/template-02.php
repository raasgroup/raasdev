    ...
    ?>
      ...
      <div class="wpm_6310_tabs_panel_settings">
                    ...
                    <tr>
                      ...
                      <td>
                        <select name="image_hover_background_height" id="wpm_image_hover_background_height" class="wpm-form-input">
                          <option value="40" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 40) ? 'selected' : '' )?>>40</option>
                          <option value="45" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 45) ? 'selected' : '' )?>>45</option>
                          <option value="50" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 50) ? 'selected' : '' )?>>50</option>
                          <option value="55" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 55) ? 'selected' : '' )?>>55</option>
                          <option value="60" <?php echo esc_attr((!isset($allStyle[31]) || (isset($allStyle[31]) && $allStyle[31] == 60)) ? 'selected' : '' )?>>60</option>
                          <option value="65" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 65) ? 'selected' : '' )?>>65</option>
                          <option value="70" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 70) ? 'selected' : '') ?>>70</option>
                          <option value="75" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 75) ? 'selected' : '') ?>>75</option>
                          <option value="80" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 80) ? 'selected' : '' )?>>80</option>
                          <option value="85" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 85) ? 'selected' : '' )?>>85</option>
                          <option value="90" <?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] == 90) ? 'selected' : '' )?>>90</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
       ...
       <?php
        ...
        .wpm_6310_team_style_02_pic img {
          float: left;
        }

        .wpm_6310_team_style_02:hover {
        ...
        .wpm_6310_team_style_02:hover .wpm_6310_team_style_02_pic:after {
          opacity: 0.85;
          height: ".esc_attr(isset($allStyle[31]) ? $allStyle[31] : 60)."%;
          top: ".esc_attr(isset($allStyle[31]) ? (100 - $allStyle[31]) : 40)."%;
        }
        ...
        .wpm_6310_team_style_02_team_content {
          ...
          top:".esc_attr(isset($allStyle[31]) ? (100 - $allStyle[31]) : '50')."%;
          display: flex;
          flex-direction: column;
          justify-content: center;
          height: ".esc_attr(isset($allStyle[31]) ? $allStyle[31] : '45')."%;
        }
        ...
        .wpm_6310_team_style_02_title:hover {
          color: ".esc_attr($allStyle[13])." ?>
        }

        .wpm_6310_team_style_02_designation:hover {
        ...
        ul.wpm_6310_team_style_02_social {
          ...
          width: 100%;
          margin: 0;
          margin-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61]:15)."px;
          margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? $allSlider[62]:0).";
          padding: 0;
          list-style: none;
        }
        ...
        ul.wpm_6310_team_style_02_social li a {
          display: inline-block;
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-02.php';
      ?>
        ...
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div class="wpm_6310_team_style_02<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_02_team_content">
                    <div class="wpm_6310_team_style_02_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_02_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
      ...
      <div class="carousel">
        ...
        $readMoreActive = esc_attr(isset($allSlider[311]) && $allSlider[311] > 0 ? 1 : 0);
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_02<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_02_pic">
                    <img src="<?php echo ($value['image'] ? $value['image'] : $value['hover_image']) ?>" data-6310-hover-image="<?php echo $value['hover_image'] ?>" alt="<?php echo esc_attr($value['name']) ?>" >
                  </div>
                  <div class="wpm_6310_team_style_02_team_content">
                    <div class="wpm_6310_team_style_02_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_02_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
