                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:3) ?>" class="wpm-form-input" />
                                            </td>
                                            </tr>
                                    </table>
                                </div>
    ...
    <?php
        ...
        .wpm_6310_tabs_panel_preview .wpm-6310-row {
            ...
            .wpm_6310_team_style_24_team_content {
                ...
                text-align: left;
                z-index: 1;
                border-bottom: 3px solid ".esc_attr($allStyle[4]).";
            }
            ...
            .wpm_6310_team_style_24_title {
                ...
                margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:3)."px;
            }
      ...
      ?>
            ...
            <?php
            include wpm_6310_plugin_url . 'settings/helper/template-24.php';
            ?>
            ...
            echo "<div class='wpm-6310-row wpm-6310-default-members'{$displayCSS}>";
                    ...
                    ?>
                            <div class="wpm-6310-col-<?php echo esc_attr($desktop_row) ?>">
                                <div class="wpm_6310_team_style_24<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                                    ...
                                    <div class="wpm_6310_team_style_24_team_content">
                                        <div class="wpm_6310_team_style_24_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                                        <div class="wpm_6310_team_style_24_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                                        <?php echo esc_attr(wpm_6310_read_more($readMoreActive, $template_id, $allSlider, $cls, $attr2, 0)) ?>
                                    </div>
                            </div>
                </div>
        <?php
                ...
                <div id="wpm-6310-slider-<?php echo esc_attr($styleId) ?>" class="wpm-6310-owl-carousel">
                    ...
                    ?>
                            <div class="wpm-6310-item">
                                <div class="wpm_6310_team_style_24<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                                    <img src="<?php echo ($value['image'] ? $value['image'] : $value['hover_image']) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="img-responsive <?php echo esc_attr($allStyle[1]) ?>" alt="<?php echo esc_attr($value['name']) ?>" >
                                    <?php
                                    wpm_6310_social_icon($value['iconids'], $value['iconurl'], $allStyle[28], $value['id'], $template_id, '', '', isset($allSlider['63']) ? $allSlider['63'] : 4);                                   
                                    ?>
                                    <div class="wpm_6310_team_style_24_team_content">
