  ...
  <div class="wpm-6310-sm">
                ...
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <?php
                                                                ?></td>
                    <td>
                      <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 'rgba(255, 255, 255, 1)') ?>">
                    </td>
                  </tr>
                  <tr>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 20); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <?php
        ...
        .wpm_6310_team_style_20 {
          ...
          border-bottom: ".esc_attr($allStyle[3])."px solid ".esc_attr($allStyle[4]).";
          border-top: none;
          border-right: none;
          height: 100%;
          background-color: ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'transparent').";
        }
  
        .wpm_6310_team_style_20:hover {
          background-color: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '#FFF').";
        }
  
        .wpm_6310_team_style_20_pic {
          position: relative;
          text-align: center;
          float: left;
          width: 100%;
        ...
        .wpm_6310_team_style_20_img_overlay {
          width: 100%;
          height: 100%;
          top: 0;
          left: 0;
        ...
        .wpm_6310_team_style_20:hover .wpm_6310_team_style_20_img_overlay {
          opacity: 1;
          -webkit-border-radius: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0)."%;
          -o-border-radius: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0)."%;
          -moz-border-radius: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0)."%;
        ...
        ul.wpm_6310_team_style_20_social {
        ...
        .wpm_6310_team_style_20:hover ul.wpm_6310_team_style_20_social {
          transform: translate(0px, 0px) rotateY(0deg);
        }
  
        ul.wpm_6310_team_style_20_social li {
          display: block;
          margin: 10px 0px 0;
        }
  
        ul.wpm_6310_team_style_20_social li:last-child {
          margin-bottom: 10px;
        }
  
        ul.wpm_6310_team_style_20_social li a {
          display: block;
          width: ".esc_attr($allStyle[26] )."px;
          height: ".esc_attr($allStyle[27])."px;
          line-height: ".$allStyle[27]."px;
        ...
        .wpm_6310_team_style_20_team_content {
          float: left;
          width: calc(100% - 40px);
          margin: 0 20px;
          height: 100%;
        ...
        .wpm_6310_team_style_20_designation {
          display: block;
          ...
          margin-bottom: ".esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 20)."px;
        }
    ...
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-20.php';
    ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_20<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_20_pic">
                    ...
                    <?php
                    wpm_6310_social_icon($value['iconids'], $value['iconurl'], $allStyle[28], $value['id'], $template_id, '', '', isset($allSlider['63']) ? $allSlider['63'] : 4, 20);
                    ?>
                  </div>

                  <div class="wpm_6310_team_style_20_team_content">
                    <div class="wpm_6310_team_style_20_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_20_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
