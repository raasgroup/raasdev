<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    $defaultDescriptionColor = 'rgb(255, 255, 255)';
    $defaultDescriptionHoverColor = 'rgb(255, 255, 255)';
    $defaultDescriptionLineHeight = '22';
    ...
    <div class="wpm_6310_tabs_panel_settings">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 0); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 10); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
     ...
     <?php
      ...
      .wpm_6310_team_style_15 img {
          width: 100%;
          height: auto;
          float: left;
      }

      .wpm_6310_team_style_15_team_content {
          height: 100%;
          position: absolute;
          top: 0;
          left: -100%;
          ...
          align-items: center;
            ...
            .wpm_6310_team_style_15_team_content_cell {
          display: table-cell;
      ...
      .wpm_6310_team_style_15:hover .wpm_6310_team_style_15_team_content {
          left: 0;
      }

      .wpm_6310_team_style_15_team_content .wpm_6310_team_style_15_title {
      ...
      .wpm_6310_team_style_15_team_content .wpm_6310_team_style_15_designation {
          ...
          margin-bottom: ".esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? esc_attr($allSlider[52]) : 10)."px;
      }

      .wpm_6310_team_style_15_social {
          display: ".esc_attr((!isset($allStyle[31]) || (isset($allStyle[31]) && $allStyle[31])) ? 'block' : 'none').";
          list-style: none;
          padding: 0;
          float: left;
          width: 100%;
          margin-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? esc_attr($allSlider[61]) : 0)."px;
          margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? esc_attr($allSlider[62]) : 0)."px;
      }

            .wpm_6310_team_style_15_social li {
          display: inline-block;
          margin: 0 5px 5px 0;
      }

      .wpm_6310_team_style_15_social li:last-child {
          margin-right: 0;
      }

      .wpm_6310_team_style_15_social li a {
          display: inline-block;
      ...
      .wpm_6310_team_style_15_team_display {
          width: 100%;
          position: absolute;
          bottom: 0;
          text-align: right;
      ...
      .wpm_6310_team_style_15:hover .wpm_6310_team_style_15_team_display {
          transform: translateX(100%);
      }

      .wpm_6310_team_style_15_team_display .wpm_6310_team_style_15_title {
          font-size: ".esc_attr($allStyle[11])."px;
          color: ".esc_attr($allStyle[12]).";
          font-weight: ".esc_attr($allStyle[15]).";
          text-transform: ".esc_attr($allStyle[16]).";
      ...
      .wpm_6310_team_style_15_team_display .wpm_6310_team_style_15_designation {
          font-size: ".esc_attr($allStyle[19])."px;
          color: ".esc_attr($allStyle[20]).";
          font-weight: ".esc_attr($allStyle[21]).";
          text-transform: ".esc_attr($allStyle[22]).";
      ...
      ?>
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-15.php';
    ?>
      ...
      $readMoreActive = esc_attr(isset($allSlider[311]) && $allSlider[311] > 0 ? 1 : 0);
          ...
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div class="wpm_6310_team_style_15<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_15_pic">
                    <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="img-responsive <?php echo $allStyle[1] ?>" alt="<?php echo esc_attr($value['name']) ?>" >
                  </div>
                  <div class="wpm_6310_team_style_15_team_content">
                    <div class="wpm_6310_team_style_15_team_content_cell">
                      <div class="wpm_6310_team_style_15_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                      <div class="wpm_6310_team_style_15_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                      <?php
