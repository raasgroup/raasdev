   ...
   <div class="wpm-6310-sm">
      ...
      if (!empty($_POST['update_style_change']) && $_POST['update_style_change'] == 'Save' && $_POST['styleid'] != '') {
         ...
         if (!wp_verify_nonce($nonce, 'wpm_nonce_field_form')) {
            ...
            $css .= "|" . sanitize_text_field($_POST['member_stoke_1_color']);
            $css .= "|" . sanitize_text_field($_POST['member_stoke_2_color']);  
            // 31 - 35

            $css .= "|" . sanitize_text_field($_POST['member_stoke_1_hover_color']);
            $css .= "|" . sanitize_text_field($_POST['member_stoke_2_hover_color']);
            // 36 - 40
                           ...
                           <table class="table table-responsive wpm_6310_admin_table">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    value="<?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 'rgba(255, 255, 255, 1)') ?>">
                                 </td>
                              </tr>
                              <tr>
                                 <td><b>Box Hover Background</b><?php                                  
                                                                              ?></td>
                                 <td>
                  ...
                  <div id="tab-2">
                     <div class="row">
                        <div class="wpm-col-6">
                           <table class="table table-responsive wpm_6310_admin_table">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <input type="text" name="member_font_hover_color" id="wpm_member_font_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[12]) ?>">
                                 </td>
                              </tr>
                              <tr>
                        ...
                        <div class="wpm-col-6">
                           <table class="table table-responsive wpm_6310_admin_table">
                              <tr>
                                 <td><b>Stoke 1 Color</b>
                                 <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                                 </td>
                                 
                                 <td>
                                    <input type="text" name="member_stoke_1_color" id="member_stoke_1_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[34]) && $allStyle[34] != '') ? $allStyle[34] : 'rgb(55, 207, 215)') ?>">
                                 </td>
                              </tr>  
                              <tr>
                                 <td><b>Stoke 2 Color</b>
                                    <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                                 </td>                                 
                                 <td>
                                    <input type="text" name="member_stoke_2_color" id="member_stoke_2_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[35]) && $allStyle[35] !== '') ? $allStyle[35] : 'rgb(244, 54, 98)') ?>">
                                 </td>
                              </tr>
                              <tr>
                                 <td><b>Stoke 1 Hover Color</b>
                                    <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                                 </td>                                 
                                 <td>
                                    <input type="text" name="member_stoke_1_hover_color" id="member_stoke_1_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[36]) && $allStyle[36] !== '') ? $allStyle[36] : 'rgb(244, 54, 98)') ?>">
                                 </td>
                              </tr>
                              <tr>
                                 <td><b>Stoke 2 Hover Color</b>
                                    <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                                 </td>                                 
                                 <td>
                                    <input type="text" name="member_stoke_2_hover_color" id="member_stoke_2_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[37]) && $allStyle[37] !== '') ? $allStyle[37] : 'rgb(55, 207, 215)') ?>">
                                 </td>
                              </tr>
                              <tr>
                                 <td><b>Margin Top</b>
                                 ...
                                 <td>
                                    <input name="member_margin_top" id="wpm_member_margin_top" type="number" value="<?php echo esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41] : 38);?>" class="wpm-form-input" />
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td>
                                    <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 18);?>" class="wpm-form-input" />
                                 </td>
                              </tr>
                           </table>
                        </div>
        ...
        <?php
          ...
          .wpm_6310_tabs_panel_preview .wpm-6310-row {
            ...
            .wpm_6310_team_style_08 {
               ...
               height: 100%;
               background-color: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 'rgba(255, 255, 255, 1)').";
            }
            ...
            .wpm_6310_team_style_08_title {
               float: left;
               width: 100%;
               margin-top: ".esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:38)."px;
               margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:18)."px;
               position: relative;
               ...
               line-height: ".esc_attr($allStyle[18])."x;
            }
            ...
            .wpm_6310_team_style_08_border {
               ...
               float: left;
               width: 100px;
               border-bottom: 3px solid ".esc_attr((isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34]:'rgb(55, 207, 215)').";
               display: block;
               margin: 0;
               transition: all 0.3s ease 0s;
            ...
            .wpm_6310_team_style_08_border:after {
               ...
               position: relative;
               top: 3px;
               border-bottom: 3px solid ".esc_attr((isset($allStyle[35]) && $allStyle[35] !== '') ? $allStyle[35]:'rgb(244, 54, 98)').";
               margin: auto;
            }
            ...
            .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_title {
               color: ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : $allStyle[12]).";
            }
            ...
            .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_border {
               border-color: ".esc_attr((isset($allStyle[36]) && $allStyle[36] !== '') ? $allStyle[36]:'rgb(244, 54, 98)').";
            }

            .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_border:after {
               border-color: ".esc_attr((isset($allStyle[37]) && $allStyle[37] !== '') ? $allStyle[37]:'rgb(255, 255, 255)').";
            }
      ...
      >
            ...
            echo "<div class='wpm-6310-row wpm-6310-default-members'{$displayCSS}>";
               ...
               ?>
                     ...
                     <div class="wpm_6310_team_style_08<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                           ...
                           <div class="wpm_6310_team_style_08_team_content">
                              <h3 class="wpm_6310_team_style_08_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></h3>
                              <div class="wpm_6310_team_style_08_border"></div>
                              <span class="wpm_6310_team_style_08_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></span>
                              <?php
