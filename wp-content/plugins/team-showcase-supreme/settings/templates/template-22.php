<div class="wpm-6310">
  <div class="wpm-6310-sm">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 15); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <?php
        ...
        ul.wpm_6310_team_style_22_social ul {
          padding: 0;
          margin: 0;
          width: 100%;
          top: 45%;
        ...
        .wpm_6310_team_style_22_title {
          ...
          margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 15)."px;
        }
    ...
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-22.php';
    ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_22<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  ...
                  <div class="wpm_6310_team_style_22_team_content">
                    <div class="wpm_6310_team_style_22_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_22_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
