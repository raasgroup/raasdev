              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="box_background" id="wpm_box_background" class="wpm-form-input wpm_6310_color_picker"  data-format="rgb" value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(255, 255, 255, 1)') ?>">
                    </td>
                  </tr>
                  <tr>
                    ...
                    <?php
                                                                ?></td>
                    <td>
                      <input type="text" name="box_hover_background" id="wpm_box_hover_background" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 'rgba(255, 255, 255, 1)') ?>">
                    </td>
                  </tr>
                  <tr>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 20); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 23); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
  ...
  <?php
    ...
    .wpm_6310_tabs_panel_preview .wpm-6310-row {
      ...
      .wpm_6310_team_style_19 {
        ...
        position: relative;
        height: 100%;
        background-color: ".esc_attr(isset($allStyle[32]) && $allStyle[32] !== '' ? $allStyle[32] : '#FFF').";
      }

      .wpm_6310_team_style_19:hover {
        background-color: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '#FFF').";
      }

      .wpm_6310_team_style_19_pic {
        position: relative;
        overflow: hidden;
        width: 100%;
        float: left;
      ...
      .wpm_6310_team_style_19_pic:after {
        content: '';
        width: 100%;
        height: 100%;
      ...
      .wpm_6310_team_style_19:hover .wpm_6310_team_style_19_pic:after {
        bottom: 0;
      }

      .wpm_6310_team_style_19 img {
        width: 100%;
        float:left;
        height: auto;
        -webkit-border-radius: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0)."%;
      ...
      .wpm_6310_team_style_19:hover ul.wpm_6310_team_style_19_social {
        top: 0;
      }
      ...
      .wpm_6310_team_style_19_team_content {
        float: left;
        width: calc(100% - 20px);
        margin: 0 10px;
      }

      .wpm_6310_team_style_19_title {
        ...
        margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 20)."px;
      }
      .wpm_6310_team_style_19_title:before {
        content: '';
        width: 50px;
        height: 1px;
      ...
      .wpm_6310_team_style_19_title:after {
        content: '';
        display: block;
        width: 7px;
        height: 7px;
        ...
        bottom: 0px;
        background: ".esc_attr($allStyle[4]).";
        outline: 4px solid ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : '#FFF').";
      }
      
      .wpm_6310_team_style_19:hover .wpm_6310_team_style_19_title:after
    {
      background: ".esc_attr($allStyle[4]).";
      outline: 4px solid ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '#FFF').";
      }

      .wpm_6310_team_style_19:hover .wpm_6310_team_style_19_title:before
    {
        width: 100px;
        background: ".esc_attr($allStyle[4]).";
      } 

      .wpm_6310_team_style_19_designation {
        ...
        height: ".esc_attr($allStyle[24])."px;
        float: left;
        width: 100%;
        margin-top: ".esc_attr((isset($allSlider[51]) && $allSlider[51] !== '') ? $allSlider[51] : 0)."px;
        margin-bottom: ".esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 23)."px;
      }   
    ...
    <?php
    include wpm_6310_plugin_url . 'settings/helper/template-19.php';
    ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_19<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_19_pic">
                    ...
                    <?php
                    wpm_6310_social_icon($value['iconids'], $value['iconurl'], $allStyle[28], $value['id'], $template_id, '', '', isset($allSlider['63']) ? $allSlider['63'] : 4, 19);
                    ?>
                  </div>
                  <div class="wpm_6310_team_style_19_team_content">
                    <div class="wpm_6310_team_style_19_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_19_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    <?php
