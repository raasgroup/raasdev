   ...
   <div class="wpm-6310-sm">
    ...
    $mobile_row = isset($rows[2]) ? $rows[2] : 1;
      ...
      .wpm_6310_team_style_10 {
         ...
         position: relative;
         height: 100%;
         background-color: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : '#FFF').";
      }

      .wpm_6310_team_style_10:hover {
      ...
      .wpm_6310_team_style_10_social_team {
         position: absolute;
         bottom: -100px;
      ...
      ul.wpm_6310_team_style_10_social {
         ...
         width: 100%;
         margin: 0;
         margin-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61]:10)."px;
      ...
      .wpm_6310_team_style_10_team_content {
         float: left;
         width: calc(100% - 20px);
         margin: 0px 10px 0;
      }
      ...
      ?>
         ...
         <?php
         include wpm_6310_plugin_url . 'settings/helper/template-10.php';
         ?>
      ...
      >
            ...
            $readMoreActive = esc_attr(isset($allSlider[311]) && $allSlider[311] > 0 ? 1 : 0);
               ...
               ?>
                     ...
                     <div class="wpm_6310_team_style_10<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                           ...
                           <div class="wpm_6310_team_style_10_team_content">                            
                              ...
                              <div class="wpm_6310_team_style_10_title"><?php echo esc_attr(wpm_6310_replace($value['name'])) ?></div>

                              <div class="wpm_6310_team_style_10_designation"><?php echo wpm_6310_replace($value['designation']) ?></div>
                              <?php
                ...
                echo "<div class='wpm-6310-row wpm-6310-category-filter ".esc_attr($filterKey)."'{$displayCSS}>";
                  ...
                  ?>
                        ...
                        <div class="wpm_6310_team_style_10<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                              ...
                              <div class="wpm_6310_team_style_10_team_content">
                                 <div class="wpm_6310_team_style_10_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>

                                 <div class="wpm_6310_team_style_10_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
