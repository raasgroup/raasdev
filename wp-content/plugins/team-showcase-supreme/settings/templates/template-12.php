<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    $defaultDescriptionLineHeight = '20';
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_top" id="wpm_member_margin_top" type="number" min="0"
                          value="<?php echo esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41]:20);?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0"
                          value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:0);?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                     ...
                     <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_margin_top" value="<?php echo esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 8); ?>" class="wpm-form-input" id="wpm_social_margin_top" />
                      </td>
                    </tr>
                     <tr class="social_act_field">
   ...
   <?php
      ...
      .wpm_6310_team_style_12_team_content {
      ...
      .wpm_6310_team_style_12:hover .wpm_6310_team_style_12_team_content {
          bottom: 0%;
      }

      .wpm_6310_team_style_12_team_content:before {
          content: '';
          border-bottom: 30px ".esc_attr($allStyle[7])." solid;
          border-right: 255px transparent solid;
          position: absolute;
          top: -30px;
          left: 0px;
      }
      ...
      .wpm_6310_team_style_12_title {
          ...
          width: 100%;
          float: left;
          margin-top: ".esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? esc_attr($allSlider[41]) : 20)."px;
    ...
    .wpm_6310_team_style_12_title:after {
        content: '';
        display: block;
        width: 10%;
        border-bottom: 4px ".esc_attr($allStyle[12])." solid;
        padding-bottom: 5px;
    }

    /* .wpm_6310_team_style_12_description:after {
        content: '';
        display: block;
        border-bottom: 1px solid ".esc_attr($allStyle[12]).";
        margin-top: 10px;
    } */
    ...
    ul.wpm_6310_team_style_12_social {
        ...
        float: left;
        width: 100%;
        margin-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? esc_attr($allSlider[61]) : 8)."px;
        margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? esc_attr($allSlider[62]) : '')."px;
    }

    ul.wpm_6310_team_style_12_social li {
    ...
    ul.wpm_6310_team_style_12_social li:last-child {
        margin-right: 0;
    }
    ...
    ul.wpm_6310_team_style_12_social li a {
        ...
        font-size: ".esc_attr(ceil((esc_attr($allStyle[26] ? $allStyle[26] : 0) + esc_attr($allStyle[27] ? $allStyle[27] : 0)) / 4))."px;
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-12.php';
      ?>
          ...
          if ($members) {
            ...
            foreach ($members as $value) {
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_12 wpm_6310_team_member_info' link-id='" . esc_attr($value['id']) . "' link-url='".wpm_6310_validate_profile_url($value['profile_url'])."' target='" . esc_attr($value['open_new_tab']) . "' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_12 wpm_6310_team_member_info' link-id='0' team-id='" . esc_attr($value['id']) . "'";
              } else if ($value['profile_details_type'] == 3) {
                $link_type = " class='wpm_6310_team_style_12 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
              } else {
                $link_type = " class='wpm_6310_team_style_12' link-id='0' team-id='0'";
              }
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div<?php echo $link_type ?>>
                  <div class="wpm_6310_team_style_12_pic">
                    <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="img-responsive" alt="<?php echo esc_attr($value['name']) ?>" >
                  </div>

                  <div class="wpm_6310_team_style_12_team_content">
                    <div class="wpm_6310_team_style_12_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_12_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    ...
                    echo "<div class='wpm_6310_team_style_{$styleId}_border'></div>";
          ...
          foreach($filterList as $filterKey => $filterValue){
            ...
            if ($catMembers) {
              ...
              foreach ($catMembers as $value) {
                if ($value['profile_details_type'] == 1) {
                  $link_type = " class='wpm_6310_team_style_12 wpm_6310_team_member_info' link-id='{$value['id']}' link-url='".wpm_6310_validate_profile_url($value['profile_url'])."' target='{$value['open_new_tab']}' team-id='0'";
                } else if ($value['profile_details_type'] == 2) {
                  $link_type = " class='wpm_6310_team_style_12 wpm_6310_team_member_info' link-id='0' team-id='{$value['id']}'";
                } else if ($value['profile_details_type'] == 3) {
                  $link_type = " class='wpm_6310_team_style_12 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
                } else {
                  $link_type = " class='wpm_6310_team_style_12' link-id='0' team-id='0'";
