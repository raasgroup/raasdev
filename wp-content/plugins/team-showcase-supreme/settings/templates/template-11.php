<div class="wpm-6310">
  <div class="wpm-6310-sm">
    ...
    ?>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                   <?php 
                    ...
                    <tr>
                      <td><b>Effect Appearance</b>
                      <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                      </td>
                      <td>
                        <?php
                        $effectsList = array(
                          "wpm_6310_team_style_hover_animation_top" => "Top to Bottom",
                          "wpm_6310_team_style_hover_animation_bottom" => "Bottom to Top",
                          "wpm_6310_team_style_hover_animation_left" => "Left to Right",
                          "wpm_6310_team_style_hover_animation_right" => "Right to Left"
                        );
                        ?>
                        <select name="effect_appearance" id="wpm_effect_appearance" class="wpm-form-input">
                          <?php
                          foreach ($effectsList as $k => $v) {
                            if ($k == $allStyle[1]) {
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0"
                          value="<?php echo esc_attr(isset($allSlider[42]) ? $allSlider[42]:0);?>" class="wpm-form-input" />
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_margin_bottom" value="<?php echo esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? $allSlider[61] : 0); ?>" class="wpm-form-input" id="wpm_social_margin_bottom" />
                      </td>
                    </tr>
                  </table>
                </div>
      ...
      .wpm_6310_team_style_hover_animation_top,
      .wpm_6310_team_style_hover_animation_bottom,
      .wpm_6310_team_style_hover_animation_left,
      .wpm_6310_team_style_hover_animation_right {
          position: absolute;
          width: 100%;
          height: 100%;
          padding: 10px;
      ...
      .wpm_6310_team_style_11:hover .wpm_6310_team_style_11_title {
          -webkit-transform: translateY(100%);
          -ms-transform: translateY(100%);
          transform: translateY(100%);
      }

      .wpm_6310_team_style_11:hover .wpm_6310_team_style_hover_animation_top {
          top: 100%;
      }

      .wpm_6310_team_style_11:hover .wpm_6310_team_style_hover_animation_bottom {
          bottom: 100%;
      }

      .wpm_6310_team_style_11:hover .wpm_6310_team_style_hover_animation_left {
          left: 100%;
      }

      .wpm_6310_team_style_11:hover .wpm_6310_team_style_hover_animation_right {
          right: 100%;
      }

      .wpm_6310_team_style_11_table {
          display: table;
          width: 100%;
          height: 100%;
      }

        .wpm_6310_team_style_11_table_cell {
          display: table-cell;
          width: 100%;
          vertical-align: middle;
      }

      .wpm_6310_team_style_11_title_hover,
      .wpm_6310_team_style_11_designation_hover,
      .wpm_6310_team_style_11_social,
      .wpm_6310_team_style_11_read_more {
          text-align: center;
          display: block;
      }
      ...
      .wpm_6310_team_style_11_title_hover {
          ...
          font-weight: ".esc_attr($allStyle[15]).";
          text-transform: ".esc_attr($allStyle[16]).";
          font-family: ".esc_attr(str_replace("+", " ", esc_attr($allStyle[17]))).";
          line-height: ".esc_attr($allStyle[18])."px;
          margin-top: ".esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? esc_attr($allSlider[41]) : 0)."px;
          margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? esc_attr($allSlider[42]) : 0)."px;
      }
      ...
      .wpm_6310_team_style_11_designation_hover {
          ...
          font-family: ".esc_attr(str_replace("+", " ", esc_attr($allStyle[23]))).";
          line-height: ".esc_attr($allStyle[24])."px;
          margin-top: ".esc_attr((isset($allSlider[51]) && $allSlider[51] !== '') ? esc_attr($allSlider[51]) : 0)."px;
          margin-bottom: ".esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? esc_attr($allSlider[52]) : 0)."px;
      }
      ...
      .wpm_6310_team_style_11_read_more a {
          ...
          padding: 10px 20px;
          font-weight: 600;
          font-size: ".esc_attr(($allStyle[11] ? $allStyle[11] : 20) - 7)."px;
      }

      .wpm_6310_team_style_11_read_more a:hover {
      ...
      ul.wpm_6310_team_style_11_social {
          ...
          list-style: none;
          text-align: center;
          margin-top: ".esc_attr((isset($allSlider[61]) && $allSlider[61] !== '') ? esc_attr($allSlider[61]) : 20)."px;
          margin-bottom: ".esc_attr((isset($allSlider[62]) && $allSlider[62] !== '') ? esc_attr($allSlider[62]) : 0)."px;
      }

      ul.wpm_6310_team_style_11_social li {
          display: inline-block;
          margin: 0 8px 8px 0;
      }

      ul.wpm_6310_team_style_11_social li:last-child {
          margin-right: 0;
      }
      ...
      ul.wpm_6310_team_style_11_social li a:hover {
          background: #fff;
          color: #d4434d
      }
      ...
      ?>
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-11.php';
      ?>
          ...
          if ($members) {
            ...
            foreach ($members as $value) {
              if ($value['profile_details_type'] == 1) {
                $link_type = " class='wpm_6310_team_style_11' team-id='0'";
              } else if ($value['profile_details_type'] == 2) {
                $link_type = " class='wpm_6310_team_style_11 wpm_6310_team_member_info' link-id='0' team-id='" . esc_attr($value['id']) . "'";
              } else if ($value['profile_details_type'] == 3) {
                $link_type = " class='wpm_6310_team_style_11 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
              } else {
                $link_type = " class='wpm_6310_team_style_11' link-id='0' team-id='0'";
              }
          ?>
              <div class="wpm-6310-col-<?php echo esc_attr($desktop_row); ?>">
                <div<?php echo $link_type; ?>>
                  <div class="">
                    <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="wpm-image-responsive" alt="Team Showcase" >
                    <?php
                    if (trim($value['name'])) {
                      echo "<div class='wpm_6310_team_style_11_title'>".wpm_6310_replace(esc_attr($value['name']))."</div>";
                    }
                    ?>
                  </div>
                  <div class="effect-appearance-class <?php echo esc_attr($allStyle[1]) ?>">
                    <div class="wpm_6310_team_style_11_table">
                      <div class="wpm_6310_team_style_11_table_cell">
                        <?php
                        if (trim($value['name'])) {
                          echo "<div class='wpm_6310_team_style_11_title_hover'>".wpm_6310_replace(esc_attr($value['name']))."</div>";
                        }
                        if (trim($value['designation'])) {
                          echo "<div class='wpm_6310_team_style_11_designation_hover'>".wpm_6310_replace(esc_attr($value['designation']))."</div>";
                        }
                        ...
                        if ($value['profile_details_type'] == 1) {
                          ...
                          echo "<div class='wpm_6310_team_style_11_read_more'>
                            <a href='".wpm_6310_validate_profile_url($value['profile_url'])."'  target='{$target}'>VIEW MORE</a>
                            </div>";
                        }
                        ?>
              ...
              if ($catMembers) {
                ...
                foreach ($catMembers as $value) {
                  if ($value['profile_details_type'] == 1) {
                    ...
                    $link_type = " class='wpm_6310_team_style_11 wpm_6310_team_member_info' link-id='0' team-id='{$value['id']}'";
                  } else if ($value['profile_details_type'] == 3) {
                    $link_type = " class='wpm_6310_team_style_11 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
                  } else {
                    $link_type = " class='wpm_6310_team_style_11' link-id='0' team-id='0'";
