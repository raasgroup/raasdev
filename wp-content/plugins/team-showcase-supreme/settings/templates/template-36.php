    ...
    ?>
      ...
      <?php
        ...
        .wpm_6310_team_style_36 {
          ...
          box-shadow: 0 1px ".esc_attr($allStyle[9])."px ".esc_attr($allStyle[9])."px ".esc_attr($allStyle[10]).";
          height: 100%;   
          position: relative;  
        ...
        .wpm_6310_team_style_36:hover .wpm_6310_team_style_36_title {
          color: ".esc_attr($allStyle[13]).";
        }
  
        .wpm_6310_team_style_36:hover .wpm_6310_team_style_36_designation {
      ...
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-36.php';
      ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          <div class="wpm-6310-col-<?php echo esc_attr($desktop_row) ?>">
            <div class="wpm_6310_team_style_36<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
              ...
              <figcaption>
                <div class="wpm_6310_team_style_36_caption">
                  <div class="wpm_6310_team_style_36_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                  <div class="wpm_6310_team_style_36_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
