  ...
  <div class="wpm-6310-sm">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  <tr>
                    ...
                    <td>
                      <input type="text" name="img_overlay_color" id="wpm_img_overlay_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($allStyle[33]) ?>">
                    </td>
                  </tr>
                  <tr>
                    <td><b>'View More' Color</b></td>
                    <td>
                      <input type="text" name="view_more_color" id="wpm_view_more_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($allStyle[34]) ?>">
                    </td>
                  </tr>
                  <tr>
                    <td><b>'View More' Font Size</b></td>
                    <td>
                      <input type="number" name="view_more_font_size" id="wpm_view_more_font_size" class="wpm-form-input" value="<?php echo esc_attr($allStyle[35]) ?>">
                    </td>
                  </tr>
                  <tr>
                    <td><b>'View More' Font Family</b></td>
                    <td>
                      <input name="view_more_font_family" id="wpm_jquery_vm_font" type="text" value="<?php echo esc_attr((isset($allStyle[36]) && $allStyle[36]) ? $allStyle[36] : 'Open Sans') ?>" />
                    </td>
                  </tr>
                  <tr>
                    <td><b>Box Background</b></td>
                    <td>
                      <input type="text" name="box_background" id="wpm_box_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(255, 255, 255, 1)') ?>">
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <label class="switch" for="wpm_social_activation">
                        <input type="checkbox" name="social_activation" id="wpm_social_activation" value="1" <?php echo esc_attr((isset($allStyle[37]) && $allStyle[37]) ? 'checked' : '') ?>>
    ...
    <?php
        ...
        .wpm_6310_team_style_31 {
          ...
          box-shadow: 0 0px ".esc_attr($allStyle[9])."px ".esc_attr($allStyle[8])."px ".esc_attr($allStyle[10]).";
          height: 100%;
        ...
        .wpm_6310_team_style_31_pic_overlay {
          ...
          width: 100%;
          height: 100%;
          background: ".esc_attr($allStyle[33]).";
          border-radius: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : 0)."%;
          opacity: 0;
          transition: all 0.3s;
        ...
        .wpm_6310_team_style_31_pic_overlay_button {
          ...
          color: ".esc_attr($allStyle[34]).";
          font-size: ".esc_attr($allStyle[35])."px;
          font-family: ".esc_attr($allStyle[36]).";
          font-weight: 700;
        ...
        ul.wpm_6310_team_style_31_social {
          display: ".esc_attr((isset($allStyle[37]) && $allStyle[37]) ? 'block' : 'none').";
          padding: 0;
        ...
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          if ($members) {
           ...
           if ($value['profile_details_type'] == 1) {
            $link_type = " class='" . 'wpm_6310_team_style_31 wpm_6310_team_member_info' . "' link-id='" . esc_attr($value['id']) . "' link-url='" . wpm_6310_validate_profile_url($value['profile_url']) . "' target='" . esc_attr($value['open_new_tab']) . "' team-id='0'";
        } else if ($value['profile_details_type'] == 2) {
            $link_type = " class='" . 'wpm_6310_team_style_31 wpm_6310_team_member_info' . "' link-id='0' team-id='" . esc_attr($value['id']) . "'";
        } else if ($value['profile_details_type'] == 3) {
            $link_type = " class='wpm_6310_team_style_31 wpm_6310_team_member_internal_link' data-wpm-link-url='".get_permalink(esc_attr($value['post_id']))."'";
        } else {
