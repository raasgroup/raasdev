  ...
  <div class="wpm-6310-sm">
    ...
    if (!empty($_POST['update_style_change']) && $_POST['update_style_change'] == 'Save' && $_POST['styleid'] != '') {
      ...
      if (!wp_verify_nonce($nonce, 'wpm_nonce_field_form')) {
        ...
        $css .= "|" . sanitize_text_field($_POST['box_radius']);
        //31 - 35
    ...
    <div class="wpm_6310_tabs_panel_settings">
      <form method="post">
        ...
        <div class="wpm-tab-content">
                ...
                <table class="table table-responsive wpm_6310_admin_table">
                 <?php 
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" min="0" name="box_radius" value="<?php echo esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : '0') ?>" class="wpm-form-input" id="wpm_box_radius" />
                    </td>
                  </tr>
                  <tr>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" name="box_background" id="wpm_box_background" class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : $allStyle[10]) ?>">
                    </td>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_top" id="wpm_member_margin_top" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[41]) && $allSlider[41] !== '') ? $allSlider[41] : 0); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 8); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table">
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="designation_margin_top" id="wpm_designation_margin_top" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[51]) && $allSlider[51] !== '') ? $allSlider[51] : 0); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                  <tr>
                    <td><b>Margin Bottom</b>
                    ...
                    <td>
                      <input name="designation_margin_bottom" id="wpm_designation_margin_bottom" type="number" min="0" value="<?php echo esc_attr((isset($allSlider[52]) && $allSlider[52] !== '') ? $allSlider[52] : 0); ?>" class="wpm-form-input" />
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div id="tab-4">
            <div class="row">
              <div class="wpm-col-12">
                <br />
                <small style="font-size: 16px; line-height: 30px;color: red; margin-left: 10px;">(Live preview is not available for Link Settings)</small>
              </div>
              <div class="wpm-col-6">
                  ...
                  <tr>
                    ...
                    <td>
                      <label class="switch" for="wpm_social_activation">
                        <input type="checkbox" name="social_activation" id="wpm_social_activation" value="1" <?php echo esc_attr((!isset($allStyle[32]) || (isset($allStyle[32]) && $allStyle[32])) ? 'checked' : '') ?>>
    ...
    <?php
        ...
        .wpm_6310_team_style_21 {
          ...
          -webkit-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
          -o-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
          -moz-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
          -ms-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
          border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
        ...
        .wpm_6310_team_style_21:hover {
          border-top: 5px ".esc_attr($allStyle[7])." solid;
          border-right: 5px ".esc_attr($allStyle[7])." solid;
          border-left: 5px ".esc_attr($allStyle[7])." solid;
        }
        ...
        .wpm_6310_team_style_21_pic {
          ...
          border-right: ".esc_attr($allStyle[3])."px solid ".esc_attr($allStyle[4]).";
          border-left: ".esc_attr($allStyle[3])."px solid ".esc_attr($allStyle[4]).";
          -webkit-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
          -o-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
          -moz-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
          -ms-border-radius: ".esc_attr((isset($allStyle[33]) && $allStyle[33] !== '') ? $allStyle[33] : 0)."px;
        ...
        .wpm_6310_team_style_21:hover .wpm_6310_team_style_21_pic {
          border-top: ".esc_attr($allStyle[3])." px solid #F1F1F1;
          border-right: ".esc_attr($allStyle[3])." px solid #F1F1F1;
          border-left: ".esc_attr($allStyle[3])." px solid #F1F1F1;
        }
        ...
        .wpm_6310_team_style_21_team_content {
          background: ".esc_attr((isset($allStyle[31]) && $allStyle[31] !== '') ? $allStyle[31] : $allStyle[10]).";
          padding: 20px 5px;
          color: #fff;
          position: relative;
          float: left;
        ...
        .wpm_6310_team_style_21_title {
          ...
          margin-bottom: ".esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42] : 8)."px;
        }
        ...
        ul.wpm_6310_team_style_21_social li {
          ...
          margin-right: 0px;
          width: ".esc_attr(ceil(sqrt(pow($allStyle[26] ? $allStyle[26] : 1, 2) + pow($allStyle[27] ? $allStyle[27] : 0, 2))))."px;
        }
  
        ul.wpm_6310_team_style_21_social li:last-child {
          margin-right: 0;
        }
    ...
    include wpm_6310_plugin_url . 'settings/helper/template-21.php';
    ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          ?>
              ...
              <div class="wpm_6310_team_style_21<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
                  <div class="wpm_6310_team_style_21_pic">
                    <img src="<?php echo esc_attr(($value['image'] ? $value['image'] : $value['hover_image'])) ?>" data-6310-hover-image="<?php echo esc_attr($value['hover_image']) ?>" class="wpm-6310-img-responsive <?php echo esc_attr($allStyle[1]) ?>" alt="<?php echo esc_attr($value['name']) ?>">
                  </div>
                  <div class="wpm_6310_team_style_21_team_content">
                    <div class="wpm_6310_team_style_21_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
                    <div class="wpm_6310_team_style_21_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
                    ...
                    if ($value['iconids']) {
                      ...
                      if ($icons) {
                        ...
                        foreach ($icons as $li) {
                          ...
                          if ($c == 0) {
                            echo "<ul class='wpm_6310_team_style_21_social'>";
                          }
                          $c++;
                          echo "<li><a " . esc_attr(wpm_6310_external_link($iconUrl[$index], '21') ). "  title='".esc_attr($li['name'])."'  id='wpm-social-link-".esc_attr($value['id'])."-{$li['id']}'><i class='" . esc_attr($li['class_name']) . "'></i></a></li>";
                          $iconStyles .= "<style>
                        ul.wpm_6310_team_style_21_social li a#wpm-social-link-".esc_attr($value['id'])."-".esc_attr($li['id'])."{
                          color: ".esc_attr($li['color']).";
                        }
                        ul.wpm_6310_team_style_21_social li a#wpm-social-link-".esc_attr($value['id'])."-".esc_attr($li['id']).":before{
                          content: '';
                          width: 100%;
                          height: 100%;
                          position: absolute;
                          ...
                          z-index: -1;
                          transition: all 0.3s ease-in-out 0s;
                          border: ".esc_attr($allStyle[28])."px solid ".esc_attr($li['bgcolor']).";
                          background-color: {$li['bgcolor']};

                        }
                        ul.wpm_6310_team_style_21_social li:hover a#wpm-social-link-".esc_attr($value['id'])."-".esc_attr($li['id'])."{
                          color: ".esc_attr($li['bgcolor']).";
                        }
                        ul.wpm_6310_team_style_21_social li:hover a#wpm-social-link-".esc_attr($value['id'])."-".esc_attr($li['id']).":before{

                          background-color: ".esc_attr($li['color']).";
                          transform: rotate(-45deg);
                        }
                  ...
                  if ($value['iconids']) {
                    ...
                    if ($icons) {
                      ...
                      foreach ($icons as $li) {
                        ...
                        $c++;
                        echo "<li><a " . esc_attr(wpm_6310_external_link($iconUrl[$index], '21')) . "  title='".esc_attr($li['name'])."'  id='wpm-social-link-".esc_attr($value['id'])."-".esc_attr($li['id'])."'><i class='" . esc_attr($li['class_name']) . "'></i></a></li>";
                        $iconStyles .= "<style>
                            ul.wpm_6310_team_style_21_social li a#wpm-social-link-{$value['id']}-{$li['id']}{
                              color: ".esc_attr($li['color']).";
                            }
                            ul.wpm_6310_team_style_21_social li a#wpm-social-link-".esc_attr($value['id'])."-".esc_attr($li['id']).":before{
                              content: '';
                              ...
                              transition: all 0.3s ease-in-out 0s;
                              border: ".esc_attr($allStyle[28])."px solid ".esc_attr($li['bgcolor']).";
                              background-color: ".esc_attr($li['bgcolor']).";
