  ...
  <div class="wpm-6310-sm">
    ...
    if (!empty($_POST['update_style_change']) && $_POST['update_style_change'] == 'Save' && $_POST['styleid'] != '') {
      ...
      if (!wp_verify_nonce($nonce, 'wpm_nonce_field_form')) {
        ...
        $css .= "|" . sanitize_text_field($_POST['image_border_width']);
        $css .= "|" . sanitize_text_field($_POST['image_border_color']);       
        // 31 - 35
        
        $css .= "|" . sanitize_text_field($_POST['image_border_color_2']);
        $css .= "|" . sanitize_text_field($_POST['name_border_width']);   
        $css .= "|" . sanitize_text_field($_POST['name_border_color']);
        // 36 - 40
    ...
    ?>
              ...
              <div class="row wpm_6310_padding_15_px">
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    ...
                    ?>
                    <tr>
                      <td><b>Items Alignment</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                    ...
                    <tr>
                      <td>
                          <b>Items Margin</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                    ...
                    <tr>
                      <td><b>Image Border Size</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span><div class="wpm-6310-pro">*Preview-on-change  not available</div></td>
                      <td>
                        <input type="number" min="0" name="image_border_width" value="<?php echo esc_attr((isset($allStyle[34]) && $allStyle[34] !== '') ? $allStyle[34] : 30) ?>"
                          class="wpm-form-input" id="wpm_image_border_width" />
                      </td>

                    </tr>
                    <tr>
                      <td><b>Image Border Color 1</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="image_border_color" id="wpm_image_border_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb"
                          value="<?php echo esc_attr((isset($allStyle[35]) && $allStyle[35] !== '') ? $allStyle[35] : '#e6e5e5') ?>">
                      </td>
                    </tr>  
                    <tr>
                      <td><b>Image Border Color 2</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="image_border_color_2" id="wpm_image_border_color_2"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb"
                          value="<?php echo esc_attr((isset($allStyle[36]) && $allStyle[36] !== '') ? $allStyle[36] : '#37b0f1') ?>">
                      </td>
                    </tr>                    
                  </table>
                </div>
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                  <tr>
                      <td><b>Box Radius</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="number" min="0" name="image_radius" value="<?php echo esc_attr($allStyle[2]) ?>" class="wpm-form-input" id="wpm_image_radius" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Box Background</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="box_background" id="wpm_box_background"
                          ...
                          value="<?php echo esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(255, 255, 255, 1)') ?>">
                      </td>
                    </tr>
                    <tr>
                      <td><b>Box Hover Background</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="image_hover_background" id="wpm_image_hover_background"
                          class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb"
                          value="<?php echo esc_attr($allStyle[7]) ?>">
                      </td>
                    </tr>
                    <tr>
                      <td><b>Box Shadow Width</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="number" min="0" name="box_shadow_width" value="<?php echo esc_attr($allStyle[8]) ?>"
                          class="wpm-form-input" step="1" id="wpm_box_shadow_width" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Box Shadow Blur</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="number" min="0" name="box_shadow_blur" value="<?php echo esc_attr($allStyle[9]) ?>"
                          class="wpm-form-input" step="1" id="wpm_box_shadow_blur" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Box Shadow Color</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="box_shadow_color" id="wpm_box_shadow_color"
                          class="wpm-form-input wpm_6310_color_picker" data-opacity=".8" data-format="rgb"
                          value="<?php echo esc_attr($allStyle[10]) ?>">
                      </td>
                    </tr>
                    <tr>
                      <td><b>Box Border Width</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="number" min="0" name="border_width" value="<?php echo esc_attr($allStyle[3]) ?>"
                          class="wpm-form-input" id="wpm_border_width" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Box Border Color</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="border_color" id="wpm_border_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8"
                          value="<?php echo esc_attr($allStyle[4]) ?>">
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      ...
                      <td>
                        <input type="number" min="0" name="member_font_size" value="<?php echo esc_attr($allStyle[11]) ?>"
                          class="wpm-form-input" step="1" id="wpm_member_font_size" />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input type="text" name="member_font_color" id="wpm_member_font_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb"
                          value="<?php echo esc_attr($allStyle[12]) ?>">
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input type="text" name="member_font_hover_color" id="wpm_member_font_hover_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb"
                          value="<?php echo esc_attr($allStyle[13]) ?>">
                      </td>
                    </tr>
                    <tr>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      ...
                      <td>
                        <input name="member_font_family" id="wpm_jquery_heading_font" type="text"
                          value="<?php echo esc_attr($allStyle[17]) ?>" />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input name="member_line_height" id="wpm_heading_line_height" type="number" min="0"
                          value="<?php echo esc_attr($allStyle[18]) ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <input name="member_margin_bottom" id="wpm_member_margin_bottom" type="number" min="0"
                          value="<?php echo esc_attr((isset($allSlider[42]) && $allSlider[42] !== '') ? $allSlider[42]:10) ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Name Border Width</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="number" min="0" name="name_border_width" value="<?php echo esc_attr((isset($allStyle[37]) && $allStyle[37] !== '') ? $allStyle[37]: 50) ?>"
                          class="wpm-form-input" id="wpm_name_border_width" />
                      </td>

                    </tr>
                    <tr>
                      <td><b>Name Border Color</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="name_border_color" id="wpm_name_border_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb" 
                          value="<?php echo esc_attr((isset($allStyle[38]) && $allStyle[38] !== '') ? $allStyle[38]: "#222") ?>">
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      <td><b>Font Size</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="number" min="0" name="designation_font_size" value="<?php echo esc_attr($allStyle[19]) ?>"
                          class="wpm-form-input" step="1" id="wpm_designation_font_size" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Font Color</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="designation_font_color" id="wpm_designation_font_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb"
                          value="<?php echo esc_attr($allStyle[20]) ?>">
                      </td>
                    </tr>
                    <tr>
                      <td><b>Font Hover Color</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input type="text" name="designation_font_hover_color" id="wpm_designation_font_hover_color"
                          class="wpm-form-input wpm_6310_color_picker" data-format="rgb"
                          value="<?php echo esc_attr($allStyle[25]) ?>">
                      </td>
                    </tr>
                    <tr>
                      <td><b>Font Weight</b>  <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span><?php                    
                    ...
                    <tr>
                      ...
                      <td>
                        <select name="designation_text_transform" class="wpm-form-input"
                          id="wpm_designation_text_transform">
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table">
                    <tr>
                      <td><b>Font Family</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input name="designation_font_family" id="wpm_jquery_designation_font" type="text"
                          value="<?php echo esc_attr($allStyle[23]) ?>" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Line Height</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                      <td>
                        <input name="designation_line_height" id="wpm_designation_line_height" type="number" min="0"
                          value="<?php echo esc_attr($allStyle[24]) ?>" class="wpm-form-input" />
                      </td>
                    </tr>
                    <tr>
                      <td><b>Margin Top</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                ...
                <div class="wpm-col-6">
                  <table class="table table-responsive wpm_6310_admin_table" width="100%">
                    ...
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_icon_width" value="<?php echo esc_attr($allStyle[26]) ?>"
                          class="wpm-form-input" id="wpm_social_icon_width" />
                      </td>
                    </tr>
                    <tr class="social_act_field">
                      <td><b>Social Icon Height</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span><?php                    
                                                    ?></td>
                      <td>
                        <input type="number" min="0" name="social_icon_height" value="<?php echo esc_attr($allStyle[27]) ?>"
                          class="wpm-form-input" id="wpm_social_icon_height" />
                      </td>
                    </tr>
                  </table>
                </div>
                  ...
                  <table class="table table-responsive wpm_6310_admin_table social_act_field">
                    <tr class="social_act_field">
                      <td><b>Social Icon Border Width</b> <span class="wpm-6310-pro">(Pro) <div class="wpm-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span><?php                    
                                                                      ?></td>
                      <td>
                        <input type="number" min="0" name="social_border_width" value="<?php echo esc_attr($allStyle[28]) ?>"
                          class="wpm-form-input" id="wpm_social_border_width" />
                      </td>
                    </tr>
                    <tr class="social_act_field">
                      ...
                      <td>
                        <input type="number" min="0" name="social_border_radius" value="<?php echo esc_attr($allStyle[30]) ?>"
                          class="wpm-form-input" id="wpm_social_border_radius" />
                      </td>
                    </tr>
                    <tr>
      ...
      <?php
        ...
        .wpm_6310_team_style_32{
            ...
            cursor: pointer;
            padding: 10px;
            box-shadow: 0 1px ".esc_attr($allStyle[9])."px ".esc_attr($allStyle[8])."px ".esc_attr($allStyle[10]).";
        -webkit-border-radius: ".esc_attr($allStyle[2] )."px;
          ...
          background-color: ".esc_attr((isset($allStyle[32]) && $allStyle[32] !== '') ? $allStyle[32] : 'rgba(255, 255, 255, 1)').";
        }
        .wpm_6310_team_style_32:hover {
                background: ".esc_attr($allStyle[7]).";
                margin-top: -10px;
                margin-bottom: 10px;
                box-shadow: 0 5px ".esc_attr((($allStyle[9] ? $allStyle[9] : 1) * 5))."px ".esc_attr($allStyle[8])."px ".esc_attr($allStyle[10]).";
              }
        .wpm_6310_team_style_32{ 
            text-align: center; 
            border-style: solid;
        ...
        .wpm_6310_team_style_32_img:after{
            ...
            height: 100%;
            border-radius: 50%;
            border: ".esc_attr($allStyle[34] )."px solid ".esc_attr($allStyle[35]).";
            position: absolute;
            top: 0;
            left: 0;
        ...
        .wpm_6310_team_style_32_img:after{
            border-color: ".esc_attr($allStyle[36])." ".esc_attr($allStyle[35])." ".esc_attr($allStyle[35])." ".esc_attr($allStyle[36]).";
            z-index: 1;
        ...
        .wpm_6310_team_style_32_title:after {
            content: '';
            width: ".esc_attr($allStyle[37])."px;
            height: 2px;
            background: ".esc_attr($allStyle[38]).";
            margin: 0 auto;
            position: absolute;
            bottom: 0;
            left: 0;
        ...
        .wpm_6310_team_style_32:hover .wpm_6310_team_style_32_title:after{
            width: ".esc_attr(($allStyle[37] ? $allStyle[37] : 0) + 20)."px;
        }
         .wpm_6310_team_style_32_designation{
            display: block;
            ...
            margin-top: ".esc_attr($allSlider[51])."px;
            margin-bottom: ".esc_attr($allSlider[52])."px;
        }
        
        .wpm_6310_team_style_32_social {
        ...
        ul.wpm_6310_team_style_32_social li {
          display: inline-block;
          margin: 0 5px 5px 0;
        }
        
        ul.wpm_6310_team_style_32_social li:last-child {
          margin-right: 0;
        }
        .wpm_6310_team_style_32_social a{
            display: inline-block;
        ...
        .wpm_6310_team_style_32:hover .wpm_6310_team_style_32_designation{
      ...
      <?php
      include wpm_6310_plugin_url . 'settings/helper/template-32.php';
      ?>
      ...
      >
        <div id="wpm-6310-noslider-<?php echo esc_attr($styleId) ?>">
          ...
          <div class="wpm-6310-col-<?php echo esc_attr($desktop_row) ?>">
            <div class="wpm_6310_team_style_32<?php echo !$readMoreActive ? $cls : '' ?>" <?php echo !$readMoreActive ? $attr : '' ?>>
              ...
              <div class="wpm_6310_team_style_32_title"><?php echo wpm_6310_replace(esc_attr($value['name'])) ?></div>
              <div class="wpm_6310_team_style_32_designation"><?php echo wpm_6310_replace(esc_attr($value['designation'])) ?></div>
              <?php
