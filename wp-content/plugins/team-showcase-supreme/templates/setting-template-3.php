    ...
    <div class="wpm-6310-template-form" id="tab-1">
      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          <tr>
            <td>
              <b>Left section background color</b>
            </td>
            <td>
              <input required type="text" name="top_text_left_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo ($cssData['top_text_left_bg_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
              <b>Right section background color</b>
            </td>
            <td>
              <input required type="text" name="top_text_right_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['top_text_right_bg_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          <tr>
            ...
            <td>
              <select name="top_text_weight" class="wpm-form-input">
                <?php
                $list = [100, 200, 300, 400, 500, 600, 700, 800, 900, 'normal', 'bold', 'lighter', 'initial'];
                foreach ($list as $index) {
                  $selected = $index == $cssData['top_text_weight'] ? 'selected' : '';
    ...
    <div class="wpm-6310-template-form" id="tab-7">
      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          ...
          <tr>
            <td>
              <b>Contact info background color</b>
            </td>
            <td>
              <input required type="text" name="contact_info_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['contact_info_bg_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
